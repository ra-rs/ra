...
#[doc = "Field `DAASW1` reader - D/A Amplifier Stabilization Wait 1"]
pub type DAASW1_R = crate::BitReader<DAASW1_A>;
#[doc = "D/A Amplifier Stabilization Wait 1\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DAASW1_A {
    #[doc = "0: Amplifier stabilization wait off (output) for channel 1"]
    _0 = 0,
    #[doc = "1: Amplifier stabilization wait on (high-Z) for channel 1"]
    _1 = 1,
}
...
#[doc = "Field `DAASW1` writer - D/A Amplifier Stabilization Wait 1"]
...
impl R {
    ...
    #[doc = "Bit 7 - D/A Amplifier Stabilization Wait 1"]
    #[inline(always)]
