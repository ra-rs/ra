...
#[doc = "Field `EBCKOEN` reader - EBCLK Pin Output Control"]
pub type EBCKOEN_R = crate::BitReader<EBCKOEN_A>;
#[doc = "EBCLK Pin Output Control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum EBCKOEN_A {
    #[doc = "0: EBCLK pin output is disabled (fixed high)"]
    _0 = 0,
    #[doc = "1: EBCLK pin output is enabled."]
    _1 = 1,
}
...
#[doc = "Field `EBCKOEN` writer - EBCLK Pin Output Control"]
...
impl R {
    #[doc = "Bit 0 - EBCLK Pin Output Control"]
    #[inline(always)]
