...
#[doc = "Field `AD0MATED` reader - ADC120 Compare Match Snooze End Enable"]
...
#[doc = "Field `AD0MATED` writer - ADC120 Compare Match Snooze End Enable"]
pub type AD0MATED_W<'a, const O: u8> = crate::BitWriter<'a, u8, SNZEDCR0_SPEC, AD0MATED_A, O>;
...
#[doc = "Field `AD0UMTED` reader - ADC120 Compare Mismatch Snooze End Enable"]
...
#[doc = "Field `AD0UMTED` writer - ADC120 Compare Mismatch Snooze End Enable"]
pub type AD0UMTED_W<'a, const O: u8> = crate::BitWriter<'a, u8, SNZEDCR0_SPEC, AD0UMTED_A, O>;
...
#[doc = "Field `AD1MATED` reader - ADC121 Compare Match Snooze End Enable"]
...
#[doc = "Field `AD1MATED` writer - ADC121 Compare Match Snooze End Enable"]
pub type AD1MATED_W<'a, const O: u8> = crate::BitWriter<'a, u8, SNZEDCR0_SPEC, AD1MATED_A, O>;
...
#[doc = "Field `AD1UMTED` reader - ADC121 Compare Mismatch Snooze End Enable"]
...
#[doc = "Field `AD1UMTED` writer - ADC121 Compare Mismatch Snooze End Enable"]
pub type AD1UMTED_W<'a, const O: u8> = crate::BitWriter<'a, u8, SNZEDCR0_SPEC, AD1UMTED_A, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - ADC120 Compare Match Snooze End Enable"]
    #[inline(always)]
    pub fn ad0mated(&self) -> AD0MATED_R {
        AD0MATED_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - ADC120 Compare Mismatch Snooze End Enable"]
    #[inline(always)]
    pub fn ad0umted(&self) -> AD0UMTED_R {
        AD0UMTED_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - ADC121 Compare Match Snooze End Enable"]
    #[inline(always)]
    pub fn ad1mated(&self) -> AD1MATED_R {
        AD1MATED_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - ADC121 Compare Mismatch Snooze End Enable"]
    #[inline(always)]
