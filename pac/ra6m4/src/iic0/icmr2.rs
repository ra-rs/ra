...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TMOL_A {
    #[doc = "0: Disable count while SCLn line is low"]
    _0 = 0,
    #[doc = "1: Enable count while SCLn line is low"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TMOH_A {
    #[doc = "0: Disable count while SCLn line is high"]
    _0 = 0,
    #[doc = "1: Enable count while SCLn line is high"]
    _1 = 1,
}
