...
pub type EXENB_W<'a, const O: u8> = crate::BitWriter<'a, u16, CSCR_SPEC, EXENB_A, O>;
...
#[repr(u8)]
pub enum BSIZE_A {
    #[doc = "0: A 16-bit bus space is selected."]
    _00 = 0,
    #[doc = "2: An 8-bit bus space is selected."]
    _10 = 2,
}
...
impl BSIZE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<BSIZE_A> {
        match self.bits {
            0 => Some(BSIZE_A::_00),
            2 => Some(BSIZE_A::_10),
            _ => None,
...
pub type BSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CSCR_SPEC, u8, BSIZE_A, 2, O>;
...
pub type EMODE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CSCR_SPEC, EMODE_A, O>;
...
pub enum MPXEN_A {
    ...
    _0 = 0,
    #[doc = "1: Address/data multiplexed I/O interface is selected for area n."]
    _1 = 1,
}
...
pub type MPXEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CSCR_SPEC, MPXEN_A, O>;
...
#[doc = "`reset()` method sets CS%sCR to value 0"]
