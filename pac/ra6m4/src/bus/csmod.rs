...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum EWENB_A {
    #[doc = "0: External wait is disabled."]
    _0 = 0,
    #[doc = "1: External wait is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PRENB_A {
    #[doc = "0: Page read access is disabled."]
    _0 = 0,
    #[doc = "1: Page read access is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PWENB_A {
    #[doc = "0: Page write access is disabled."]
    _0 = 0,
    #[doc = "1: Page write access is enabled."]
    _1 = 1,
}
...
#[doc = "Field `PRMOD` reader - Page Read Access Mode Select"]
...
#[doc = "Field `PRMOD` writer - Page Read Access Mode Select"]
pub type PRMOD_W<'a, const O: u8> = crate::BitWriter<'a, u16, CSMOD_SPEC, PRMOD_A, O>;
impl<'a, const O: u8> PRMOD_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prmod(&mut self) -> PRMOD_W<15> {
        PRMOD_W::new(self)
    }
