#[doc = "Register `SSR_MANC` reader"]
pub struct R(crate::R<SSR_MANC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSR_MANC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSR_MANC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSR_MANC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SSR_MANC` writer"]
pub struct W(crate::W<SSR_MANC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SSR_MANC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SSR_MANC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SSR_MANC_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Field `MER` writer - Manchester Error Flag"]
pub type MER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_MANC_SPEC, MER_A, O>;
...
pub type PER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_MANC_SPEC, PER_A, O>;
...
pub type FER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_MANC_SPEC, FER_A, O>;
...
pub type ORER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_MANC_SPEC, ORER_A, O>;
...
pub type RDRF_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_MANC_SPEC, RDRF_A, O>;
...
pub type TDRE_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_MANC_SPEC, TDRE_A, O>;
...
impl R {
    #[doc = "Bit 0 - Manchester Error Flag"]
    #[inline(always)]
    pub fn mer(&self) -> MER_R {
        MER_R::new((self.bits & 1) != 0)
    }
...
pub struct SSR_MANC_SPEC;
impl crate::RegisterSpec for SSR_MANC_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [ssr_manc::R](R) reader structure"]
impl crate::Readable for SSR_MANC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ssr_manc::W](W) writer structure"]
impl crate::Writable for SSR_MANC_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SSR_MANC to value 0x84"]
impl crate::Resettable for SSR_MANC_SPEC {
