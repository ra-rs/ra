...
#[doc = "Field `SFMD` reader - Port for direct communication with the SPI bus"]
pub type SFMD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SFMD` writer - Port for direct communication with the SPI bus"]
pub type SFMD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SFMCOM_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Port for direct communication with the SPI bus"]
    #[inline(always)]
