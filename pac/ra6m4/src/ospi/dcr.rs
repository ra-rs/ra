...
#[doc = "Field `DVCMD0` reader - Device Command data"]
pub type DVCMD0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DVCMD0` writer - Device Command data"]
pub type DVCMD0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DCR_SPEC, u8, u8, 8, O>;
#[doc = "Field `DVCMD1` reader - Device Command data"]
pub type DVCMD1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DVCMD1` writer - Device Command data"]
pub type DVCMD1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DCR_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Device Command data"]
    #[inline(always)]
    pub fn dvcmd0(&self) -> DVCMD0_R {
        DVCMD0_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Device Command data"]
    #[inline(always)]
    pub fn dvcmd1(&self) -> DVCMD1_R {
        DVCMD1_R::new(((self.bits >> 8) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Device Command data"]
    #[inline(always)]
    #[must_use]
    pub fn dvcmd0(&mut self) -> DVCMD0_W<0> {
        DVCMD0_W::new(self)
    }
    #[doc = "Bits 8:15 - Device Command data"]
    #[inline(always)]
    #[must_use]
    pub fn dvcmd1(&mut self) -> DVCMD1_W<8> {
        DVCMD1_W::new(self)
    }
