...
pub struct RegisterBlock {
    ...
    #[doc = "0x6d - Octal-SPI Clock Division Control Register"]
    pub octackdivcr: OCTACKDIVCR,
    _reserved23: [u8; 0x06],
    #[doc = "0x74 - USB Clock Control Register"]
    pub usbckcr: USBCKCR,
    #[doc = "0x75 - Octal-SPI Clock Control Register"]
    pub octackcr: OCTACKCR,
    _reserved25: [u8; 0x12],
...
pub mod usbckdivcr;
#[doc = "OCTACKDIVCR (rw) register accessor: an alias for `Reg<OCTACKDIVCR_SPEC>`"]
pub type OCTACKDIVCR = crate::Reg<octackdivcr::OCTACKDIVCR_SPEC>;
...
pub mod usbckcr;
#[doc = "OCTACKCR (rw) register accessor: an alias for `Reg<OCTACKCR_SPEC>`"]
pub type OCTACKCR = crate::Reg<octackcr::OCTACKCR_SPEC>;
