...
pub enum DVCHG_A {
    #[doc = "0: Disable writes to the USBADDR.STSRECOV\\[3:0\\]
and USBADDR.USBADDR\\[6:0\\]
bits"]
    _0 = 0,
    #[doc = "1: Enable writes to the USBADDR.STSRECOV\\[3:0\\]
and USBADDR.USBADDR\\[6:0\\]
bits"]
    _1 = 1,
}
...
impl<'a, const O: u8> DVCHG_W<'a, O> {
    #[doc = "Disable writes to the USBADDR.STSRECOV\\[3:0\\]
and USBADDR.USBADDR\\[6:0\\]
bits"]
    #[inline(always)]
    ...
    #[doc = "Enable writes to the USBADDR.STSRECOV\\[3:0\\]
and USBADDR.USBADDR\\[6:0\\]
bits"]
    #[inline(always)]
