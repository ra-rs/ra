...
pub enum PID_A {
    #[doc = "0: NAK response"]
    _00 = 0,
    #[doc = "1: BUF response (depends on the buffer state)"]
    _01 = 1,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CCPL_A {
    #[doc = "0: Disable control transfer completion"]
    _0 = 0,
    #[doc = "1: Enable control transfer completion"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PBUSY_A {
    #[doc = "0: DCP not used for the USB bus"]
    _0 = 0,
    #[doc = "1: DCP in use for the USB bus"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSTS_A {
    #[doc = "0: Buffer access disabled"]
    _0 = 0,
    #[doc = "1: Buffer access enabled"]
    _1 = 1,
}
