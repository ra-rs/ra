...
#[doc = "Field `PIPE0NRDY` reader - NRDY Interrupt Status for Pipe 0"]
pub type PIPE0NRDY_R = crate::BitReader<PIPE0NRDY_A>;
#[doc = "NRDY Interrupt Status for Pipe 0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PIPE0NRDY_A {
    #[doc = "0: No NRDY interrupt occurred"]
    _0 = 0,
    #[doc = "1: NRDY interrupt occurred"]
    _1 = 1,
}
...
#[doc = "Field `PIPE0NRDY` writer - NRDY Interrupt Status for Pipe 0"]
pub type PIPE0NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE0NRDY_A, O>;
...
#[doc = "Field `PIPE1NRDY` reader - NRDY Interrupt Status for Pipe 1"]
...
#[doc = "Field `PIPE1NRDY` writer - NRDY Interrupt Status for Pipe 1"]
pub type PIPE1NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE1NRDY_A, O>;
...
#[doc = "Field `PIPE2NRDY` reader - NRDY Interrupt Status for Pipe 2"]
...
#[doc = "Field `PIPE2NRDY` writer - NRDY Interrupt Status for Pipe 2"]
pub type PIPE2NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE2NRDY_A, O>;
...
#[doc = "Field `PIPE3NRDY` reader - NRDY Interrupt Status for Pipe 3"]
...
#[doc = "Field `PIPE3NRDY` writer - NRDY Interrupt Status for Pipe 3"]
pub type PIPE3NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE3NRDY_A, O>;
...
#[doc = "Field `PIPE4NRDY` reader - NRDY Interrupt Status for Pipe 4"]
...
#[doc = "Field `PIPE4NRDY` writer - NRDY Interrupt Status for Pipe 4"]
pub type PIPE4NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE4NRDY_A, O>;
...
#[doc = "Field `PIPE5NRDY` reader - NRDY Interrupt Status for Pipe 5"]
...
#[doc = "Field `PIPE5NRDY` writer - NRDY Interrupt Status for Pipe 5"]
pub type PIPE5NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE5NRDY_A, O>;
...
#[doc = "Field `PIPE6NRDY` reader - NRDY Interrupt Status for Pipe 6"]
...
#[doc = "Field `PIPE6NRDY` writer - NRDY Interrupt Status for Pipe 6"]
pub type PIPE6NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE6NRDY_A, O>;
...
#[doc = "Field `PIPE7NRDY` reader - NRDY Interrupt Status for Pipe 7"]
...
#[doc = "Field `PIPE7NRDY` writer - NRDY Interrupt Status for Pipe 7"]
pub type PIPE7NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE7NRDY_A, O>;
...
#[doc = "Field `PIPE8NRDY` reader - NRDY Interrupt Status for Pipe 8"]
...
#[doc = "Field `PIPE8NRDY` writer - NRDY Interrupt Status for Pipe 8"]
pub type PIPE8NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE8NRDY_A, O>;
...
#[doc = "Field `PIPE9NRDY` reader - NRDY Interrupt Status for Pipe 9"]
...
#[doc = "Field `PIPE9NRDY` writer - NRDY Interrupt Status for Pipe 9"]
pub type PIPE9NRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NRDYSTS_SPEC, PIPE9NRDY_A, O>;
