...
pub enum IDFM_A {
    ...
    _01 = 1,
    #[doc = "2: Mixed ID mode All mailboxes, including FIFO mailboxes, handle both standard and extended IDs. In normal mailbox mode, use the associated IDE bit to differentiate standard and extended IDs. In FIFO mailbox mode, the associated IDE bits are used for mailboxes 0 to 23, the IDE bits in FIDCR0 and FIDCR1 are used for the receive FIFO, and the IDE bit associated with mailbox 24 is used for the transmit FIFO."]
    _10 = 2,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TSRC_A {
    #[doc = "0: Do not reset time stamp counter"]
    _0 = 0,
    #[doc = "1: Reset time stamp counter"]
    _1 = 1,
}
...
pub enum CANM_A {
    ...
    #[doc = "2: CAN halt mode"]
    _10 = 2,
    #[doc = "3: CAN reset mode (forced transition)"]
    _11 = 3,
}
...
pub enum BOM_A {
    ...
    _00 = 0,
    #[doc = "1: Enter CAN halt mode automatically on entering bus-off state"]
    _01 = 1,
    #[doc = "2: Enter CAN halt mode automatically at the end of bus-off state"]
    _10 = 2,
    #[doc = "3: Enter CAN halt mode during bus-off recovery period through a software request"]
    _11 = 3,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RBOC_A {
    #[doc = "0: No return occurred"]
    _0 = 0,
    #[doc = "1: Forced return from bus-off state"]
    _1 = 1,
}
