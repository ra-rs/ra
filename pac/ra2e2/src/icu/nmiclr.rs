...
#[doc = "Field `BUSSCLR` reader - Bus Slave MPU Error Interrupt Status Flag Clear"]
...
#[doc = "Field `BUSSCLR` writer - Bus Slave MPU Error Interrupt Status Flag Clear"]
...
#[doc = "Field `SPECLR` reader - CPU Stack Pointer Monitor Interrupt Status Flag Clear"]
...
#[doc = "Field `SPECLR` writer - CPU Stack Pointer Monitor Interrupt Status Flag Clear"]
...
impl R {
    ...
    #[doc = "Bit 10 - Bus Slave MPU Error Interrupt Status Flag Clear"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - CPU Stack Pointer Monitor Interrupt Status Flag Clear"]
    #[inline(always)]
