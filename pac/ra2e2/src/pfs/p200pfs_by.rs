#[doc = "Register `P200PFS_BY` reader"]
pub struct R(crate::R<P200PFS_BY_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P200PFS_BY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P200PFS_BY_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P200PFS_BY_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P200PFS_BY` writer"]
pub struct W(crate::W<P200PFS_BY_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P200PFS_BY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P200PFS_BY_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P200PFS_BY_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P200PFS_BY_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P200PFS_BY_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P200PFS_BY_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P200PFS_BY_SPEC, NCODR_A, O>;
...
#[doc = "Port 200 Pin Function Select Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p200pfs_by](index.html) module"]
pub struct P200PFS_BY_SPEC;
impl crate::RegisterSpec for P200PFS_BY_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [p200pfs_by::R](R) reader structure"]
impl crate::Readable for P200PFS_BY_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p200pfs_by::W](W) writer structure"]
impl crate::Writable for P200PFS_BY_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P200PFS_BY to value 0"]
impl crate::Resettable for P200PFS_BY_SPEC {
