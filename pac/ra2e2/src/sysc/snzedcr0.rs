...
#[doc = "Field `AD0MATED` reader - ADC12 Compare Match Snooze End Enable"]
...
#[doc = "Field `AD0MATED` writer - ADC12 Compare Match Snooze End Enable"]
...
#[doc = "Field `AD0UMTED` reader - ADC12 Compare Mismatch Snooze End Enable"]
...
#[doc = "Field `AD0UMTED` writer - ADC12 Compare Mismatch Snooze End Enable"]
...
impl R {
    ...
    #[doc = "Bit 3 - ADC12 Compare Match Snooze End Enable"]
    #[inline(always)]
    pub fn ad0mated(&self) -> AD0MATED_R {
        AD0MATED_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - ADC12 Compare Mismatch Snooze End Enable"]
    #[inline(always)]
