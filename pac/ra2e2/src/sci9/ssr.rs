...
pub type PER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SPEC, PER_A, O>;
...
pub type FER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SPEC, FER_A, O>;
...
pub type ORER_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SPEC, ORER_A, O>;
...
pub type RDRF_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SPEC, RDRF_A, O>;
...
pub type TDRE_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SPEC, TDRE_A, O>;
