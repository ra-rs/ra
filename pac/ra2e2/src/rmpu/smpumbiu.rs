...
pub enum RPGRPA_A {
    #[doc = "0: Memory protection read for master MPU group A disabled"]
    _0 = 0,
    #[doc = "1: Memory protection read for master MPU group A enabled"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WPGRPA_A {
    #[doc = "0: Memory protection write for master MPU group A disabled"]
    _0 = 0,
    #[doc = "1: Memory protection write for master MPU group A enabled"]
    _1 = 1,
}
