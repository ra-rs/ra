...
pub enum PROTECT_A {
    #[doc = "0: All bus master MPU group A register writes are permitted."]
    _0 = 0,
    #[doc = "1: All bus master MPU group A register writes are protected. Reads are permitted."]
    _1 = 1,
}
...
pub type KEY_W<'a, const O: u8> = crate::FieldWriter<'a, u16, MMPUPTA_SPEC, u8, u8, 8, O>;
impl R {
