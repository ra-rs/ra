...
#[doc = "Field `HDREXDF` reader - HDR Exit Pattern Detection Flag"]
pub type HDREXDF_R = crate::BitReader<HDREXDF_A>;
#[doc = "HDR Exit Pattern Detection Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HDREXDF_A {
    #[doc = "0: HDR Exit Pattern Detection Interrupt does not occur."]
    _0 = 0,
    #[doc = "1: HDR Exit Pattern Detection Interrupt occurs."]
    _1 = 1,
}
impl From<HDREXDF_A> for bool {
    #[inline(always)]
    fn from(variant: HDREXDF_A) -> Self {
        variant as u8 != 0
    }
}
impl HDREXDF_R {
...
#[doc = "Field `HDREXDF` writer - HDR Exit Pattern Detection Flag"]
pub type HDREXDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, BST_SPEC, HDREXDF_A, O>;
impl<'a, const O: u8> HDREXDF_W<'a, O> {
    #[doc = "HDR Exit Pattern Detection Interrupt does not occur."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HDREXDF_A::_0)
    }
    #[doc = "HDR Exit Pattern Detection Interrupt occurs."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(HDREXDF_A::_1)
    }
}
...
impl R {
    ...
    #[doc = "Bit 2 - HDR Exit Pattern Detection Flag"]
    #[inline(always)]
    pub fn hdrexdf(&self) -> HDREXDF_R {
        HDREXDF_R::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hdrexdf(&mut self) -> HDREXDF_W<2> {
        HDREXDF_W::new(self)
    }
    #[doc = "Bit 4 - NACK Detection Flag"]
    #[inline(always)]
