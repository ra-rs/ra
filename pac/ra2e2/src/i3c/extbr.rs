...
#[doc = "Field `EBRLP` reader - Extended Bit Rate Low-Level Period Push-Pull"]
pub type EBRLP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EBRLP` writer - Extended Bit Rate Low-Level Period Push-Pull"]
pub type EBRLP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EXTBR_SPEC, u8, u8, 6, O>;
#[doc = "Field `EBRHP` reader - Extended Bit Rate Low-Level Period Push-Pull"]
pub type EBRHP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EBRHP` writer - Extended Bit Rate Low-Level Period Push-Pull"]
pub type EBRHP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EXTBR_SPEC, u8, u8, 6, O>;
impl R {
    ...
    #[doc = "Bits 16:21 - Extended Bit Rate Low-Level Period Push-Pull"]
    #[inline(always)]
    pub fn ebrlp(&self) -> EBRLP_R {
        EBRLP_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29 - Extended Bit Rate Low-Level Period Push-Pull"]
    #[inline(always)]
    pub fn ebrhp(&self) -> EBRHP_R {
        EBRHP_R::new(((self.bits >> 24) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Extended Bit Rate Low-Level Period Open-Drain"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ebrlp(&mut self) -> EBRLP_W<16> {
        EBRLP_W::new(self)
    }
    #[doc = "Bits 24:29 - Extended Bit Rate Low-Level Period Push-Pull"]
    #[inline(always)]
    #[must_use]
    pub fn ebrhp(&mut self) -> EBRHP_W<24> {
        EBRHP_W::new(self)
    }
...
#[doc = "`reset()` method sets EXTBR to value 0x3f3f_ffff"]
