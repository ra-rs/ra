...
pub struct RegisterBlock {
    ...
    pub adrd: ADRD,
    _reserved15: [u8; 0x0a],
    #[doc = "0x2a - A/D Data Registers %s"]
    pub addr: [ADDR; 2],
    _reserved16: [u8; 0x04],
    #[doc = "0x32 - A/D Data Registers %s"]
    pub addr9: ADDR9,
    #[doc = "0x34 - A/D Data Registers %s"]
    pub addr10: ADDR9,
    _reserved18: [u8; 0x10],
    ...
    pub adsstro: ADSSTRO,
    _reserved47: [u8; 0x05],
    #[doc = "0xe5 - A/D Sampling State Register"]
    pub adsstr: [ADSSTR; 2],
    _reserved48: [u8; 0x02],
    #[doc = "0xe9 - A/D Sampling State Register"]
    pub adsstr9: ADSSTR9,
    #[doc = "0xea - A/D Sampling State Register"]
    pub adsstr10: ADSSTR9,
}
impl RegisterBlock {
    #[doc = "0x2a - A/D Data Registers %s"]
    #[inline(always)]
    pub fn addr5(&self) -> &ADDR {
        &self.addr[0]
    }
    #[doc = "0x2c - A/D Data Registers %s"]
    #[inline(always)]
    pub fn addr6(&self) -> &ADDR {
        &self.addr[1]
    }
    #[doc = "0xe5 - A/D Sampling State Register"]
    #[inline(always)]
    pub fn adsstr5(&self) -> &ADSSTR {
        &self.adsstr[0]
    }
    #[doc = "0xe6 - A/D Sampling State Register"]
    #[inline(always)]
    pub fn adsstr6(&self) -> &ADSSTR {
        &self.adsstr[1]
    }
}
...
pub mod addr;
pub use addr as addr9;
pub use addr as addr19;
pub use ADDR as ADDR9;
pub use ADDR as ADDR19;
