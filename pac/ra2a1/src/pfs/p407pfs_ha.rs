#[doc = "Register `P407PFS_HA` reader"]
pub struct R(crate::R<P407PFS_HA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P407PFS_HA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P407PFS_HA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P407PFS_HA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P407PFS_HA` writer"]
pub struct W(crate::W<P407PFS_HA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P407PFS_HA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P407PFS_HA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P407PFS_HA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P407PFS_HA_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P407PFS_HA_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P407PFS_HA_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P407PFS_HA_SPEC, NCODR_A, O>;
...
pub type DSCR1_R = crate::FieldReader<u8, DSCR1_A>;
...
pub enum DSCR1_A {
    ...
    #[doc = "1: Middle drive"]
    _01 = 1,
    #[doc = "2: Middle drive for IIC Fast-mode and SPI"]
    _10 = 2,
    #[doc = "3: Setting prohibited."]
    _11 = 3,
}
impl From<DSCR1_A> for u8 {
    #[inline(always)]
...
pub type DSCR1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, P407PFS_HA_SPEC, u8, DSCR1_A, 2, O>;
impl<'a, const O: u8> DSCR1_W<'a, O> {
    #[doc = "Low drive"]
    #[inline(always)]
    pub fn _00(self) -> &'a mut W {
        self.variant(DSCR1_A::_00)
    }
    #[doc = "Middle drive"]
    #[inline(always)]
    pub fn _01(self) -> &'a mut W {
        self.variant(DSCR1_A::_01)
    }
    #[doc = "Middle drive for IIC Fast-mode and SPI"]
    #[inline(always)]
    pub fn _10(self) -> &'a mut W {
        self.variant(DSCR1_A::_10)
    }
    #[doc = "Setting prohibited."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut W {
        self.variant(DSCR1_A::_11)
    }
}
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, P407PFS_HA_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, P407PFS_HA_SPEC, ASEL_A, O>;
...
impl R {
    ...
    #[doc = "Bits 10:11 - Drive Strength Control Register"]
    #[inline(always)]
    pub fn dscr1(&self) -> DSCR1_R {
        DSCR1_R::new(((self.bits >> 10) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dscr1(&mut self) -> DSCR1_W<10> {
        DSCR1_W::new(self)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
...
#[doc = "P407 Pin Function Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p407pfs_ha](index.html) module"]
pub struct P407PFS_HA_SPEC;
impl crate::RegisterSpec for P407PFS_HA_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [p407pfs_ha::R](R) reader structure"]
impl crate::Readable for P407PFS_HA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p407pfs_ha::W](W) writer structure"]
impl crate::Writable for P407PFS_HA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P407PFS_HA to value 0"]
impl crate::Resettable for P407PFS_HA_SPEC {
