#[doc = "Register `P407PFS` reader"]
pub struct R(crate::R<P407PFS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P407PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P407PFS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P407PFS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P407PFS` writer"]
pub struct W(crate::W<P407PFS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P407PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P407PFS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P407PFS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, NCODR_A, O>;
...
pub type DSCR1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, P407PFS_SPEC, u8, DSCR1_A, 2, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, ASEL_A, O>;
...
pub type PMR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P407PFS_SPEC, PMR_A, O>;
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, P407PFS_SPEC, u8, u8, 5, O>;
impl R {
...
impl crate::RegisterSpec for P407PFS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [p407pfs::R](R) reader structure"]
impl crate::Readable for P407PFS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p407pfs::W](W) writer structure"]
impl crate::Writable for P407PFS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P407PFS to value 0"]
impl crate::Resettable for P407PFS_SPEC {
