#[doc = "Register `AMP2MS` reader"]
pub struct R(crate::R<AMP2MS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AMP2MS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AMP2MS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AMP2MS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AMP2MS` writer"]
pub struct W(crate::W<AMP2MS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AMP2MS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AMP2MS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AMP2MS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `AMPMS0` reader - AMP2- pin select"]
pub type AMPMS0_R = crate::BitReader<AMPMS0_A>;
#[doc = "AMP2- pin select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AMPMS0_A {
    #[doc = "0: AMP2- pin is not connected to the AMP2 minus input"]
    _0 = 0,
    #[doc = "1: AMP2- pin is connected to the AMP2 minus input"]
    _1 = 1,
}
...
#[doc = "Field `AMPMS0` writer - AMP2- pin select"]
pub type AMPMS0_W<'a, const O: u8> = crate::BitWriter<'a, u8, AMP2MS_SPEC, AMPMS0_A, O>;
...
pub type AMPMS7_W<'a, const O: u8> = crate::BitWriter<'a, u8, AMP2MS_SPEC, AMPMS7_A, O>;
...
#[doc = "Operational Amplifier 2 Minus Input Select Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [amp2ms](index.html) module"]
pub struct AMP2MS_SPEC;
impl crate::RegisterSpec for AMP2MS_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [amp2ms::R](R) reader structure"]
impl crate::Readable for AMP2MS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [amp2ms::W](W) writer structure"]
impl crate::Writable for AMP2MS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AMP2MS to value 0"]
impl crate::Resettable for AMP2MS_SPEC {
