...
pub struct R(crate::R<BCNT0AER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BCNT0AER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BCNT0AER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BCNT0AER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BCNT0AER` writer"]
pub struct W(crate::W<BCNT0AER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BCNT0AER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BCNT0AER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BCNT0AER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENB_W<'a, const O: u8> = crate::FieldWriter<'a, u8, BCNT0AER_SPEC, u8, u8, 8, O>;
impl R {
