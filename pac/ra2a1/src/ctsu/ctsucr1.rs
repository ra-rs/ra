...
impl CTSUATUNE0_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CTSUATUNE0_A {
        match self.bits {
...
pub type CTSUATUNE0_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTSUCR1_SPEC, CTSUATUNE0_A, O>;
impl<'a, const O: u8> CTSUATUNE0_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ctsuatune0(&mut self) -> CTSUATUNE0_W<2> {
