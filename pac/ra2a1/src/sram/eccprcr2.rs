...
#[repr(u8)]
pub enum KW_AW {
    #[doc = "120: Writing to the ECCPRCR2 bit is valid, when the KEY bits are written 1111000b."]
    _1111000 = 120,
}
...
pub type KW_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ECCPRCR2_SPEC, u8, KW_AW, 7, O>;
