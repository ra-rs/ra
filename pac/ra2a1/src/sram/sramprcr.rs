...
pub enum SRAMPRCR_A {
    #[doc = "0: Writing to the protected register is disabled."]
    _0 = 0,
    #[doc = "1: Writing to the protected register is enabled."]
    _1 = 1,
}
...
pub type KW_W<'a, const O: u8> = crate::FieldWriter<'a, u8, SRAMPRCR_SPEC, u8, KW_AW, 7, O>;
