...
pub struct R(crate::R<LVD1CR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LVD1CR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LVD1CR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LVD1CR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LVD1CR1` writer"]
pub struct W(crate::W<LVD1CR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LVD1CR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LVD1CR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LVD1CR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum IDTSEL_A {
    ...
    _00 = 0,
    #[doc = "1: When VCC<Vdet1 (drop) is detected"]
    _01 = 1,
...
pub type IDTSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, LVD1CR1_SPEC, u8, IDTSEL_A, 2, O>;
...
pub type IRQSEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, LVD1CR1_SPEC, IRQSEL_A, O>;
