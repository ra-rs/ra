...
pub type GTCCRE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `GTCCRE` writer - Compare Capture Register E"]
pub type GTCCRE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTCCRE_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Compare Capture Register E"]
    #[inline(always)]
    pub fn gtccre(&self) -> GTCCRE_R {
        GTCCRE_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Compare Capture Register E"]
    #[inline(always)]
    #[must_use]
    pub fn gtccre(&mut self) -> GTCCRE_W<0> {
        GTCCRE_W::new(self)
    }
