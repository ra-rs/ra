...
pub type GTPBR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `GTPBR` writer - Cycle Setting Buffer Register"]
pub type GTPBR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTPBR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Cycle Setting Buffer Register"]
    #[inline(always)]
    pub fn gtpbr(&self) -> GTPBR_R {
        GTPBR_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Cycle Setting Buffer Register"]
    #[inline(always)]
    #[must_use]
    pub fn gtpbr(&mut self) -> GTPBR_W<0> {
        GTPBR_W::new(self)
    }
