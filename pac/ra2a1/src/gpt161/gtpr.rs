...
pub type GTPR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `GTPR` writer - Cycle Setting Register"]
pub type GTPR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTPR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Cycle Setting Register"]
    #[inline(always)]
    pub fn gtpr(&self) -> GTPR_R {
        GTPR_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Cycle Setting Register"]
