...
#[repr(u32)]
pub enum EID_A {
    #[doc = "0: Corresponding EID\\[17:0\\]
bits are 0"]
    _0 = 0,
    #[doc = "1: Corresponding EID\\[17:0\\]
bits are 1"]
    _1 = 1,
}
...
pub type EID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIDCR_SPEC, u32, EID_A, 18, O>;
impl<'a, const O: u8> EID_W<'a, O> {
    #[doc = "Corresponding EID\\[17:0\\]
bits are 0"]
    #[inline(always)]
...
#[repr(u16)]
pub enum SID_A {
    #[doc = "0: Corresponding SID\\[10:0\\]
bits are 0"]
    _0 = 0,
    #[doc = "1: Corresponding SID\\[10:0\\]
bits are 1"]
    _1 = 1,
}
...
pub type SID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIDCR_SPEC, u16, SID_A, 11, O>;
impl<'a, const O: u8> SID_W<'a, O> {
    #[doc = "Corresponding SID\\[10:0\\]
bits are 0"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
