...
pub type EID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MB_ID_SPEC, u32, EID_A, 18, O>;
...
pub type SID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MB_ID_SPEC, u16, SID_A, 11, O>;
