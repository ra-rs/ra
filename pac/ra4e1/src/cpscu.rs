...
pub struct RegisterBlock {
    ...
    pub icusard: ICUSARD,
    _reserved8: [u8; 0x04],
    #[doc = "0x54 - Interrupt Controller Unit Security Attribution Register F"]
    pub icusarf: ICUSARF,
    _reserved9: [u8; 0x18],
...
pub mod icusard;
#[doc = "ICUSARF (rw) register accessor: an alias for `Reg<ICUSARF_SPEC>`"]
pub type ICUSARF = crate::Reg<icusarf::ICUSARF_SPEC>;
