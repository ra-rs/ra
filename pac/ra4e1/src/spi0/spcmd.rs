...
pub type CPHA_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, CPHA_A, O>;
...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, CPOL_A, O>;
...
pub type BRDV_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, SPCMD_SPEC, u8, BRDV_A, 2, O>;
...
pub type SSLA_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SPCMD_SPEC, u8, SSLA_A, 3, O>;
...
#[doc = "Field `SSLKP` reader - SSL Signal Level Keeping"]
pub type SSLKP_R = crate::BitReader<SSLKP_A>;
#[doc = "SSL Signal Level Keeping\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSLKP_A {
    #[doc = "0: Negate all SSL signals on completion of transfer"]
    _0 = 0,
    #[doc = "1: Keep SSL signal level from the end of transfer until the beginning of the next access"]
    _1 = 1,
}
...
#[doc = "Field `SSLKP` writer - SSL Signal Level Keeping"]
pub type SSLKP_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, SSLKP_A, O>;
...
pub type SPB_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SPCMD_SPEC, u8, SPB_A, 4, O>;
...
pub type LSBF_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, LSBF_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPNDEN_A {
    #[doc = "0: Select next-access delay of 1 RSPCK + 2 PCLKA"]
    _0 = 0,
...
pub type SPNDEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, SPNDEN_A, O>;
...
pub type SLNDEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, SLNDEN_A, O>;
...
pub type SCKDEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, SPCMD_SPEC, SCKDEN_A, O>;
...
impl R {
    ...
    #[doc = "Bit 7 - SSL Signal Level Keeping"]
    #[inline(always)]
...
#[doc = "`reset()` method sets SPCMD%s to value 0x070d"]
