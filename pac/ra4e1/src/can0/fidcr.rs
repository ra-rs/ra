...
pub struct R(crate::R<FIDCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FIDCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FIDCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FIDCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FIDCR%s` writer"]
pub struct W(crate::W<FIDCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FIDCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FIDCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FIDCR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EID` reader - Extended ID of data and remote frames"]
pub type EID_R = crate::FieldReader<u32, u32>;
#[doc = "Field `EID` writer - Extended ID of data and remote frames"]
pub type EID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIDCR_SPEC, u32, u32, 18, O>;
#[doc = "Field `SID` reader - Standard ID of data and remote frames"]
pub type SID_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SID` writer - Standard ID of data and remote frames"]
pub type SID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIDCR_SPEC, u16, u16, 11, O>;
...
pub type RTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, FIDCR_SPEC, RTR_A, O>;
...
pub type IDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, FIDCR_SPEC, IDE_A, O>;
...
impl R {
    #[doc = "Bits 0:17 - Extended ID of data and remote frames"]
    #[inline(always)]
    pub fn eid(&self) -> EID_R {
        EID_R::new(self.bits & 0x0003_ffff)
    }
    #[doc = "Bits 18:28 - Standard ID of data and remote frames"]
    #[inline(always)]
