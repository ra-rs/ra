...
pub enum RFE_A {
    #[doc = "0: Disable receive FIFO"]
    _0 = 0,
    #[doc = "1: Enable receive FIFO"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RFMLF_A {
    #[doc = "0: Receive FIFO message not lost"]
    _0 = 0,
    #[doc = "1: Receive FIFO message lost"]
    _1 = 1,
}
...
pub enum RFFST_A {
    ...
    _0 = 0,
    #[doc = "1: Receive FIFO full (4 unread messages)"]
    _1 = 1,
}
