...
pub type SODRV_R = crate::BitReader<SODRV_A>;
...
pub type SODRV_W<'a, const O: u8> = crate::BitWriter<'a, u8, SOMCR_SPEC, SODRV_A, O>;
impl<'a, const O: u8> SODRV_W<'a, O> {
    #[doc = "Standard"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SODRV_A::_0)
    }
    #[doc = "Low"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(SODRV_A::_1)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sodrv(&mut self) -> SODRV_W<1> {
        SODRV_W::new(self)
    }
