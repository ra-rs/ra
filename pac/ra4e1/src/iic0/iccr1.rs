...
pub enum SDAI_A {
    #[doc = "0: SDA0 line is low"]
    _0 = 0,
    #[doc = "1: SDA0 line is high"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SCLI_A {
    #[doc = "0: SCL0 line is low"]
    _0 = 0,
    #[doc = "1: SCL0 line is high"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDAO_A {
    #[doc = "0: Read: IIC drives SDA0 pin low Write: IIC drives SDA0 pin low"]
    _0 = 0,
    #[doc = "1: Read: IIC releases SDA0 pin Write: IIC releases SDA0 pin"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SCLO_A {
    #[doc = "0: Read: IIC drives SCL0 pin low Write: IIC drives SCL0 pin low"]
    _0 = 0,
    #[doc = "1: Read: IIC releases SCL0 pin Write: IIC releases SCL0 pin"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ICE_A {
    #[doc = "0: Disable (SCL0 and SDA0 pins in inactive state)"]
    _0 = 0,
    #[doc = "1: Enable (SCL0 and SDA0 pins in active state)"]
    _1 = 1,
}
