...
pub struct RegisterBlock {
    ...
    pub adrd: ADRD,
    #[doc = "0x20..0x2a - A/D Data Registers %s"]
    pub addr: [ADDR; 5],
    _reserved15: [u8; 0x0e],
    ...
    pub addr12: ADDR11,
    #[doc = "0x3c - A/D Data Registers %s"]
    pub addr13: ADDR11,
    _reserved18: [u8; 0x04],
    #[doc = "0x42 - A/D Data Registers 16"]
    pub addr16: ADDR16,
    _reserved19: [u8; 0x36],
    ...
    pub adsstro: ADSSTRO,
    #[doc = "0xe0..0xe5 - A/D Sampling State Register"]
    pub adsstr: [ADSSTR; 5],
    _reserved45: [u8; 0x07],
    #[doc = "0xec - A/D Sampling State Register"]
    pub adsstr11: ADSSTR11,
    #[doc = "0xed - A/D Sampling State Register"]
    pub adsstr12: ADSSTR11,
    #[doc = "0xee - A/D Sampling State Register"]
    pub adsstr13: ADSSTR11,
}
