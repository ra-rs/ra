#[doc = "Register `P206PFS` reader"]
pub struct R(crate::R<P206PFS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P206PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P206PFS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P206PFS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P206PFS` writer"]
pub struct W(crate::W<P206PFS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P206PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P206PFS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P206PFS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, NCODR_A, O>;
...
pub type EOFR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, P206PFS_SPEC, u8, EOFR_A, 2, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, ASEL_A, O>;
...
pub type PMR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P206PFS_SPEC, PMR_A, O>;
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, P206PFS_SPEC, u8, u8, 5, O>;
impl R {
...
#[doc = "Port 1n206 Pin Function Select Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p206pfs](index.html) module"]
pub struct P206PFS_SPEC;
impl crate::RegisterSpec for P206PFS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [p206pfs::R](R) reader structure"]
impl crate::Readable for P206PFS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p206pfs::W](W) writer structure"]
impl crate::Writable for P206PFS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P206PFS to value 0"]
impl crate::Resettable for P206PFS_SPEC {
