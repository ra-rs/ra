...
#[doc = "Field `SFMRM` reader - Serial interface read mode select"]
...
impl SFMRM_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<SFMRM_A> {
        match self.bits {
            0 => Some(SFMRM_A::_000),
            1 => Some(SFMRM_A::_001),
            2 => Some(SFMRM_A::_010),
...
#[doc = "Field `SFMRM` writer - Serial interface read mode select"]
pub type SFMRM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SFMSMD_SPEC, u8, SFMRM_A, 3, O>;
...
#[doc = "Field `SFMSE` reader - QSSL extension function select after SPI bus access"]
pub type SFMSE_R = crate::FieldReader<u8, SFMSE_A>;
#[doc = "QSSL extension function select after SPI bus access\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum SFMSE_A {
    #[doc = "0: Do not extend QSSL"]
    _00 = 0,
    #[doc = "1: Extend QSSL by 33 QSPCLK"]
    _01 = 1,
    #[doc = "2: Extend QSSL by 129 QSPCLK"]
    _10 = 2,
    #[doc = "3: Extend QSSL infinitely"]
    _11 = 3,
}
...
#[doc = "Field `SFMSE` writer - QSSL extension function select after SPI bus access"]
...
#[doc = "Field `SFMPFE` reader - Prefetch function select"]
pub type SFMPFE_R = crate::BitReader<SFMPFE_A>;
#[doc = "Prefetch function select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SFMPFE_A {
    #[doc = "0: Disable function"]
    _0 = 0,
    #[doc = "1: Enable function"]
    _1 = 1,
}
...
#[doc = "Field `SFMPFE` writer - Prefetch function select"]
...
#[doc = "Field `SFMPAE` reader - Function select for stopping prefetch at locations other than on byte boundaries"]
...
#[doc = "Field `SFMPAE` writer - Function select for stopping prefetch at locations other than on byte boundaries"]
...
#[doc = "Field `SFMMD3` reader - SPI mode select."]
...
#[doc = "Field `SFMMD3` writer - SPI mode select."]
...
#[doc = "Field `SFMOEX` reader - Extension select for the I/O buffer output enable signal for the serial interface"]
...
#[doc = "Field `SFMOEX` writer - Extension select for the I/O buffer output enable signal for the serial interface"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SFMOHW_A {
    #[doc = "0: Do not extend high-level width of QSPCLK during transmission"]
    _0 = 0,
    #[doc = "1: Extend high-level width of QSPCLK by 1 PCLKA during transmission"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SFMOSW_A {
    #[doc = "0: Do not extend low-level width of QSPCLK during transmission"]
    _0 = 0,
    #[doc = "1: Extend low-level width of QSPCLK by 1 PCLKA during transmission"]
    _1 = 1,
}
...
#[doc = "Field `SFMCCE` reader - Read instruction code select"]
pub type SFMCCE_R = crate::BitReader<SFMCCE_A>;
#[doc = "Read instruction code select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SFMCCE_A {
    #[doc = "0: Uses automatically generated SPI instruction code"]
    _0 = 0,
    #[doc = "1: Use instruction code in the SFMSIC register"]
    _1 = 1,
}
...
#[doc = "Field `SFMCCE` writer - Read instruction code select"]
...
impl R {
    #[doc = "Bits 0:2 - Serial interface read mode select"]
    #[inline(always)]
    pub fn sfmrm(&self) -> SFMRM_R {
        SFMRM_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:5 - QSSL extension function select after SPI bus access"]
    #[inline(always)]
    pub fn sfmse(&self) -> SFMSE_R {
        SFMSE_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bit 6 - Prefetch function select"]
    #[inline(always)]
    pub fn sfmpfe(&self) -> SFMPFE_R {
        SFMPFE_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Function select for stopping prefetch at locations other than on byte boundaries"]
    #[inline(always)]
    pub fn sfmpae(&self) -> SFMPAE_R {
        SFMPAE_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - SPI mode select."]
    #[inline(always)]
    pub fn sfmmd3(&self) -> SFMMD3_R {
        SFMMD3_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Extension select for the I/O buffer output enable signal for the serial interface"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - Read instruction code select"]
    #[inline(always)]
