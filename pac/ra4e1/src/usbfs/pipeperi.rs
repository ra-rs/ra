...
#[doc = "Field `IITV` reader - Interval Error Detection Interval"]
pub type IITV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IITV` writer - Interval Error Detection Interval"]
...
impl R {
    #[doc = "Bits 0:2 - Interval Error Detection Interval"]
    #[inline(always)]
