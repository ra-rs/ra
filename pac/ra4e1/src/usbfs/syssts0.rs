...
#[doc = "Field `OVCMON` reader - External USB_OVRCURA Input Pin Monitor"]
pub type OVCMON_R = crate::BitReader<bool>;
impl R {
    ...
    #[doc = "Bit 15 - External USB_OVRCURA Input Pin Monitor"]
    #[inline(always)]
    pub fn ovcmon(&self) -> OVCMON_R {
        OVCMON_R::new(((self.bits >> 15) & 1) != 0)
    }
}
