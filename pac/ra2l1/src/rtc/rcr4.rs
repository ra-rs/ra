...
#[doc = "Field `RCKSEL` reader - Count Source Select in normal operation mode"]
...
#[doc = "Field `RCKSEL` writer - Count Source Select in normal operation mode"]
...
#[doc = "Field `ROPSEL` reader - RTC Operation Mode Select"]
pub type ROPSEL_R = crate::BitReader<ROPSEL_A>;
#[doc = "RTC Operation Mode Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ROPSEL_A {
    #[doc = "0: Normal operation mode is selected."]
    _0 = 0,
    #[doc = "1: Low-consumption clock mode is selected."]
    _1 = 1,
}
impl From<ROPSEL_A> for bool {
    #[inline(always)]
    fn from(variant: ROPSEL_A) -> Self {
        variant as u8 != 0
    }
}
impl ROPSEL_R {
...
#[doc = "Field `ROPSEL` writer - RTC Operation Mode Select"]
pub type ROPSEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, RCR4_SPEC, ROPSEL_A, O>;
impl<'a, const O: u8> ROPSEL_W<'a, O> {
    #[doc = "Normal operation mode is selected."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ROPSEL_A::_0)
    }
    #[doc = "Low-consumption clock mode is selected."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ROPSEL_A::_1)
    }
}
impl R {
    #[doc = "Bit 0 - Count Source Select in normal operation mode"]
    #[inline(always)]
    pub fn rcksel(&self) -> RCKSEL_R {
        RCKSEL_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 7 - RTC Operation Mode Select"]
    #[inline(always)]
    pub fn ropsel(&self) -> ROPSEL_R {
        ROPSEL_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Count Source Select in normal operation mode"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ropsel(&mut self) -> ROPSEL_W<7> {
        ROPSEL_W::new(self)
    }
