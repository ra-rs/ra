...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ATUNE0_A {
    #[doc = "0: VCC â\u{89}¥ 2.4 V: Normal voltage operating mode VCC < 2.4 V: Setting prohibited"]
    _0 = 0,
...
impl<'a, const O: u8> ATUNE0_W<'a, O> {
    #[doc = "VCC â\u{89}¥ 2.4 V: Normal voltage operating mode VCC < 2.4 V: Setting prohibited"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ATUNE1_A {
    #[doc = "0: 80 ÂµA when ATUNE2 = 0 20 ÂµA when ATUNE2 = 1"]
    _0 = 0,
    #[doc = "1: 40 ÂµA when ATUNE2 = 0 160 ÂµA when ATUNE2 = 1"]
    _1 = 1,
}
...
impl<'a, const O: u8> ATUNE1_W<'a, O> {
    #[doc = "80 ÂµA when ATUNE2 = 0 20 ÂµA when ATUNE2 = 1"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ATUNE1_A::_0)
    }
    #[doc = "40 ÂµA when ATUNE2 = 0 160 ÂµA when ATUNE2 = 1"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ATUNE2_A {
    #[doc = "0: 80 ÂµA when ATUNE1 = 0 40 ÂµA when ATUNE1 = 1"]
    _0 = 0,
    #[doc = "1: 20 ÂµA when ATUNE1 = 0 160 ÂµA when ATUNE1 = 1"]
    _1 = 1,
}
...
impl<'a, const O: u8> ATUNE2_W<'a, O> {
    #[doc = "80 ÂµA when ATUNE1 = 0 40 ÂµA when ATUNE1 = 1"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ATUNE2_A::_0)
    }
    #[doc = "20 ÂµA when ATUNE1 = 0 160 ÂµA when ATUNE1 = 1"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[repr(u8)]
pub enum LOAD_A {
    #[doc = "0: 2.5 ÂµA constant current load"]
    _00 = 0,
    #[doc = "1: No load"]
    _01 = 1,
    #[doc = "2: 20 ÂµA constant current load and overcurrent detector disabled"]
    _10 = 2,
...
impl<'a, const O: u8> LOAD_W<'a, O> {
    #[doc = "2.5 ÂµA constant current load"]
    #[inline(always)]
    pub fn _00(self) -> &'a mut W {
    ...
    #[doc = "20 ÂµA constant current load and overcurrent detector disabled"]
    #[inline(always)]
    pub fn _10(self) -> &'a mut W {
