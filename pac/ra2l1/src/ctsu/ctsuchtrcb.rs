...
#[doc = "Field `CHTRC35` reader - CTSU Channel Transmit/Receive Control B"]
pub type CHTRC35_R = crate::BitReader<CHTRC35_A>;
#[doc = "CTSU Channel Transmit/Receive Control B\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CHTRC35_A {
    #[doc = "0: Reception"]
...
impl From<CHTRC35_A> for bool {
    #[inline(always)]
    fn from(variant: CHTRC35_A) -> Self {
        variant as u8 != 0
    }
}
impl CHTRC35_R {
...
#[doc = "Field `CHTRC35` writer - CTSU Channel Transmit/Receive Control B"]
pub type CHTRC35_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTSUCHTRCB_SPEC, CHTRC35_A, O>;
impl<'a, const O: u8> CHTRC35_W<'a, O> {
    #[doc = "Reception"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CHTRC35_A::_0)
    }
    #[doc = "Transmission"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CHTRC35_A::_1)
    }
}
impl R {
    ...
    #[doc = "Bit 3 - CTSU Channel Transmit/Receive Control B"]
    #[inline(always)]
    pub fn chtrc35(&self) -> CHTRC35_R {
        CHTRC35_R::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - CTSU Channel Transmit/Receive Control B"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn chtrc35(&mut self) -> CHTRC35_W<3> {
        CHTRC35_W::new(self)
    }
