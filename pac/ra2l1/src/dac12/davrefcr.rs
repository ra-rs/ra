...
pub enum REF_A {
    #[doc = "0: No reference voltage selected."]
    _0 = 0,
    #[doc = "1: AVCC0/AVSS0 selected."]
    _1 = 1,
}
...
pub type REF_W<'a, const O: u8> = crate::BitWriter<'a, u8, DAVREFCR_SPEC, REF_A, O>;
...
impl R {
    #[doc = "Bit 0 - D/A Reference Voltage Select"]
    #[inline(always)]
    pub fn ref_(&self) -> REF_R {
        REF_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - D/A Reference Voltage Select"]
