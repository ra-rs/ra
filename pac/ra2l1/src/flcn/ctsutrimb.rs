...
#[doc = "Field `TRESULT0` reader - The coefficient of variation for the 7.5 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRESULT0` writer - The coefficient of variation for the 7.5 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTSUTRIMB_SPEC, u8, u8, 8, O>;
#[doc = "Field `TRESULT1` reader - The coefficient of variation for the 15 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRESULT1` writer - The coefficient of variation for the 15 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTSUTRIMB_SPEC, u8, u8, 8, O>;
#[doc = "Field `TRESULT2` reader - The coefficient of variation for the 30 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRESULT2` writer - The coefficient of variation for the 30 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTSUTRIMB_SPEC, u8, u8, 8, O>;
#[doc = "Field `TRESULT3` reader - The coefficient of variation for the 60 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRESULT3` writer - The coefficient of variation for the 60 kâ\u{84}¦ reference load resistance is stored."]
pub type TRESULT3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTSUTRIMB_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - The coefficient of variation for the 7.5 kâ\u{84}¦ reference load resistance is stored."]
    #[inline(always)]
    pub fn tresult0(&self) -> TRESULT0_R {
        TRESULT0_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - The coefficient of variation for the 15 kâ\u{84}¦ reference load resistance is stored."]
    #[inline(always)]
    pub fn tresult1(&self) -> TRESULT1_R {
        TRESULT1_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - The coefficient of variation for the 30 kâ\u{84}¦ reference load resistance is stored."]
    #[inline(always)]
    pub fn tresult2(&self) -> TRESULT2_R {
        TRESULT2_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - The coefficient of variation for the 60 kâ\u{84}¦ reference load resistance is stored."]
    #[inline(always)]
