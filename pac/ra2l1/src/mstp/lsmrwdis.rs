...
pub type RTCRWDIS_R = crate::BitReader<RTCRWDIS_A>;
...
impl From<RTCRWDIS_A> for bool {
    #[inline(always)]
    fn from(variant: RTCRWDIS_A) -> Self {
        variant as u8 != 0
    }
}
impl RTCRWDIS_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> RTCRWDIS_A {
        match self.bits {
            false => RTCRWDIS_A::_0,
            true => RTCRWDIS_A::_1,
        }
...
pub type RTCRWDIS_W<'a, const O: u8> = crate::BitWriter<'a, u16, LSMRWDIS_SPEC, RTCRWDIS_A, O>;
impl<'a, const O: u8> RTCRWDIS_W<'a, O> {
    #[doc = "RTC register R/W clock always on"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(RTCRWDIS_A::_0)
    }
    #[doc = "RTC register R/W clock stops"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(RTCRWDIS_A::_1)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn rtcrwdis(&self) -> RTCRWDIS_R {
        RTCRWDIS_R::new((self.bits & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtcrwdis(&mut self) -> RTCRWDIS_W<0> {
        RTCRWDIS_W::new(self)
    }
    #[doc = "Bit 1 - WDT Operate Clock Control"]
    #[inline(always)]
