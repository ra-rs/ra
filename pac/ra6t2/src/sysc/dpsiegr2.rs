...
#[doc = "Field `DLVD1EG` reader - LVD1 Edge Select"]
pub type DLVD1EG_R = crate::BitReader<DLVD1EG_A>;
#[doc = "LVD1 Edge Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DLVD1EG_A {
    #[doc = "0: A cancel request is generated when VCC < Vdet1 (fall) is detected"]
    _0 = 0,
    #[doc = "1: A cancel request is generated when VCC â\u{89}¥ Vdet1 (rise) is detected"]
    _1 = 1,
}
impl From<DLVD1EG_A> for bool {
    #[inline(always)]
    fn from(variant: DLVD1EG_A) -> Self {
        variant as u8 != 0
    }
}
impl DLVD1EG_R {
...
#[doc = "Field `DLVD1EG` writer - LVD1 Edge Select"]
pub type DLVD1EG_W<'a, const O: u8> = crate::BitWriter<'a, u8, DPSIEGR2_SPEC, DLVD1EG_A, O>;
impl<'a, const O: u8> DLVD1EG_W<'a, O> {
    #[doc = "A cancel request is generated when VCC < Vdet1 (fall) is detected"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DLVD1EG_A::_0)
    }
    #[doc = "A cancel request is generated when VCC â\u{89}¥ Vdet1 (rise) is detected"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(DLVD1EG_A::_1)
    }
}
#[doc = "Field `DLVD2EG` reader - LVD2 Edge Select"]
pub type DLVD2EG_R = crate::BitReader<DLVD2EG_A>;
#[doc = "LVD2 Edge Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DLVD2EG_A {
    #[doc = "0: A cancel request is generated when VCC < Vdet2 (fall) is detected"]
    _0 = 0,
    #[doc = "1: A cancel request is generated when VCC â\u{89}¥ Vdet2 (rise) is detected"]
    _1 = 1,
}
impl From<DLVD2EG_A> for bool {
    #[inline(always)]
    fn from(variant: DLVD2EG_A) -> Self {
        variant as u8 != 0
    }
}
impl DLVD2EG_R {
...
#[doc = "Field `DLVD2EG` writer - LVD2 Edge Select"]
pub type DLVD2EG_W<'a, const O: u8> = crate::BitWriter<'a, u8, DPSIEGR2_SPEC, DLVD2EG_A, O>;
impl<'a, const O: u8> DLVD2EG_W<'a, O> {
    #[doc = "A cancel request is generated when VCC < Vdet2 (fall) is detected"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DLVD2EG_A::_0)
    }
    #[doc = "A cancel request is generated when VCC â\u{89}¥ Vdet2 (rise) is detected"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(DLVD2EG_A::_1)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn dlvd1eg(&self) -> DLVD1EG_R {
        DLVD1EG_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - LVD2 Edge Select"]
    #[inline(always)]
    pub fn dlvd2eg(&self) -> DLVD2EG_R {
        DLVD2EG_R::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dlvd1eg(&mut self) -> DLVD1EG_W<0> {
        DLVD1EG_W::new(self)
    }
    #[doc = "Bit 1 - LVD2 Edge Select"]
    #[inline(always)]
    #[must_use]
    pub fn dlvd2eg(&mut self) -> DLVD2EG_W<1> {
        DLVD2EG_W::new(self)
    }
    #[doc = "Bit 4 - NMI Pin Edge Select"]
    #[inline(always)]
