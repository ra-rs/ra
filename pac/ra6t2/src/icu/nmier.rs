...
#[doc = "Field `BUSMEN` reader - Bus Master MPU Error Interrupt Enable"]
...
#[doc = "Field `BUSMEN` writer - Bus Master MPU Error Interrupt Enable"]
...
#[doc = "Field `TZFEN` reader - "]
pub type TZFEN_R = crate::BitReader<TZFEN_A>;
#[doc = "\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TZFEN_A {
    #[doc = "0: Disabled"]
...
impl From<TZFEN_A> for bool {
    #[inline(always)]
    fn from(variant: TZFEN_A) -> Self {
        variant as u8 != 0
    }
}
impl TZFEN_R {
...
#[doc = "Field `TZFEN` writer - "]
pub type TZFEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, NMIER_SPEC, TZFEN_A, O>;
impl<'a, const O: u8> TZFEN_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TZFEN_A::_0)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(TZFEN_A::_1)
    }
}
#[doc = "Field `CPEEN` reader - "]
pub type CPEEN_R = crate::BitReader<CPEEN_A>;
#[doc = "\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CPEEN_A {
    #[doc = "0: Disabled"]
...
impl From<CPEEN_A> for bool {
    #[inline(always)]
    fn from(variant: CPEEN_A) -> Self {
        variant as u8 != 0
    }
}
impl CPEEN_R {
...
#[doc = "Field `CPEEN` writer - "]
pub type CPEEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, NMIER_SPEC, CPEEN_A, O>;
impl<'a, const O: u8> CPEEN_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CPEEN_A::_0)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CPEEN_A::_1)
    }
}
impl R {
    ...
    #[doc = "Bit 11 - Bus Master MPU Error Interrupt Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn tzfen(&self) -> TZFEN_R {
        TZFEN_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn cpeen(&self) -> CPEEN_R {
        CPEEN_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - IWDT Underflow/Refresh Error Interrupt Enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzfen(&mut self) -> TZFEN_W<13> {
        TZFEN_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn cpeen(&mut self) -> CPEEN_W<15> {
        CPEEN_W::new(self)
    }
