#[doc = "Register `SDATBAS%s` reader"]
pub struct R(crate::R<SDATBAS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SDATBAS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SDATBAS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SDATBAS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SDATBAS%s` writer"]
pub struct W(crate::W<SDATBAS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SDATBAS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SDATBAS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SDATBAS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SDSTAD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SDATBAS_SPEC, u16, u16, 10, O>;
...
pub type SDADLS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDATBAS_SPEC, SDADLS_A, O>;
...
#[doc = "Slave Device Address Table Basic Register %s\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sdatbas](index.html) module"]
pub struct SDATBAS_SPEC;
impl crate::RegisterSpec for SDATBAS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sdatbas::R](R) reader structure"]
impl crate::Readable for SDATBAS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sdatbas::W](W) writer structure"]
impl crate::Writable for SDATBAS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SDATBAS%s to value 0"]
impl crate::Resettable for SDATBAS_SPEC {
