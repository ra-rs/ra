...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WUCNDDFC_AW {
    #[doc = "0: Not Force Wake-Up Condition Detection Interrupt for software testing."]
    _0 = 0,
    #[doc = "1: Force Wake-Up Condition Detection Interrupt for software testing."]
    _1 = 1,
}
impl From<WUCNDDFC_AW> for bool {
    #[inline(always)]
    fn from(variant: WUCNDDFC_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `WUCNDDFC` writer - Wake-Up Condition Detection Force"]
pub type WUCNDDFC_W<'a, const O: u8> = crate::BitWriter<'a, u32, BSTFC_SPEC, WUCNDDFC_AW, O>;
impl<'a, const O: u8> WUCNDDFC_W<'a, O> {
    #[doc = "Not Force Wake-Up Condition Detection Interrupt for software testing."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(WUCNDDFC_AW::_0)
    }
    #[doc = "Force Wake-Up Condition Detection Interrupt for software testing."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(WUCNDDFC_AW::_1)
    }
}
impl W {
    ...
    #[doc = "Bit 24 - Wake-Up Condition Detection Force"]
    #[inline(always)]
    #[must_use]
    pub fn wucnddfc(&mut self) -> WUCNDDFC_W<24> {
        WUCNDDFC_W::new(self)
    }
