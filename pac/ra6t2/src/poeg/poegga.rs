...
pub type OSTPF_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGGA_SPEC, OSTPF_A, O>;
...
pub type OSTPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGGA_SPEC, OSTPE_A, O>;
...
pub type CDRE0_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGGA_SPEC, CDRE0_A, O>;
...
pub type CDRE1_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGGA_SPEC, CDRE1_A, O>;
...
pub type CDRE2_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGGA_SPEC, CDRE2_A, O>;
...
pub type CDRE3_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGGA_SPEC, CDRE3_A, O>;
