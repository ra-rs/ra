#[doc = "Register `GTONCCRD` reader"]
pub struct R(crate::R<GTONCCRD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GTONCCRD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GTONCCRD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GTONCCRD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GTONCCRD` writer"]
pub struct W(crate::W<GTONCCRD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GTONCCRD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GTONCCRD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GTONCCRD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NE_W<'a, const O: u8> = crate::BitWriter<'a, u16, GTONCCRD_SPEC, NE_A, O>;
...
pub type NFS_W<'a, const O: u8> = crate::FieldWriter<'a, u16, GTONCCRD_SPEC, u8, NFS_A, 4, O>;
...
pub type NFV_W<'a, const O: u8> = crate::BitWriter<'a, u16, GTONCCRD_SPEC, NFV_A, O>;
...
#[doc = "GPT Output Stopping Control Group D Controlling Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gtonccrd](index.html) module"]
pub struct GTONCCRD_SPEC;
impl crate::RegisterSpec for GTONCCRD_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gtonccrd::R](R) reader structure"]
impl crate::Readable for GTONCCRD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gtonccrd::W](W) writer structure"]
impl crate::Writable for GTONCCRD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GTONCCRD to value 0x0100"]
impl crate::Resettable for GTONCCRD_SPEC {
