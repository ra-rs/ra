...
#[doc = "Field `FSADDR` reader - Start Address for FACI Command Processing"]
pub type FSADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FSADDR` writer - Start Address for FACI Command Processing"]
pub type FSADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FSADDR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Start Address for FACI Command Processing"]
    #[inline(always)]
    pub fn fsaddr(&self) -> FSADDR_R {
        FSADDR_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Start Address for FACI Command Processing"]
    #[inline(always)]
    #[must_use]
    pub fn fsaddr(&mut self) -> FSADDR_W<0> {
        FSADDR_W::new(self)
    }
