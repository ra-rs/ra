...
#[doc = "Field `SRPC0` reader - USB Single-ended Receiver Control"]
pub type SRPC0_R = crate::BitReader<SRPC0_A>;
#[doc = "USB Single-ended Receiver Control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SRPC0_A {
    #[doc = "0: Disable input through DP and DM inputs"]
    _0 = 0,
    #[doc = "1: Enable input through DP and DM inputs"]
    _1 = 1,
}
...
#[doc = "Field `SRPC0` writer - USB Single-ended Receiver Control"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RPUE0_A {
    #[doc = "0: Disable DP pull-up resistor"]
    _0 = 0,
    #[doc = "1: Enable DP pull-up resistor"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DRPD0_A {
    #[doc = "0: Disable DP/DM pull-down resistor"]
    _0 = 0,
    #[doc = "1: Enable DP/DM pull-down resistor"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FIXPHY0_A {
    #[doc = "0: Fix outputs in Normal mode and on return from Deep Software Standby mode"]
    _0 = 0,
    #[doc = "1: Fix outputs on transition to Deep Software Standby mode"]
    _1 = 1,
}
...
#[doc = "Field `DP0` reader - USB D+ Input"]
pub type DP0_R = crate::BitReader<bool>;
#[doc = "Field `DM0` reader - USB D- Input"]
pub type DM0_R = crate::BitReader<bool>;
#[doc = "Field `DOVCA0` reader - USB OVRCURA Input"]
pub type DOVCA0_R = crate::BitReader<bool>;
#[doc = "Field `DOVCB0` reader - USB OVRCURB Input"]
pub type DOVCB0_R = crate::BitReader<bool>;
#[doc = "Field `DVBSTS0` reader - USB VBUS Input"]
pub type DVBSTS0_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - USB Single-ended Receiver Control"]
    #[inline(always)]
