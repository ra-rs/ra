...
#[doc = "Field `CMPAB` reader - Window A/B Composite Conditions Setting"]
pub type CMPAB_R = crate::FieldReader<u8, CMPAB_A>;
#[doc = "Window A/B Composite Conditions Setting\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CMPAB_A {
    #[doc = "0: Output ADC12i_WCMPM (i = 0, 1) when window A OR window B comparison conditions are met. Otherwise, output ADC12i_WCMPUM (i = 0, 1)."]
    _00 = 0,
    #[doc = "1: Output ADC12i_WCMPM (i = 0, 1) when window A EXOR window B comparison conditions are met. Otherwise, output ADC12i_WCMPUM (i = 0, 1)."]
    _01 = 1,
    #[doc = "2: Output ADC12i_WCMPM (i = 0, 1) when window A AND window B comparison conditions are met. Otherwise, output ADC12i_WCMPUM (i = 0, 1)."]
    _10 = 2,
...
#[doc = "Field `CMPAB` writer - Window A/B Composite Conditions Setting"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPBE_A {
    #[doc = "0: Disable compare window B operation. Disable ADC12i_WCMPM (i = 0, 1) and ADC12i_WCMPUM (i = 0, 1) outputs."]
    _0 = 0,
    #[doc = "1: Enable compare window B operation."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPAE_A {
    #[doc = "0: Disable compare window A operation. Disable ADC12i_WCMPM (i = 0, 1) and ADC12i_WCMPUM (i = 0, 1) outputs."]
    _0 = 0,
    #[doc = "1: Enable compare window A operation."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPBIE_A {
    #[doc = "0: Disable ADC12i_CMPBI (i = 0, 1) interrupt when comparison conditions (window B) are met."]
    _0 = 0,
    #[doc = "1: Enable ADC12i_CMPBI (i = 0, 1) interrupt when comparison conditions (window B) are met."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WCMPE_A {
    #[doc = "0: Disable window function Window A and window B operate as a comparator to compare the single value on the lower side with the A/D conversion result."]
    _0 = 0,
    #[doc = "1: Enable window function Window A and window B operate as a comparator to compare the two values on the upper and lower sides with the A/D conversion result."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPAIE_A {
    #[doc = "0: Disable ADC12i_CMPAI (i = 0, 1) interrupt when comparison conditions (window A) are met."]
    _0 = 0,
    #[doc = "1: Enable ADC12i_CMPAI (i = 0, 1) interrupt when comparison conditions (window A) are met."]
    _1 = 1,
}
...
impl R {
    #[doc = "Bits 0:1 - Window A/B Composite Conditions Setting"]
    #[inline(always)]
