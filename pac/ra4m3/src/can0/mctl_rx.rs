...
pub enum NEWDATA_A {
    #[doc = "0: No data received, or 0 was written to the flag"]
    _0 = 0,
    #[doc = "1: New message being stored or was stored in the mailbox"]
    _1 = 1,
}
...
#[doc = "Field `INVALDATA` reader - Reception-in-Progress Status Flag"]
...
#[doc = "Field `MSGLOST` reader - Message Lost Flag"]
pub type MSGLOST_R = crate::BitReader<MSGLOST_A>;
#[doc = "Message Lost Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MSGLOST_A {
    #[doc = "0: Message not overwritten or overrun"]
    _0 = 0,
    #[doc = "1: Message overwritten or overrun"]
    _1 = 1,
}
...
#[doc = "Field `MSGLOST` writer - Message Lost Flag"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ONESHOT_A {
    #[doc = "0: Disable one-shot reception"]
    _0 = 0,
    #[doc = "1: Enable one-shot reception"]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 1 - Reception-in-Progress Status Flag"]
    #[inline(always)]
    pub fn invaldata(&self) -> INVALDATA_R {
        INVALDATA_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Message Lost Flag"]
    #[inline(always)]
