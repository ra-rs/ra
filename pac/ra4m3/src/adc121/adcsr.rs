...
pub enum GBADIE_A {
    #[doc = "0: Disable ADC12i_GBADI (i = 0, 1) interrupt generation on group B scan completion."]
    _0 = 0,
    #[doc = "1: Enable ADC12i_GBADI (i = 0, 1) interrupt generation on group B scan completion."]
    _1 = 1,
}
