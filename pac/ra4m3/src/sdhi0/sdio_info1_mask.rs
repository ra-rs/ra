...
pub enum IOIRQM_A {
    #[doc = "0: Do not mask IOIRQ interrupts"]
    _0 = 0,
    #[doc = "1: Mask IOIRQ interrupts"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum EXPUB52M_A {
    #[doc = "0: Do not mask EXPUB52 interrupt requests"]
    _0 = 0,
    #[doc = "1: Mask EXPUB52 interrupt requests"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum EXWTM_A {
    #[doc = "0: Do not mask EXWT interrupt requests"]
    _0 = 0,
    #[doc = "1: Mask EXWT interrupt requests"]
    _1 = 1,
}
