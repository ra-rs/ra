...
#[doc = "Field `IOIRQ` reader - SDIO Interrupt Status Flag"]
pub type IOIRQ_R = crate::BitReader<IOIRQ_A>;
#[doc = "SDIO Interrupt Status Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IOIRQ_A {
    #[doc = "0: No SDIO interrupt detected"]
    _0 = 0,
    #[doc = "1: SDIO interrupt detected"]
    _1 = 1,
}
...
#[doc = "Field `IOIRQ` writer - SDIO Interrupt Status Flag"]
pub type IOIRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDIO_INFO1_SPEC, IOIRQ_A, O>;
...
#[doc = "Field `EXPUB52` reader - EXPUB52 Status Flag"]
pub type EXPUB52_R = crate::BitReader<bool>;
#[doc = "Field `EXPUB52` writer - EXPUB52 Status Flag"]
pub type EXPUB52_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDIO_INFO1_SPEC, bool, O>;
#[doc = "Field `EXWT` reader - EXWT Status Flag"]
pub type EXWT_R = crate::BitReader<bool>;
#[doc = "Field `EXWT` writer - EXWT Status Flag"]
pub type EXWT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDIO_INFO1_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - SDIO Interrupt Status Flag"]
    #[inline(always)]
    pub fn ioirq(&self) -> IOIRQ_R {
        IOIRQ_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 14 - EXPUB52 Status Flag"]
    #[inline(always)]
    pub fn expub52(&self) -> EXPUB52_R {
        EXPUB52_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - EXWT Status Flag"]
    #[inline(always)]
