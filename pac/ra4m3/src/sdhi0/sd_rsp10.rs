...
#[doc = "Register `SD_RSP10` writer"]
pub struct W(crate::W<SD_RSP10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SD_RSP10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SD_RSP10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SD_RSP10_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [sd_rsp10::W](W) writer structure"]
impl crate::Writable for SD_RSP10_SPEC {
    type Writer = W;
