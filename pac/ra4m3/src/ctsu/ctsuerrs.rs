...
#[doc = "Field `CTSUCLKSEL1` reader - Calibration Setting 3"]
pub type CTSUCLKSEL1_R = crate::BitReader<CTSUCLKSEL1_A>;
#[doc = "Calibration Setting 3\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CTSUCLKSEL1_A {
    #[doc = "0: Capacitance measurement mode"]
    _0 = 0,
    #[doc = "1: Calibration setting 3"]
    _1 = 1,
}
impl From<CTSUCLKSEL1_A> for bool {
    #[inline(always)]
    fn from(variant: CTSUCLKSEL1_A) -> Self {
        variant as u8 != 0
    }
}
impl CTSUCLKSEL1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CTSUCLKSEL1_A {
        match self.bits {
            false => CTSUCLKSEL1_A::_0,
            true => CTSUCLKSEL1_A::_1,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == CTSUCLKSEL1_A::_0
    }
    #[doc = "Checks if the value of the field is `_1`"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == CTSUCLKSEL1_A::_1
    }
}
#[doc = "Field `CTSUCLKSEL1` writer - Calibration Setting 3"]
pub type CTSUCLKSEL1_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, CTSUERRS_SPEC, CTSUCLKSEL1_A, O>;
impl<'a, const O: u8> CTSUCLKSEL1_W<'a, O> {
    #[doc = "Capacitance measurement mode"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CTSUCLKSEL1_A::_0)
    }
    #[doc = "Calibration setting 3"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(CTSUCLKSEL1_A::_1)
    }
}
...
impl R {
    ...
    #[doc = "Bit 6 - Calibration Setting 3"]
    #[inline(always)]
    pub fn ctsuclksel1(&self) -> CTSUCLKSEL1_R {
        CTSUCLKSEL1_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ctsuclksel1(&mut self) -> CTSUCLKSEL1_W<6> {
        CTSUCLKSEL1_W::new(self)
    }
    #[doc = "Bit 7 - Calibration Setting 2"]
    #[inline(always)]
    #[must_use]
