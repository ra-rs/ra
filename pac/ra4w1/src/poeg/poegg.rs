...
#[doc = "Field `IOCE` reader - Output-disable Request Enable from GPTNote: Can be modified only once after a reset."]
...
#[doc = "Field `IOCE` writer - Output-disable Request Enable from GPTNote: Can be modified only once after a reset."]
...
impl R {
    ...
    #[doc = "Bit 5 - Output-disable Request Enable from GPTNote: Can be modified only once after a reset."]
    #[inline(always)]
