...
#[doc = "Field `MOSTP` reader - Main Clock Oscillator StopNote: MOMCR register must be set before setting MOSTP to 0."]
...
#[doc = "Field `MOSTP` writer - Main Clock Oscillator StopNote: MOMCR register must be set before setting MOSTP to 0."]
...
impl R {
    #[doc = "Bit 0 - Main Clock Oscillator StopNote: MOMCR register must be set before setting MOSTP to 0."]
    #[inline(always)]
