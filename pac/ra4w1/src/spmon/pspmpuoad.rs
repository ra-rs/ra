...
pub struct R(crate::R<PSPMPUOAD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSPMPUOAD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSPMPUOAD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSPMPUOAD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PSPMPUOAD` writer"]
pub struct W(crate::W<PSPMPUOAD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PSPMPUOAD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PSPMPUOAD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PSPMPUOAD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OAD_W<'a, const O: u8> = crate::BitWriter<'a, u16, PSPMPUOAD_SPEC, OAD_A, O>;
...
#[doc = "Field `KEY` writer - Key CodeThe data written to these bits are not stored."]
pub type KEY_W<'a, const O: u8> = crate::FieldWriter<'a, u16, PSPMPUOAD_SPEC, u8, KEY_AW, 8, O>;
...
impl W {
    ...
    #[doc = "Bits 8:15 - Key CodeThe data written to these bits are not stored."]
    #[inline(always)]
    #[must_use]
