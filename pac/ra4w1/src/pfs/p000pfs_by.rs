...
pub struct R(crate::R<P000PFS_BY_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P000PFS_BY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P000PFS_BY_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P000PFS_BY_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P000PFS_BY` writer"]
pub struct W(crate::W<P000PFS_BY_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P000PFS_BY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P000PFS_BY_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P000PFS_BY_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P000PFS_BY_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P000PFS_BY_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P000PFS_BY_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u8, P000PFS_BY_SPEC, NCODR_A, O>;
