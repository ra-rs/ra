...
pub type DSCR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P000PFS_HA_SPEC, DSCR_A, O>;
...
pub type EOR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P000PFS_HA_SPEC, EOR_A, O>;
...
pub type EOF_W<'a, const O: u8> = crate::BitWriter<'a, u16, P000PFS_HA_SPEC, EOF_A, O>;
