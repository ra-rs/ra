...
pub struct R(crate::R<P408PFS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P408PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P408PFS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P408PFS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P408PFS` writer"]
pub struct W(crate::W<P408PFS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P408PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P408PFS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P408PFS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, NCODR_A, O>;
...
pub type DSCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, DSCR_A, O>;
...
pub type DSCR1_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, DSCR1_A, O>;
...
pub type EOR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, EOR_A, O>;
...
pub type EOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, EOF_A, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, ASEL_A, O>;
...
pub type PMR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P408PFS_SPEC, PMR_A, O>;
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, P408PFS_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dscr1(&mut self) -> DSCR1_W<11> {
        DSCR1_W::new(self)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
