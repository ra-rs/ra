...
pub type RPCPU_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, RPCPU_A, O>;
...
pub type WPCPU_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, WPCPU_A, O>;
...
pub type RPGRPA_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, RPGRPA_A, O>;
...
pub type WPGRPA_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, WPGRPA_A, O>;
