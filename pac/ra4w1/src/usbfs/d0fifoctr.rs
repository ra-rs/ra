...
#[doc = "Field `BCLR` reader - CPU Buffer ClearNote: Only 0 can be read."]
...
#[doc = "Field `BCLR` writer - CPU Buffer ClearNote: Only 0 can be read."]
pub type BCLR_W<'a, const O: u8> = crate::BitWriter<'a, u16, D0FIFOCTR_SPEC, BCLR_A, O>;
...
impl R {
    ...
    #[doc = "Bit 14 - CPU Buffer ClearNote: Only 0 can be read."]
    #[inline(always)]
