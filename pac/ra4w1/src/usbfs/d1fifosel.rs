...
pub type MBW_W<'a, const O: u8> = crate::BitWriter<'a, u16, D1FIFOSEL_SPEC, MBW_A, O>;
...
#[doc = "Field `REW` reader - Buffer Pointer Rewind"]
...
pub type REW_W<'a, const O: u8> = crate::BitWriter<'a, u16, D1FIFOSEL_SPEC, REW_A, O>;
