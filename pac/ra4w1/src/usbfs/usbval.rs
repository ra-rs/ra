...
#[doc = "Field `WVALUE` reader - ValueThese bits store the USB request Value value."]
pub type WVALUE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WVALUE` writer - ValueThese bits store the USB request Value value."]
pub type WVALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, USBVAL_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - ValueThese bits store the USB request Value value."]
    #[inline(always)]
