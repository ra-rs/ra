...
#[doc = "Field `REW` reader - Buffer Pointer RewindNote: Only 0 can be read."]
...
#[doc = "Field `REW` writer - Buffer Pointer RewindNote: Only 0 can be read."]
pub type REW_W<'a, const O: u8> = crate::BitWriter<'a, u16, D0FIFOSEL_SPEC, REW_A, O>;
...
impl R {
    ...
    #[doc = "Bit 14 - Buffer Pointer RewindNote: Only 0 can be read."]
    #[inline(always)]
