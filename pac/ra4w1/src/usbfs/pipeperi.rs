...
#[doc = "Field `IITV` reader - Interval Error Detection IntervalSpecifies the interval error detection timing for the selected pipe in terms of frames, which is expressed as nth power of 2."]
pub type IITV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IITV` writer - Interval Error Detection IntervalSpecifies the interval error detection timing for the selected pipe in terms of frames, which is expressed as nth power of 2."]
...
impl R {
    #[doc = "Bits 0:2 - Interval Error Detection IntervalSpecifies the interval error detection timing for the selected pipe in terms of frames, which is expressed as nth power of 2."]
    #[inline(always)]
