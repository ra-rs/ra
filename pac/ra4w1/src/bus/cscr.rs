...
#[repr(u8)]
pub enum BSIZE_A {
    #[doc = "0: 16-bit bus space"]
    _00 = 0,
    #[doc = "1: Setting prohibited"]
    _01 = 1,
    #[doc = "2: 8-bit bus space"]
    _10 = 2,
...
pub type BSIZE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, CSCR_SPEC, u8, BSIZE_A, 2, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MPXEN_A {
    #[doc = "0: Separate bus interface is selected for area 0."]
    _0 = 0,
    #[doc = "1: Address/data multiplexed I/O interface is selected for area 0."]
    _1 = 1,
}
