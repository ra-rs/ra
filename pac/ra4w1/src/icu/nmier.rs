...
pub type VBATTEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, NMIER_SPEC, VBATTEN_A, O>;
impl<'a, const O: u8> VBATTEN_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vbatten(&mut self) -> VBATTEN_W<4> {
        VBATTEN_W::new(self)
    }
    #[doc = "Bit 6 - Oscillation Stop Detection Interrupt Enable"]
    #[inline(always)]
