...
impl From<DORCIR_AW> for bool {
    #[inline(always)]
    fn from(variant: DORCIR_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DORCIR` writer - CRCDOR Register Clear"]
pub type DORCIR_W<'a, const O: u8> = crate::BitWriter<'a, u8, CRCCR0_SPEC, DORCIR_AW, O>;
impl<'a, const O: u8> DORCIR_W<'a, O> {
    #[doc = "No effect."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DORCIR_AW::_0)
    }
    #[doc = "Clears the CRCDOR register."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(DORCIR_AW::_1)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dorcir(&mut self) -> DORCIR_W<7> {
        DORCIR_W::new(self)
    }
