...
#[doc = "Field `MPBT` reader - Multi-Processor Bit TransferThis bit should be 0 in smart card interface mode."]
pub type MPBT_R = crate::BitReader<bool>;
#[doc = "Field `MPBT` writer - Multi-Processor Bit TransferThis bit should be 0 in smart card interface mode."]
pub type MPBT_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SMCI_SPEC, bool, O>;
#[doc = "Field `MPB` reader - Multi-ProcessorThis bit should be 0 in smart card interface mode."]
...
pub type PER_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SSR_SMCI_SPEC, PER_A, O>;
...
pub type ERS_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SSR_SMCI_SPEC, ERS_A, O>;
...
pub type ORER_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SSR_SMCI_SPEC, ORER_A, O>;
...
pub type RDRF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SSR_SMCI_SPEC, RDRF_A, O>;
...
pub type TDRE_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SSR_SMCI_SPEC, TDRE_A, O>;
...
impl R {
    #[doc = "Bit 0 - Multi-Processor Bit TransferThis bit should be 0 in smart card interface mode."]
    #[inline(always)]
    pub fn mpbt(&self) -> MPBT_R {
        MPBT_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Multi-ProcessorThis bit should be 0 in smart card interface mode."]
    #[inline(always)]
