...
impl AMPTRM30_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> AMPTRM30_A {
        match self.bits {
            false => AMPTRM30_A::_0,
            true => AMPTRM30_A::_1,
        }
...
pub type AMPTRM30_W<'a, const O: u8> = crate::BitWriter<'a, u8, AMPTRM_SPEC, AMPTRM30_A, O>;
impl<'a, const O: u8> AMPTRM30_W<'a, O> {
...
impl AMPTRM31_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> AMPTRM31_A {
        match self.bits {
            false => AMPTRM31_A::_0,
            true => AMPTRM31_A::_1,
        }
...
pub type AMPTRM31_W<'a, const O: u8> = crate::BitWriter<'a, u8, AMPTRM_SPEC, AMPTRM31_A, O>;
impl<'a, const O: u8> AMPTRM31_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn amptrm30(&mut self) -> AMPTRM30_W<6> {
        AMPTRM30_W::new(self)
    }
    #[doc = "Bit 7 - Operational amplifier function activation/stop trigger control"]
    #[inline(always)]
    #[must_use]
    pub fn amptrm31(&mut self) -> AMPTRM31_W<7> {
        AMPTRM31_W::new(self)
    }
