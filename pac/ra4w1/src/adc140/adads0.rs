...
#[doc = "Field `ADS15` reader - A/D-Converted Value Addition/Average Channel AN015 Select"]
pub type ADS15_R = crate::BitReader<ADS15_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN015 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS15_A {
    #[doc = "0: AN015 is not selected."]
    _0 = 0,
    #[doc = "1: AN015 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS15` writer - A/D-Converted Value Addition/Average Channel AN015 Select"]
...
impl R {
    ...
    #[doc = "Bit 15 - A/D-Converted Value Addition/Average Channel AN015 Select"]
    #[inline(always)]
