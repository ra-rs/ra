...
pub type CMPSTCHA09_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA09_A, O>;
...
pub type CMPSTCHA10_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA10_A, O>;
...
pub type CMPSTCHA11_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA11_A, O>;
...
pub type CMPSTCHA12_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA12_A, O>;
...
pub type CMPSTCHA13_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA13_A, O>;
...
pub type CMPSTCHA14_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA14_A, O>;
...
#[doc = "Field `CMPSTCHA15` reader - Compare window A flag of AN015\n\nThe field is **modified** in some way after a read operation."]
...
#[doc = "Field `CMPSTCHA15` writer - Compare window A flag of AN015"]
pub type CMPSTCHA15_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR0_SPEC, CMPSTCHA15_A, O>;
...
impl R {
    ...
    #[doc = "Bit 15 - Compare window A flag of AN015"]
    #[inline(always)]
...
impl crate::Writable for ADCMPSR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0xffff;
