...
#[doc = "Field `ADS26` reader - A/D-Converted Value Addition/Average Channel AN026 Select"]
pub type ADS26_R = crate::BitReader<ADS26_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN026 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS26_A {
    #[doc = "0: AN026 is not selected."]
    _0 = 0,
    #[doc = "1: AN026 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS26` writer - A/D-Converted Value Addition/Average Channel AN026 Select"]
...
#[doc = "Field `ADS27` reader - A/D-Converted Value Addition/Average Channel AN027 Select"]
pub type ADS27_R = crate::BitReader<ADS27_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN027 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS27_A {
    #[doc = "0: AN027 is not selected."]
    _0 = 0,
    #[doc = "1: AN027 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS27` writer - A/D-Converted Value Addition/Average Channel AN027 Select"]
...
impl R {
    ...
    #[doc = "Bit 10 - A/D-Converted Value Addition/Average Channel AN026 Select"]
    #[inline(always)]
    pub fn ads26(&self) -> ADS26_R {
        ADS26_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - A/D-Converted Value Addition/Average Channel AN027 Select"]
    #[inline(always)]
