...
#[doc = "Field `ANSA26` reader - AN026 Select"]
pub type ANSA26_R = crate::BitReader<ANSA26_A>;
#[doc = "AN026 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ANSA26_A {
    #[doc = "0: AN026 is not subjected to conversion."]
    _0 = 0,
    #[doc = "1: AN026 is subjected to conversion."]
    _1 = 1,
}
...
#[doc = "Field `ANSA26` writer - AN026 Select"]
...
#[doc = "Field `ANSA27` reader - AN027 Select"]
pub type ANSA27_R = crate::BitReader<ANSA27_A>;
#[doc = "AN027 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ANSA27_A {
    #[doc = "0: AN027 is not subjected to conversion."]
    _0 = 0,
    #[doc = "1: AN027 is subjected to conversion."]
    _1 = 1,
}
...
#[doc = "Field `ANSA27` writer - AN027 Select"]
