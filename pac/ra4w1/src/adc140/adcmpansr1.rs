...
#[doc = "Field `CMPCHA26` reader - AN026 Select"]
pub type CMPCHA26_R = crate::BitReader<CMPCHA26_A>;
#[doc = "AN026 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA26_A {
    #[doc = "0: Excludes AN026 from the compare window A target range."]
    _0 = 0,
    #[doc = "1: Includes AN026 from the compare window A target range."]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA26` writer - AN026 Select"]
...
#[doc = "Field `CMPCHA27` reader - AN027 Select"]
pub type CMPCHA27_R = crate::BitReader<CMPCHA27_A>;
#[doc = "AN027 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA27_A {
    #[doc = "0: Excludes AN027 from the compare window A target range."]
    _0 = 0,
    #[doc = "1: Includes AN027 from the compare window A target range."]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA27` writer - AN027 Select"]
