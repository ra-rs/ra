...
#[doc = "Field `CMPSTCHA26` reader - Compare window A flag of AN026\n\nThe field is **modified** in some way after a read operation."]
...
#[doc = "Field `CMPSTCHA26` writer - Compare window A flag of AN026"]
pub type CMPSTCHA26_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR1_SPEC, CMPSTCHA26_A, O>;
...
#[doc = "Field `CMPSTCHA27` reader - Compare window A flag of AN027\n\nThe field is **modified** in some way after a read operation."]
...
#[doc = "Field `CMPSTCHA27` writer - Compare window A flag of AN027"]
pub type CMPSTCHA27_W<'a, const O: u8> =
    crate::BitWriter0C<'a, u16, ADCMPSR1_SPEC, CMPSTCHA27_A, O>;
...
impl R {
    ...
    #[doc = "Bit 10 - Compare window A flag of AN026"]
    #[inline(always)]
    pub fn cmpstcha26(&self) -> CMPSTCHA26_R {
        CMPSTCHA26_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Compare window A flag of AN027"]
    #[inline(always)]
...
impl crate::Writable for ADCMPSR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x0fff;
