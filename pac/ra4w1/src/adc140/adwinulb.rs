...
pub type ADWINULB_R = crate::FieldReader<u16, u16>;
...
pub type ADWINULB_W<'a, const O: u8> = crate::FieldWriter<'a, u16, ADWINULB_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adwinulb(&mut self) -> ADWINULB_W<0> {
        ADWINULB_W::new(self)
    }
