...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSLKP_A {
    #[doc = "0: Negates all SSL signals upon completion of transfer"]
    _0 = 0,
    #[doc = "1: Keeps the SSL signal level from the end of transfer until the beginning of the next access"]
    _1 = 1,
}
