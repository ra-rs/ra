...
pub enum USGTRGAR_A {
    #[doc = "0: Disable counter count up on the rising edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTETRGA input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGAF_A {
    #[doc = "0: Disable counter count up on the falling edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTETRGA input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGBR_A {
    #[doc = "0: Disable counter count up on the rising edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTETRGB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGBF_A {
    #[doc = "0: Disable counter count up on the falling edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTETRGB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGCR_A {
    #[doc = "0: Disable counter count up on the rising edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTETRGC input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGCF_A {
    #[doc = "0: Disable counter count up on the falling edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTETRGC input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGDR_A {
    #[doc = "0: Disable counter count up on the rising edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTETRGD input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGDF_A {
    #[doc = "0: Disable counter count up on the falling edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTETRGD input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCARBL_A {
    #[doc = "0: Disable counter count up on the rising edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTIOCA input when GTIOCB input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCARBH_A {
    #[doc = "0: Disable counter count up on the rising edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTIOCA input when GTIOCB input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCAFBL_A {
    #[doc = "0: Disable counter count up on the falling edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTIOCA input when GTIOCB input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCAFBH_A {
    #[doc = "0: Disable counter count up on the falling edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTIOCA input when GTIOCB input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBRAL_A {
    #[doc = "0: Disable counter count up on the rising edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTIOCB input when GTIOCA input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBRAH_A {
    #[doc = "0: Disable counter count up on the rising edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the rising edge of GTIOCB input when GTIOCA input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBFAL_A {
    #[doc = "0: Disable counter count up on the falling edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTIOCB input when GTIOCA input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBFAH_A {
    #[doc = "0: Disable counter count up on the falling edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count up on the falling edge of GTIOCB input when GTIOCA input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCA_A {
    #[doc = "0: Disable counter count up on ELC_GPTA input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTA input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCB_A {
    #[doc = "0: Disable counter count up on ELC_GPTB input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCC_A {
    #[doc = "0: Disable counter count up on ELC_GPTC input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTC input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCD_A {
    #[doc = "0: Disable counter count up on ELC_GPTD input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTD input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCE_A {
    #[doc = "0: Disable counter count up on ELC_GPTE input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTE input.put"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCF_A {
    #[doc = "0: Disable counter count up on ELC_GPTF input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTF input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCG_A {
    #[doc = "0: Disable counter count up on ELC_GPTG input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTG input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCH_A {
    #[doc = "0: Disable counter count up on ELC_GPTH input"]
    _0 = 0,
    #[doc = "1: Enable counter count up on ELC_GPTH input."]
    _1 = 1,
}
