...
#[doc = "Field `GTADTDBRB` reader - A/D Converter Start Request Timing Double-Buffer Register B"]
pub type GTADTDBRB_R = crate::FieldReader<u32, u32>;
#[doc = "Field `GTADTDBRB` writer - A/D Converter Start Request Timing Double-Buffer Register B"]
pub type GTADTDBRB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GTADTDBRB_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A/D Converter Start Request Timing Double-Buffer Register B"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gtadtdbrb(&mut self) -> GTADTDBRB_W<0> {
        GTADTDBRB_W::new(self)
    }
