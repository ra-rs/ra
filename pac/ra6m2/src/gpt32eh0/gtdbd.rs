...
#[doc = "Field `GTDBD` reader - Dead Time Buffer Register D"]
pub type GTDBD_R = crate::FieldReader<u32, u32>;
#[doc = "Field `GTDBD` writer - Dead Time Buffer Register D"]
pub type GTDBD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTDBD_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Dead Time Buffer Register D"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gtdbd(&mut self) -> GTDBD_W<0> {
        GTDBD_W::new(self)
    }
