...
#[doc = "Field `BD` reader - BD\\[3\\]: GTDV Buffer Operation DisableBD\\[2\\]: GTADTR Buffer Operation DisableBD\\[1\\]: GTPR Buffer Operation DisableBD\\[0\\]: GTCCR Buffer Operation Disable"]
...
#[doc = "Field `BD` writer - BD\\[3\\]: GTDV Buffer Operation DisableBD\\[2\\]: GTADTR Buffer Operation DisableBD\\[1\\]: GTPR Buffer Operation DisableBD\\[0\\]: GTCCR Buffer Operation Disable"]
pub type BD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTBER_SPEC, u8, BD_A, 4, O>;
...
pub enum PR_A {
    ...
    _01 = 1,
    #[doc = "2: Double buffer operation (GTPDBR --> GTPBR --> GTPR)"]
    _10 = 2,
    #[doc = "3: Double buffer operation (GTPDBR --> GTPBR --> GTPR)"]
    _11 = 3,
}
...
pub type PR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, GTBER_SPEC, u8, PR_A, 2, O>;
...
#[doc = "Field `ADTTA` reader - GTADTRA Buffer Transfer Timing Select in the Triangle wavesNOTE: In the Saw waves, values other than 0 0: Transfer at an underflow (in down-counting) or overflow (in up-counting) is performed."]
...
pub enum ADTTA_A {
    #[doc = "0: No transfer"]
    _00 = 0,
    #[doc = "1: Transfer at crest"]
    _01 = 1,
    #[doc = "2: Transfer at trough"]
    _10 = 2,
    #[doc = "3: Transfer at both crest and trough"]
    _11 = 3,
}
...
#[doc = "Field `ADTTA` writer - GTADTRA Buffer Transfer Timing Select in the Triangle wavesNOTE: In the Saw waves, values other than 0 0: Transfer at an underflow (in down-counting) or overflow (in up-counting) is performed."]
...
#[doc = "Field `ADTDA` reader - GTADTRA Double Buffer Operation"]
...
pub enum ADTDA_A {
    ...
    _0 = 0,
    #[doc = "1: Double buffer operation (GTADTDBRA --> GTADTBRA --> GTADTDRA)"]
    _1 = 1,
}
...
#[doc = "Field `ADTDA` writer - GTADTRA Double Buffer Operation"]
...
#[doc = "Field `ADTTB` reader - GTADTRB Buffer Transfer Timing Select in the Triangle wavesNOTE: In the Saw waves, values other than 0 0: Transfer at an underflow (in down-counting) or overflow (in up-counting) is performed."]
...
#[doc = "Field `ADTTB` writer - GTADTRB Buffer Transfer Timing Select in the Triangle wavesNOTE: In the Saw waves, values other than 0 0: Transfer at an underflow (in down-counting) or overflow (in up-counting) is performed."]
...
#[doc = "Field `ADTDB` reader - GTADTRB Double Buffer Operation"]
...
pub enum ADTDB_A {
    ...
    _0 = 0,
    #[doc = "1: Double buffer operation (GTADTDBRB --> GTADTBRB --> GTADTDRB)"]
    _1 = 1,
}
...
#[doc = "Field `ADTDB` writer - GTADTRB Double Buffer Operation"]
...
impl R {
    #[doc = "Bits 0:3 - BD\\[3\\]: GTDV Buffer Operation DisableBD\\[2\\]: GTADTR Buffer Operation DisableBD\\[1\\]: GTPR Buffer Operation DisableBD\\[0\\]: GTCCR Buffer Operation Disable"]
    #[inline(always)]
    pub fn bd(&self) -> BD_R {
    ...
    #[doc = "Bits 24:25 - GTADTRA Buffer Transfer Timing Select in the Triangle wavesNOTE: In the Saw waves, values other than 0 0: Transfer at an underflow (in down-counting) or overflow (in up-counting) is performed."]
    #[inline(always)]
    pub fn adtta(&self) -> ADTTA_R {
        ADTTA_R::new(((self.bits >> 24) & 3) as u8)
    }
    #[doc = "Bit 26 - GTADTRA Double Buffer Operation"]
    #[inline(always)]
    pub fn adtda(&self) -> ADTDA_R {
        ADTDA_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bits 28:29 - GTADTRB Buffer Transfer Timing Select in the Triangle wavesNOTE: In the Saw waves, values other than 0 0: Transfer at an underflow (in down-counting) or overflow (in up-counting) is performed."]
    #[inline(always)]
    pub fn adttb(&self) -> ADTTB_R {
        ADTTB_R::new(((self.bits >> 28) & 3) as u8)
    }
    #[doc = "Bit 30 - GTADTRB Double Buffer Operation"]
    #[inline(always)]
