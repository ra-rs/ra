...
#[doc = "Field `CMPSTB` reader - Compare window B flag.It is a status flag that shows the comparative result of CH (AN000-AN007,AN016-AN020, temperature sensor, and internal reference voltage) made the object of window B relation condition.\n\nThe field is **modified** in some way after a read operation."]
...
#[doc = "Field `CMPSTB` writer - Compare window B flag.It is a status flag that shows the comparative result of CH (AN000-AN007,AN016-AN020, temperature sensor, and internal reference voltage) made the object of window B relation condition."]
...
impl R {
    #[doc = "Bit 0 - Compare window B flag.It is a status flag that shows the comparative result of CH (AN000-AN007,AN016-AN020, temperature sensor, and internal reference voltage) made the object of window B relation condition."]
    #[inline(always)]
