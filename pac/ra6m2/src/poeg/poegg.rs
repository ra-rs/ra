...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IOCF_A {
    #[doc = "0: A output-disable request from GPT disable request or comparator interrupt has not been generated."]
    _0 = 0,
    #[doc = "1: A output-disable request from GPT disable request or comparator interrupt has been generated."]
    _1 = 1,
}
...
#[doc = "Field `IOCE` reader - Enable for GPT Output-Disable RequestNote: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IOCE_A {
    #[doc = "0: Disable output-disable requests from GPT disable request"]
    _0 = 0,
    #[doc = "1: Enable output-disable requests from GPT disable request"]
    _1 = 1,
}
...
#[doc = "Field `IOCE` writer - Enable for GPT Output-Disable RequestNote: Can be modified only once after a reset."]
...
#[doc = "Field `CDRE0` reader - Comparator Disable Request Enable 0Note: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDRE0_A {
    #[doc = "0: A disable request of comparator 0 disabled."]
    _0 = 0,
    #[doc = "1: A disable request of comparator 0 enabled."]
    _1 = 1,
}
...
#[doc = "Field `CDRE0` writer - Comparator Disable Request Enable 0Note: Can be modified only once after a reset."]
...
#[doc = "Field `CDRE1` reader - Comparator Disable Request Enable 1Note: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDRE1_A {
    #[doc = "0: A disable request of comparator 1 disabled."]
    _0 = 0,
    #[doc = "1: A disable request of comparator 1 enabled."]
    _1 = 1,
}
...
#[doc = "Field `CDRE1` writer - Comparator Disable Request Enable 1Note: Can be modified only once after a reset."]
pub type CDRE1_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGG_SPEC, CDRE1_A, O>;
...
#[doc = "Field `CDRE2` reader - Comparator Disable Request Enable 2Note: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDRE2_A {
    #[doc = "0: A disable request of comparator 2 disabled."]
    _0 = 0,
    #[doc = "1: A disable request of comparator 2 enabled."]
    _1 = 1,
}
...
#[doc = "Field `CDRE2` writer - Comparator Disable Request Enable 2Note: Can be modified only once after a reset."]
pub type CDRE2_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGG_SPEC, CDRE2_A, O>;
...
#[doc = "Field `CDRE3` reader - Comparator Disable Request Enable 3Note: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDRE3_A {
    #[doc = "0: A disable request of comparator 3 disabled."]
    _0 = 0,
    #[doc = "1: A disable request of comparator 3 enabled."]
    _1 = 1,
}
...
#[doc = "Field `CDRE3` writer - Comparator Disable Request Enable 3Note: Can be modified only once after a reset."]
pub type CDRE3_W<'a, const O: u8> = crate::BitWriter<'a, u32, POEGG_SPEC, CDRE3_A, O>;
...
#[doc = "Field `CDRE4` reader - Comparator Disable Request Enable 4Note: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDRE4_A {
    #[doc = "0: A disable request of comparator 4 disabled."]
    _0 = 0,
    #[doc = "1: A disable request of comparator 4 enabled."]
    _1 = 1,
}
...
#[doc = "Field `CDRE4` writer - Comparator Disable Request Enable 4Note: Can be modified only once after a reset."]
...
#[doc = "Field `CDRE5` reader - Comparator Disable Request Enable 5Note: Can be modified only once after a reset."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDRE5_A {
    #[doc = "0: A disable request of comparator 5 disabled."]
    _0 = 0,
    #[doc = "1: A disable request of comparator 5 enabled."]
    _1 = 1,
}
...
#[doc = "Field `CDRE5` writer - Comparator Disable Request Enable 5Note: Can be modified only once after a reset."]
...
impl R {
    ...
    #[doc = "Bit 5 - Enable for GPT Output-Disable RequestNote: Can be modified only once after a reset."]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Comparator Disable Request Enable 0Note: Can be modified only once after a reset."]
    #[inline(always)]
    pub fn cdre0(&self) -> CDRE0_R {
        CDRE0_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Comparator Disable Request Enable 1Note: Can be modified only once after a reset."]
    #[inline(always)]
    pub fn cdre1(&self) -> CDRE1_R {
        CDRE1_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Comparator Disable Request Enable 2Note: Can be modified only once after a reset."]
    #[inline(always)]
    pub fn cdre2(&self) -> CDRE2_R {
        CDRE2_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Comparator Disable Request Enable 3Note: Can be modified only once after a reset."]
    #[inline(always)]
    pub fn cdre3(&self) -> CDRE3_R {
        CDRE3_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Comparator Disable Request Enable 4Note: Can be modified only once after a reset."]
    #[inline(always)]
    pub fn cdre4(&self) -> CDRE4_R {
        CDRE4_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Comparator Disable Request Enable 5Note: Can be modified only once after a reset."]
    #[inline(always)]
