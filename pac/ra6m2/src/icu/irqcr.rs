...
#[doc = "Field `FCLKSEL` reader - IRQ Digital Filter Sampling Clock"]
...
#[doc = "Field `FCLKSEL` writer - IRQ Digital Filter Sampling Clock"]
...
impl R {
    ...
    #[doc = "Bits 4:5 - IRQ Digital Filter Sampling Clock"]
    #[inline(always)]
