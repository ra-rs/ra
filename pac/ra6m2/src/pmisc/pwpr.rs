...
#[doc = "Field `BOWI` reader - PFSWE Bit Write Disable"]
...
#[doc = "Field `BOWI` writer - PFSWE Bit Write Disable"]
pub type BOWI_W<'a, const O: u8> = crate::BitWriter<'a, u8, PWPR_SPEC, BOWI_A, O>;
impl<'a, const O: u8> BOWI_W<'a, O> {
