...
#[doc = "Field `TIS` reader - Transmit Interrupt EnableSet the EESR.TWB flag to 1 in the mode selected by the TIM bit to notify an interrupt."]
...
pub enum TIS_A {
    #[doc = "0: Transmit Interrupt is disabled."]
    _0 = 0,
    #[doc = "1: Transmit Interrupt is enabled."]
    _1 = 1,
}
...
#[doc = "Field `TIS` writer - Transmit Interrupt EnableSet the EESR.TWB flag to 1 in the mode selected by the TIM bit to notify an interrupt."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIM_A {
    #[doc = "0: Transmission complete interrupt mode: An interrupt occurs when a frame has been transmitted."]
    _0 = 0,
    #[doc = "1: Write-back complete interrupt mode: An interrupt occurs when write-back to the transmit descriptor has been completed."]
    _1 = 1,
}
...
impl R {
    #[doc = "Bit 0 - Transmit Interrupt EnableSet the EESR.TWB flag to 1 in the mode selected by the TIM bit to notify an interrupt."]
    #[inline(always)]
