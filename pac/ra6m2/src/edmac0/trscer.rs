...
pub enum RRFCE_A {
    #[doc = "0: The EDMACn.EESR.RRF flag status is reflected in the RDn.RFE bit of the receive descriptor."]
    _0 = 0,
    #[doc = "1: The EDMACn.EESR.RRF flag status is not reflected in the RDn.RFE bit of the receive descriptor."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RMAFCE_A {
    #[doc = "0: The EDMACn.EESR.RMAF flag status is reflected in the RDn.RFE bit of the receive descriptor."]
    _0 = 0,
    #[doc = "1: The EDMACn.EESR.RMAF flag status is not reflected in the RDn.RFE bit of the receive descriptor."]
    _1 = 1,
}
