...
pub enum RNR_A {
    #[doc = "0: EDRRR.RR bit (receive request bit) is set to 0 when one frame has been received."]
    _0 = 0,
    #[doc = "1: EDRRR.RR bit (receive request bit) is not set to 0 when one frame has been received."]
    _1 = 1,
}
