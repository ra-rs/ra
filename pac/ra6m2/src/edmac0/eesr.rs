...
pub enum CERF_A {
    #[doc = "0: CRC error has not been detected."]
    _0 = 0,
    #[doc = "1: CRC error has been detected."]
    _1 = 1,
}
...
pub type CERF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, CERF_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PRE_A {
    #[doc = "0: PHY-LSI receive error has not been detected."]
    _0 = 0,
    #[doc = "1: PHY-LSI receive error has been detected."]
    _1 = 1,
}
...
pub type PRE_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, PRE_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RTSF_A {
    #[doc = "0: Frame-too-short error has not been detected."]
    _0 = 0,
    #[doc = "1: Frame-too-short error has been detected."]
    _1 = 1,
}
...
pub type RTSF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, RTSF_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RTLF_A {
    #[doc = "0: Frame-too-long error has not been detected."]
    _0 = 0,
    #[doc = "1: Frame-too-long error has been detected."]
    _1 = 1,
}
...
pub type RTLF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, RTLF_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RRF_A {
    #[doc = "0: Alignment error has not been detected."]
    _0 = 0,
    #[doc = "1: Alignment error has been detected."]
    _1 = 1,
}
...
pub type RRF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, RRF_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RMAF_A {
    #[doc = "0: Multicast address frame has not been received."]
    _0 = 0,
    #[doc = "1: Multicast address frame has been received."]
    _1 = 1,
}
...
pub type RMAF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, RMAF_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TRO_A {
    #[doc = "0: Transmit retry-over condition has not been detected."]
    _0 = 0,
    #[doc = "1: Transmit retry-over condition has been detected."]
    _1 = 1,
}
...
pub type TRO_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, TRO_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CD_A {
    #[doc = "0: Late collision has not been detected."]
    _0 = 0,
    #[doc = "1: Late collision has been detected during frame transmission."]
    _1 = 1,
}
...
pub type CD_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, CD_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DLC_A {
    #[doc = "0: Loss of carrier has not been detected."]
    _0 = 0,
    #[doc = "1: Loss of carrier has been detected during frame transmission."]
    _1 = 1,
}
...
pub type DLC_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, DLC_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CND_A {
    #[doc = "0: A carrier has been detected when transmission starts."]
    _0 = 0,
    #[doc = "1: A carrier has not been detected during preamble transmission."]
    _1 = 1,
}
...
pub type CND_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, CND_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RDE_A {
    #[doc = "0: The EDMAC detects that the receive descriptor valid bit (RDn.RACT) is 1."]
    _0 = 0,
    #[doc = "1: The EDMAC detects that the receive descriptor valid bit (RDn.RACT) is 0."]
    _1 = 1,
}
...
pub enum FR_A {
    ...
    _0 = 0,
    #[doc = "1: Frame has been received. Update of the receive descriptor is complete."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TDE_A {
    #[doc = "0: The EDMAC detects that the transmit descriptor valid bit (TDn.TACT) is 1."]
    _0 = 0,
    #[doc = "1: The EDMAC detects that the transmit descriptor valid bit (TDn.TACT) is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TC_A {
    #[doc = "0: Transfer have not been completed, or no transfer has been requested."]
    _0 = 0,
...
#[doc = "Field `ECI` reader - ETHERC Status Register Source FlagNOTE: When the source in the ETHERCn.ECSR register is cleared, the ECI flag is also cleared."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ECI_A {
    #[doc = "0: ETHERC status interrupt source has not been detected."]
    _0 = 0,
    #[doc = "1: ETHERC status interrupt source has been detected."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RABT_A {
    #[doc = "0: Frame reception has not been aborted or no reception has been requested."]
    _0 = 0,
    #[doc = "1: Frame reception has been aborted."]
    _1 = 1,
}
...
pub type RABT_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, EESR_SPEC, RABT_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TABT_A {
    #[doc = "0: Frame transmission has not been aborted or no transmission has been requested."]
    _0 = 0,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TWB_A {
    #[doc = "0: Write-back has not been completed, or no transmission has been requested."]
    _0 = 0,
...
impl R {
    ...
    #[doc = "Bit 22 - ETHERC Status Register Source FlagNOTE: When the source in the ETHERCn.ECSR register is cleared, the ECI flag is also cleared."]
    #[inline(always)]
...
impl crate::Writable for EESR_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x47bf_0f9f;
}
