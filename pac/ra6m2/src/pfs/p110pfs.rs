#[doc = "Register `P110PFS` reader"]
pub struct R(crate::R<P110PFS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P110PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P110PFS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P110PFS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P110PFS` writer"]
pub struct W(crate::W<P110PFS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P110PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P110PFS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P110PFS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, NCODR_A, O>;
...
#[repr(u8)]
pub enum DSCR_A {
    #[doc = "0: Normal drive output"]
    _00 = 0,
    #[doc = "1: Middle drive output"]
    _01 = 1,
    #[doc = "2: Setting prohibited"]
    _10 = 2,
    #[doc = "3: High-drive output"]
    _11 = 3,
}
...
pub type DSCR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, P110PFS_SPEC, u8, DSCR_A, 2, O>;
...
pub type EOR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, EOR_A, O>;
...
pub type EOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, EOF_A, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, ASEL_A, O>;
...
pub type PMR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P110PFS_SPEC, PMR_A, O>;
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, P110PFS_SPEC, u8, u8, 5, O>;
impl R {
...
#[doc = "P110 Pin Function Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p110pfs](index.html) module"]
pub struct P110PFS_SPEC;
impl crate::RegisterSpec for P110PFS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [p110pfs::R](R) reader structure"]
impl crate::Readable for P110PFS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p110pfs::W](W) writer structure"]
impl crate::Writable for P110PFS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P110PFS to value 0x0001_0010"]
impl crate::Resettable for P110PFS_SPEC {
