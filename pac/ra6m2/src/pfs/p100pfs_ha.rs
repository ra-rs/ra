...
pub struct R(crate::R<P100PFS_HA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P100PFS_HA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P100PFS_HA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P100PFS_HA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P100PFS_HA` writer"]
pub struct W(crate::W<P100PFS_HA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P100PFS_HA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P100PFS_HA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P100PFS_HA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, NCODR_A, O>;
...
pub type DSCR_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, P100PFS_HA_SPEC, u8, DSCR_A, 2, O>;
...
pub type EOR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, EOR_A, O>;
...
pub type EOF_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, EOF_A, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, P100PFS_HA_SPEC, ASEL_A, O>;
...
#[doc = "P100 Pin Function Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p100pfs_ha](index.html) module"]
pub struct P100PFS_HA_SPEC;
impl crate::RegisterSpec for P100PFS_HA_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [p100pfs_ha::R](R) reader structure"]
impl crate::Readable for P100PFS_HA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p100pfs_ha::W](W) writer structure"]
impl crate::Writable for P100PFS_HA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P100PFS_HA to value 0"]
impl crate::Resettable for P100PFS_HA_SPEC {
