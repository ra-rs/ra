...
#[doc = "Field `MSTPA1` reader - RAM1 Module Stop"]
...
#[doc = "Field `MSTPA1` writer - RAM1 Module Stop"]
pub type MSTPA1_W<'a, const O: u8> = crate::BitWriter<'a, u32, MSTPCRA_SPEC, MSTPA1_A, O>;
impl<'a, const O: u8> MSTPA1_W<'a, O> {
    #[doc = "Cancel the module-stop state"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[doc = "Field `MSTPA5` reader - High-Speed RAM Module Stop"]
...
#[doc = "Field `MSTPA5` writer - High-Speed RAM Module Stop"]
pub type MSTPA5_W<'a, const O: u8> = crate::BitWriter<'a, u32, MSTPCRA_SPEC, MSTPA5_A, O>;
impl<'a, const O: u8> MSTPA5_W<'a, O> {
    #[doc = "Cancel the module-stop state"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[doc = "Field `MSTPA7` reader - Standny RAM Module Stop"]
...
#[doc = "Field `MSTPA7` writer - Standny RAM Module Stop"]
pub type MSTPA7_W<'a, const O: u8> = crate::BitWriter<'a, u32, MSTPCRA_SPEC, MSTPA7_A, O>;
impl<'a, const O: u8> MSTPA7_W<'a, O> {
    #[doc = "Cancel the module-stop state"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 1 - RAM1 Module Stop"]
    #[inline(always)]
    pub fn mstpa1(&self) -> MSTPA1_R {
        MSTPA1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 5 - High-Speed RAM Module Stop"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Standny RAM Module Stop"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mstpa1(&mut self) -> MSTPA1_W<1> {
        MSTPA1_W::new(self)
    }
    #[doc = "Bit 5 - High-Speed RAM Module Stop"]
    #[inline(always)]
    #[must_use]
    pub fn mstpa5(&mut self) -> MSTPA5_W<5> {
        MSTPA5_W::new(self)
    }
    #[doc = "Bit 6 - ECCRAM Module Stop"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mstpa7(&mut self) -> MSTPA7_W<7> {
        MSTPA7_W::new(self)
    }
    #[doc = "Bit 22 - DMA Controller/Data Transfer Controller Module Stop"]
    #[inline(always)]
...
#[doc = "`reset()` method sets MSTPCRA to value 0xffbf_ff1c"]
impl crate::Resettable for MSTPCRA_SPEC {
    const RESET_VALUE: Self::Ux = 0xffbf_ff1c;
}
