...
#[doc = "Field `DUSBHSIF` reader - USBHS Suspend/Resume Deep Standby Cancel Flag\n\nThe field is **modified** in some way after a read operation."]
...
impl DUSBHSIF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DUSBHSIF_A {
        match self.bits {
            false => DUSBHSIF_A::_0,
            true => DUSBHSIF_A::_1,
        }
...
#[doc = "Field `DUSBHSIF` writer - USBHS Suspend/Resume Deep Standby Cancel Flag"]
pub type DUSBHSIF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, DPSIFR3_SPEC, DUSBHSIF_A, O>;
impl<'a, const O: u8> DUSBHSIF_W<'a, O> {
    #[doc = "The cancel request is not generated"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 1 - USBHS Suspend/Resume Deep Standby Cancel Flag"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dusbhsif(&mut self) -> DUSBHSIF_W<1> {
        DUSBHSIF_W::new(self)
    }
    #[doc = "Bit 2 - AGT1 Underflow Deep Standby Cancel Flag"]
    #[inline(always)]
