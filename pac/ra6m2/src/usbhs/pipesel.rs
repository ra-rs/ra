...
#[doc = "Field `PIPESEL` reader - Pipe Window SelectThese bits specify the pipe for registers at addresses 68H to 6EH."]
...
#[doc = "Field `PIPESEL` writer - Pipe Window SelectThese bits specify the pipe for registers at addresses 68H to 6EH."]
...
impl R {
    #[doc = "Bits 0:3 - Pipe Window SelectThese bits specify the pipe for registers at addresses 68H to 6EH."]
    #[inline(always)]
