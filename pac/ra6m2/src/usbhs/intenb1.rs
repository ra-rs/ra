...
#[doc = "Field `PDDETINTE` reader - PDDETINT Detection Interrupt Enable"]
...
impl PDDETINTE_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> PDDETINTE_A {
        match self.bits {
...
#[doc = "Field `PDDETINTE` writer - PDDETINT Detection Interrupt Enable"]
pub type PDDETINTE_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTENB1_SPEC, PDDETINTE_A, O>;
impl<'a, const O: u8> PDDETINTE_W<'a, O> {
...
#[doc = "Field `LPMENDE` reader - LPM Transaction End Interrupt Enable"]
...
#[doc = "Field `LPMENDE` writer - LPM Transaction End Interrupt Enable"]
pub type LPMENDE_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTENB1_SPEC, LPMENDE_A, O>;
impl<'a, const O: u8> LPMENDE_W<'a, O> {
    #[doc = "Interrupt output disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[doc = "Field `L1RSMENDE` reader - L1 Resume End Interrupt Enable"]
...
impl L1RSMENDE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> L1RSMENDE_A {
        match self.bits {
...
#[doc = "Field `L1RSMENDE` writer - L1 Resume End Interrupt Enable"]
pub type L1RSMENDE_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTENB1_SPEC, L1RSMENDE_A, O>;
impl<'a, const O: u8> L1RSMENDE_W<'a, O> {
    #[doc = "Interrupt output disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
#[doc = "Field `OVRCRE` reader - OVRCRE Interrupt Enable"]
...
#[doc = "Field `OVRCRE` writer - OVRCRE Interrupt Enable"]
...
impl R {
    #[doc = "Bit 0 - PDDETINT Detection Interrupt Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - LPM Transaction End Interrupt Enable"]
    #[inline(always)]
    pub fn lpmende(&self) -> LPMENDE_R {
        LPMENDE_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - L1 Resume End Interrupt Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - OVRCRE Interrupt Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pddetinte(&mut self) -> PDDETINTE_W<0> {
        PDDETINTE_W::new(self)
    }
    #[doc = "Bit 4 - Setup Transaction Normal Response Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpmende(&mut self) -> LPMENDE_W<8> {
        LPMENDE_W::new(self)
    }
    #[doc = "Bit 9 - L1 Resume End Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn l1rsmende(&mut self) -> L1RSMENDE_W<9> {
        L1RSMENDE_W::new(self)
    }
    #[doc = "Bit 11 - Connection Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
