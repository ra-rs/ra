...
pub type EPNUM_R = crate::FieldReader<u8, EPNUM_A>;
#[doc = "Endpoint Number\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum EPNUM_A {
    #[doc = "0: the selected pipe is not used"]
    _000 = 0,
}
...
impl EPNUM_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<EPNUM_A> {
        match self.bits {
            0 => Some(EPNUM_A::_000),
            _ => None,
        }
...
pub type EPNUM_W<'a, const O: u8> = crate::FieldWriter<'a, u16, PIPECFG_SPEC, u8, EPNUM_A, 4, O>;
impl<'a, const O: u8> EPNUM_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SHTNAK_A {
    #[doc = "0: The pipe is continued at the end of transfer."]
    _0 = 0,
    #[doc = "1: The pipe is disabled at the end of transfer."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CNTMD_A {
    #[doc = "0: Discontinuous transfer mode"]
    _0 = 0,
...
pub type CNTMD_W<'a, const O: u8> = crate::BitWriter<'a, u16, PIPECFG_SPEC, CNTMD_A, O>;
...
pub enum TYPE_A {
    ...
    #[doc = "1: Bulk transfer"]
    _01 = 1,
    #[doc = "2: Interrupt transfer"]
    _10 = 2,
    #[doc = "3: Isochronous transfer"]
    _11 = 3,
}
