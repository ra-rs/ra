...
pub struct R(crate::R<D1FIFOL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<D1FIFOL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<D1FIFOL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<D1FIFOL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `D1FIFOL` writer"]
pub struct W(crate::W<D1FIFOL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D1FIFOL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D1FIFOL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D1FIFOL_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
