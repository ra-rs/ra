...
pub type RP_GRPB_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, RP_GRPB_A, O>;
...
pub type WP_GRPB_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, WP_GRPB_A, O>;
...
pub type RP_GRPC_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, RP_GRPC_A, O>;
...
pub type WP_GRPC_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUEXBIU_SPEC, WP_GRPC_A, O>;
