...
pub type RP_CPU_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, RP_CPU_A, O>;
...
pub type WP_CPU_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, WP_CPU_A, O>;
...
pub type RP_GRPA_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, RP_GRPA_A, O>;
...
pub type WP_GRPA_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, WP_GRPA_A, O>;
...
pub type RP_GRPB_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, RP_GRPB_A, O>;
...
pub type WP_GRPB_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, WP_GRPB_A, O>;
...
pub type RP_GRPC_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, RP_GRPC_A, O>;
...
pub type WP_GRPC_W<'a, const O: u8> = crate::BitWriter<'a, u16, SMPUFBIU_SPEC, WP_GRPC_A, O>;
...
#[doc = "`reset()` method sets SMPUFBIU to value 0xc0"]
