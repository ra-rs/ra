...
pub enum DSGTRGAR_A {
    #[doc = "0: Disable counter count down on the rising edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTETRGA input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGAF_A {
    #[doc = "0: Disable counter count down on the falling edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTETRGA input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGBR_A {
    #[doc = "0: Disable counter count down on the rising edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTETRGB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGBF_A {
    #[doc = "0: Disable counter count down on the falling edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTETRGB input."]
    _1 = 1,
}
...
#[doc = "Field `DSGTRGCR` reader - GTETRGC Pin Rising Input Source Counter Count Down Enable"]
pub type DSGTRGCR_R = crate::BitReader<DSGTRGCR_A>;
#[doc = "GTETRGC Pin Rising Input Source Counter Count Down Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGCR_A {
    #[doc = "0: Disable counter count down on the rising edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTETRGC input"]
    _1 = 1,
}
...
impl DSGTRGCR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DSGTRGCR_A {
        match self.bits {
            false => DSGTRGCR_A::_0,
            true => DSGTRGCR_A::_1,
        }
...
#[doc = "Field `DSGTRGCR` writer - GTETRGC Pin Rising Input Source Counter Count Down Enable"]
pub type DSGTRGCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSGTRGCR_A, O>;
impl<'a, const O: u8> DSGTRGCR_W<'a, O> {
...
#[doc = "Field `DSGTRGCF` reader - GTETRGC Pin Falling Input Source Counter Count Down Enable"]
pub type DSGTRGCF_R = crate::BitReader<DSGTRGCF_A>;
#[doc = "GTETRGC Pin Falling Input Source Counter Count Down Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGCF_A {
    #[doc = "0: Disable counter count down on the falling edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTETRGC input."]
    _1 = 1,
}
...
impl DSGTRGCF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DSGTRGCF_A {
        match self.bits {
            false => DSGTRGCF_A::_0,
            true => DSGTRGCF_A::_1,
        }
...
#[doc = "Field `DSGTRGCF` writer - GTETRGC Pin Falling Input Source Counter Count Down Enable"]
pub type DSGTRGCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSGTRGCF_A, O>;
impl<'a, const O: u8> DSGTRGCF_W<'a, O> {
...
#[doc = "Field `DSGTRGDR` reader - GTETRGD Pin Rising Input Source Counter Count Down Enable"]
pub type DSGTRGDR_R = crate::BitReader<DSGTRGDR_A>;
#[doc = "GTETRGD Pin Rising Input Source Counter Count Down Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGDR_A {
    #[doc = "0: Disable counter count down on the rising edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTETRGD input."]
    _1 = 1,
}
...
impl DSGTRGDR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DSGTRGDR_A {
        match self.bits {
            false => DSGTRGDR_A::_0,
            true => DSGTRGDR_A::_1,
        }
...
#[doc = "Field `DSGTRGDR` writer - GTETRGD Pin Rising Input Source Counter Count Down Enable"]
pub type DSGTRGDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSGTRGDR_A, O>;
impl<'a, const O: u8> DSGTRGDR_W<'a, O> {
...
#[doc = "Field `DSGTRGDF` reader - GTETRGD Pin Falling Input Source Counter Count Down Enable"]
pub type DSGTRGDF_R = crate::BitReader<DSGTRGDF_A>;
#[doc = "GTETRGD Pin Falling Input Source Counter Count Down Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGDF_A {
    #[doc = "0: Disable counter count down on the falling edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTETRGD input."]
    _1 = 1,
}
...
impl DSGTRGDF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DSGTRGDF_A {
        match self.bits {
            false => DSGTRGDF_A::_0,
            true => DSGTRGDF_A::_1,
        }
...
#[doc = "Field `DSGTRGDF` writer - GTETRGD Pin Falling Input Source Counter Count Down Enable"]
pub type DSGTRGDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSGTRGDF_A, O>;
impl<'a, const O: u8> DSGTRGDF_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCARBL_A {
    #[doc = "0: Disable counter count down on the rising edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTIOCA input when GTIOCB input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCARBH_A {
    #[doc = "0: Disable counter count down on the rising edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTIOCA input when GTIOCB input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCAFBL_A {
    #[doc = "0: Disable counter count down on the falling edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTIOCA input when GTIOCB input is 0"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCAFBH_A {
    #[doc = "0: Disable counter count down on the falling edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTIOCA input when GTIOCB input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBRAL_A {
    #[doc = "0: Disable counter count down on the rising edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTIOCB input when GTIOCA input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBRAH_A {
    #[doc = "0: Disable counter count down on the rising edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the rising edge of GTIOCB input when GTIOCA input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBFAL_A {
    #[doc = "0: Disable counter count down on the falling edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTIOCB input when GTIOCA input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBFAH_A {
    #[doc = "0: Disable counter count down on the falling edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter count down on the falling edge of GTIOCB input when GTIOCA input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCA_A {
    #[doc = "0: Disable counter count down on ELC_GPTA input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTA input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCB_A {
    #[doc = "0: Disable counter count down on ELC_GPTB input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCC_A {
    #[doc = "0: Disable counter count down on ELC_GPTC input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTC input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCD_A {
    #[doc = "0: Disable counter count down on ELC_GPTD input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTD input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCE_A {
    #[doc = "0: Disable counter count down on ELC_GPTE input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTE input."]
    _1 = 1,
}
...
pub type DSELCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSELCE_A, O>;
impl<'a, const O: u8> DSELCE_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCF_A {
    #[doc = "0: Disable counter count down on ELC_GPTF input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTF input."]
    _1 = 1,
}
...
pub type DSELCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSELCF_A, O>;
impl<'a, const O: u8> DSELCF_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCG_A {
    #[doc = "0: Disable counter count down on ELC_GPTG input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTG input."]
    _1 = 1,
}
...
pub type DSELCG_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSELCG_A, O>;
impl<'a, const O: u8> DSELCG_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCH_A {
    #[doc = "0: Disable counter count down on ELC_GPTH input"]
    _0 = 0,
    #[doc = "1: Enable counter count down on ELC_GPTH input."]
    _1 = 1,
}
...
pub type DSELCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTDNSR_SPEC, DSELCH_A, O>;
impl<'a, const O: u8> DSELCH_W<'a, O> {
...
impl R {
    ...
    #[doc = "Bit 4 - GTETRGC Pin Rising Input Source Counter Count Down Enable"]
    #[inline(always)]
    pub fn dsgtrgcr(&self) -> DSGTRGCR_R {
        DSGTRGCR_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - GTETRGC Pin Falling Input Source Counter Count Down Enable"]
    #[inline(always)]
    pub fn dsgtrgcf(&self) -> DSGTRGCF_R {
        DSGTRGCF_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - GTETRGD Pin Rising Input Source Counter Count Down Enable"]
    #[inline(always)]
    pub fn dsgtrgdr(&self) -> DSGTRGDR_R {
        DSGTRGDR_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - GTETRGD Pin Falling Input Source Counter Count Down Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsgtrgcr(&mut self) -> DSGTRGCR_W<4> {
        DSGTRGCR_W::new(self)
    }
    #[doc = "Bit 5 - GTETRGC Pin Falling Input Source Counter Count Down Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsgtrgcf(&mut self) -> DSGTRGCF_W<5> {
        DSGTRGCF_W::new(self)
    }
    #[doc = "Bit 6 - GTETRGD Pin Rising Input Source Counter Count Down Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsgtrgdr(&mut self) -> DSGTRGDR_W<6> {
        DSGTRGDR_W::new(self)
    }
    #[doc = "Bit 7 - GTETRGD Pin Falling Input Source Counter Count Down Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsgtrgdf(&mut self) -> DSGTRGDF_W<7> {
        DSGTRGDF_W::new(self)
    }
    #[doc = "Bit 8 - GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Count Down Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dselce(&mut self) -> DSELCE_W<20> {
        DSELCE_W::new(self)
    }
    #[doc = "Bit 21 - ELC_GPTF Event Source Counter Count Down Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dselcf(&mut self) -> DSELCF_W<21> {
        DSELCF_W::new(self)
    }
    #[doc = "Bit 22 - ELC_GPTG Event Source Counter Count Down Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dselcg(&mut self) -> DSELCG_W<22> {
        DSELCG_W::new(self)
    }
    #[doc = "Bit 23 - ELC_GPTH Event Source Counter Count Down Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dselch(&mut self) -> DSELCH_W<23> {
        DSELCH_W::new(self)
    }
