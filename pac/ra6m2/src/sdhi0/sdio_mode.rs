...
#[doc = "Field `IOABT` reader - SDIO AbortNOTE: See manual"]
pub type IOABT_R = crate::BitReader<bool>;
#[doc = "Field `IOABT` writer - SDIO AbortNOTE: See manual"]
pub type IOABT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDIO_MODE_SPEC, bool, O>;
#[doc = "Field `C52PUB` reader - SDIO None AbortNOTE: See manual"]
pub type C52PUB_R = crate::BitReader<bool>;
#[doc = "Field `C52PUB` writer - SDIO None AbortNOTE: See manual"]
...
impl R {
    ...
    #[doc = "Bit 8 - SDIO AbortNOTE: See manual"]
    #[inline(always)]
    pub fn ioabt(&self) -> IOABT_R {
        IOABT_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - SDIO None AbortNOTE: See manual"]
    #[inline(always)]
