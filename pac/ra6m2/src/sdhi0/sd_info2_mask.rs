...
pub enum CMDEM_A {
    #[doc = "0: Command error interrupt request not masked"]
    _0 = 0,
    #[doc = "1: Command error interrupt request masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CRCEM_A {
    #[doc = "0: CRC error interrupt request not masked"]
    _0 = 0,
    #[doc = "1: CRC error interrupt request masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ENDEM_A {
    #[doc = "0: End bit detection error interrupt request not masked"]
    _0 = 0,
    #[doc = "1: End bit detection error interrupt request masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DTOM_A {
    #[doc = "0: Data timeout interrupt request not masked"]
    _0 = 0,
    #[doc = "1: Data timeout interrupt request masked"]
    _1 = 1,
}
...
#[doc = "Field `ILWM` reader - SD_BUF Register Illegal Write Interrupt Request Mask"]
pub type ILWM_R = crate::BitReader<ILWM_A>;
#[doc = "SD_BUF Register Illegal Write Interrupt Request Mask\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ILWM_A {
    #[doc = "0: Illegal write detection interrupt request for the SD_BUF register not masked"]
    _0 = 0,
    #[doc = "1: Illegal write detection interrupt request for the SD_BUF register masked"]
    _1 = 1,
}
...
#[doc = "Field `ILWM` writer - SD_BUF Register Illegal Write Interrupt Request Mask"]
...
#[doc = "Field `ILRM` reader - SD_BUF Register Illegal Read Interrupt Request Mask"]
pub type ILRM_R = crate::BitReader<ILRM_A>;
#[doc = "SD_BUF Register Illegal Read Interrupt Request Mask\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ILRM_A {
    #[doc = "0: Illegal read detection interrupt request for the SD_BUF register not masked"]
    _0 = 0,
    #[doc = "1: Illegal read detection interrupt request for the SD_BUF register masked"]
    _1 = 1,
}
...
#[doc = "Field `ILRM` writer - SD_BUF Register Illegal Read Interrupt Request Mask"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RSPTOM_A {
    #[doc = "0: Response timeout interrupt request not masked"]
    _0 = 0,
    #[doc = "1: Response timeout interrupt request masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BREM_A {
    #[doc = "0: Read enable interrupt request for the SD buffer not masked"]
    _0 = 0,
    #[doc = "1: Read enable interrupt request for the SD buffer masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BWEM_A {
    #[doc = "0: Write enable interrupt request for the SD_BUF register not masked"]
    _0 = 0,
    #[doc = "1: Write enable interrupt request for the SD_BUF register masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ILAM_A {
    #[doc = "0: Illegal access error interrupt request not masked"]
    _0 = 0,
    #[doc = "1: Illegal access error interrupt request masked"]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 4 - SD_BUF Register Illegal Write Interrupt Request Mask"]
    #[inline(always)]
    pub fn ilwm(&self) -> ILWM_R {
        ILWM_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - SD_BUF Register Illegal Read Interrupt Request Mask"]
    #[inline(always)]
