...
pub enum BWSWP_A {
    #[doc = "0: The current data are written without swapping."]
    _0 = 0,
    #[doc = "1: Swapping of the positions of the higher- and lower-order bytes of data for writing proceeds."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BRSWP_A {
    #[doc = "0: The current data are read without swapping."]
    _0 = 0,
    #[doc = "1: Swapping of the positions of the higher- and lower-order bytes of data for reading proceeds."]
    _1 = 1,
}
