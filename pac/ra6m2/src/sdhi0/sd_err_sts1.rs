...
#[doc = "Field `CMDE0` reader - Command Error 0NOTE: other than a response to a command issued within a command sequence"]
...
#[doc = "Field `CMDE1` reader - Command Error 1NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is Indicated in CMDE0."]
...
#[doc = "Field `RSPLENE0` reader - Response Length Error 0NOTE: other than a response to a command issued within a command sequence"]
...
#[doc = "Field `RSPLENE1` reader - Response Length Error 1NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is indicated in RSPLENE0."]
...
#[doc = "Field `RSPCRCE0` reader - Response CRC Error 0NOTE: other than a response to a command issued within a command sequence"]
...
#[doc = "Field `RSPCRCE1` reader - Response CRC Error 1NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is indicated in RSPCRCE0."]
...
#[doc = "Field `CRCTK` reader - CRC Status TokenStore the CRC status token value (normal value is 010b)"]
pub type CRCTK_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bit 0 - Command Error 0NOTE: other than a response to a command issued within a command sequence"]
    #[inline(always)]
    pub fn cmde0(&self) -> CMDE0_R {
        CMDE0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Command Error 1NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is Indicated in CMDE0."]
    #[inline(always)]
    pub fn cmde1(&self) -> CMDE1_R {
        CMDE1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Response Length Error 0NOTE: other than a response to a command issued within a command sequence"]
    #[inline(always)]
    pub fn rsplene0(&self) -> RSPLENE0_R {
        RSPLENE0_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Response Length Error 1NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is indicated in RSPLENE0."]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Response CRC Error 0NOTE: other than a response to a command issued within a command sequence"]
    #[inline(always)]
    pub fn rspcrce0(&self) -> RSPCRCE0_R {
        RSPCRCE0_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Response CRC Error 1NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is indicated in RSPCRCE0."]
    #[inline(always)]
    ...
    #[doc = "Bits 12:14 - CRC Status TokenStore the CRC status token value (normal value is 010b)"]
    #[inline(always)]
