...
#[doc = "Field `SFMAS` reader - Selection the number of address bits of the serial interface"]
...
#[doc = "Field `SFMAS` writer - Selection the number of address bits of the serial interface"]
...
#[doc = "Field `SFM4BC` reader - Selection of a default instruction code, when Serial Interface address width is selected 4 bytes."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SFM4BC_A {
    #[doc = "0: Does not use 4 Byte address read Instruction code"]
    _0 = 0,
...
#[doc = "Field `SFM4BC` writer - Selection of a default instruction code, when Serial Interface address width is selected 4 bytes."]
...
impl R {
    #[doc = "Bits 0:1 - Selection the number of address bits of the serial interface"]
    #[inline(always)]
    pub fn sfmas(&self) -> SFMAS_R {
        SFMAS_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 4 - Selection of a default instruction code, when Serial Interface address width is selected 4 bytes."]
    #[inline(always)]
