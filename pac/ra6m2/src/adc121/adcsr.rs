...
pub enum GBADIE_A {
    #[doc = "0: Disables S12GBADI1 interrupt generation upon group B scan completion."]
    _0 = 0,
    #[doc = "1: Enables S12GBADI1 interrupt generation upon group B scan completion."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum EXTRG_A {
    #[doc = "0: A/D conversion is started by the synchronous trigger (ELCTRG1)."]
    _0 = 0,
    #[doc = "1: A/D conversion is started by the asynchronous trigger (ADTRG1#)."]
    _1 = 1,
}
