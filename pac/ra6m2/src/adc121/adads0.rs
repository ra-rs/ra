...
#[doc = "Field `ADS03` reader - A/D-Converted Value Addition/Average Channel AN103 Select"]
pub type ADS03_R = crate::BitReader<ADS03_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN103 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS03_A {
    #[doc = "0: AN103 is not selected."]
    _0 = 0,
    #[doc = "1: AN103 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS03` writer - A/D-Converted Value Addition/Average Channel AN103 Select"]
...
impl R {
    ...
    #[doc = "Bit 3 - A/D-Converted Value Addition/Average Channel AN103 Select"]
    #[inline(always)]
