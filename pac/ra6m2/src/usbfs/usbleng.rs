...
#[doc = "Field `WLENGTH` reader - LengthThese bits store the USB request wLength value."]
pub type WLENGTH_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WLENGTH` writer - LengthThese bits store the USB request wLength value."]
