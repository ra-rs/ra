...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HTACT_A {
    #[doc = "0: Host sequencer of the USB is completely stopped."]
    _0 = 0,
    #[doc = "1: Host sequencer of the USB is not completely stopped."]
    _1 = 1,
}
...
#[doc = "Field `OVCMON` reader - External USB0_OVRCURA/ USB0_OVRCURB Input Pin MonitorThe OCVMON\\[1\\]
...
impl R {
    ...
    #[doc = "Bits 14:15 - External USB0_OVRCURA/ USB0_OVRCURB Input Pin MonitorThe OCVMON\\[1\\]
bit indicates the status of the USBHS_OVRCURA pin. The OCVMON\\[0\\]
bit indicates the status of the USBHS_OVRCURB pin."]
    #[inline(always)]
