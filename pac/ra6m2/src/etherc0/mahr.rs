...
#[doc = "Field `MAHR` reader - MAC Address Upper Bit RegisterThe MAHR register sets the upper 32 bits (b47 to b16) of the 48-bit MAC address."]
pub type MAHR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MAHR` writer - MAC Address Upper Bit RegisterThe MAHR register sets the upper 32 bits (b47 to b16) of the 48-bit MAC address."]
pub type MAHR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAHR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - MAC Address Upper Bit RegisterThe MAHR register sets the upper 32 bits (b47 to b16) of the 48-bit MAC address."]
    #[inline(always)]
