...
#[doc = "Field `LCCR` reader - Lost Carrier Counter RegisterThe LCCR register is a counter indicating the number of times a loss of carrier is detected during frame transmission."]
pub type LCCR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LCCR` writer - Lost Carrier Counter RegisterThe LCCR register is a counter indicating the number of times a loss of carrier is detected during frame transmission."]
pub type LCCR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LCCR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Lost Carrier Counter RegisterThe LCCR register is a counter indicating the number of times a loss of carrier is detected during frame transmission."]
    #[inline(always)]
