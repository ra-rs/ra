...
#[doc = "Field `MDC` reader - MII/RMII Management Data ClockThe MDC bit value is output from the ETn_MDC pin to supply the management data clock to the MII or RMII."]
pub type MDC_R = crate::BitReader<bool>;
#[doc = "Field `MDC` writer - MII/RMII Management Data ClockThe MDC bit value is output from the ETn_MDC pin to supply the management data clock to the MII or RMII."]
...
#[doc = "Field `MDO` reader - MII/RMII Management Data-OutThe MDO bit value is output from the ETn_MDIO pin when the MMD bit is 1 (write). The value is not output when the MMD bit is 0 (read)."]
pub type MDO_R = crate::BitReader<bool>;
#[doc = "Field `MDO` writer - MII/RMII Management Data-OutThe MDO bit value is output from the ETn_MDIO pin when the MMD bit is 1 (write). The value is not output when the MMD bit is 0 (read)."]
pub type MDO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIR_SPEC, bool, O>;
#[doc = "Field `MDI` reader - MII/RMII Management Data-InThis bit indicates the level of the ETn_MDIO pin. The write value should be 0."]
pub type MDI_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - MII/RMII Management Data ClockThe MDC bit value is output from the ETn_MDC pin to supply the management data clock to the MII or RMII."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - MII/RMII Management Data-OutThe MDO bit value is output from the ETn_MDIO pin when the MMD bit is 1 (write). The value is not output when the MMD bit is 0 (read)."]
    #[inline(always)]
    pub fn mdo(&self) -> MDO_R {
        MDO_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - MII/RMII Management Data-InThis bit indicates the level of the ETn_MDIO pin. The write value should be 0."]
    #[inline(always)]
