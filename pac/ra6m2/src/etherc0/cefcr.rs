...
#[doc = "Field `CEFCR` reader - CRC Error Frame Receive Counter RegisterThe CEFCR register is a counter indicating the number of received frames where a CRC error has been detected."]
pub type CEFCR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CEFCR` writer - CRC Error Frame Receive Counter RegisterThe CEFCR register is a counter indicating the number of received frames where a CRC error has been detected."]
pub type CEFCR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CEFCR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CRC Error Frame Receive Counter RegisterThe CEFCR register is a counter indicating the number of received frames where a CRC error has been detected."]
    #[inline(always)]
