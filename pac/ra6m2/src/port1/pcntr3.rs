...
pub type POSR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PCNTR3_SPEC, u16, POSR_AW, 16, O>;
...
pub type PORR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PCNTR3_SPEC, u16, PORR_AW, 16, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn porr(&mut self) -> PORR_W<16> {
        PORR_W::new(self)
    }
