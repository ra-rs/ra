...
#[doc = "Field `CTSUCHTRC0` reader - CTSU Channel Transmit/Receive Control 0CTSUCHTRC0\\[0\\]
corresponds to TS00 and CTSUCHTRC0\\[7\\]
corresponds to TS07. ( 0: Reception / 1: Transmission )"]
pub type CTSUCHTRC0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CTSUCHTRC0` writer - CTSU Channel Transmit/Receive Control 0CTSUCHTRC0\\[0\\]
corresponds to TS00 and CTSUCHTRC0\\[7\\]
corresponds to TS07. ( 0: Reception / 1: Transmission )"]
pub type CTSUCHTRC0_W<'a, const O: u8> = crate::FieldWriter<'a, u8, CTSUCHTRC0_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - CTSU Channel Transmit/Receive Control 0CTSUCHTRC0\\[0\\]
corresponds to TS00 and CTSUCHTRC0\\[7\\]
corresponds to TS07. ( 0: Reception / 1: Transmission )"]
    #[inline(always)]
