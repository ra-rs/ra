...
pub enum SEG_AW {
    ...
    _0 = 0,
    #[doc = "1: Generate a software event"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WE_A {
    #[doc = "0: Disable writes to SEG bit"]
    _0 = 0,
    #[doc = "1: Enable writes to SEG bit"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WI_AW {
    #[doc = "0: Enable writes to ELSEGR register"]
    _0 = 0,
    #[doc = "1: Disable writes to ELSEGR register."]
    _1 = 1,
}
