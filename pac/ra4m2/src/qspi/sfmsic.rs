...
#[doc = "Field `SFMCIC` reader - Serial flash instruction code to substitute"]
pub type SFMCIC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SFMCIC` writer - Serial flash instruction code to substitute"]
pub type SFMCIC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SFMSIC_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Serial flash instruction code to substitute"]
    #[inline(always)]
