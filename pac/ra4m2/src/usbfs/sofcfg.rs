...
pub type EDGESTS_R = crate::BitReader<bool>;
...
pub enum BRDYM_A {
    #[doc = "0: Clear BRDY flag by software"]
    _0 = 0,
    #[doc = "1: Clear BRDY flag by the USBFS through a data read from the FIFO buffer or data write to the FIFO buffer"]
    _1 = 1,
}
