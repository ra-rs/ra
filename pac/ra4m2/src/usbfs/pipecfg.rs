...
pub enum SHTNAK_A {
    ...
    _0 = 0,
    #[doc = "1: Disable pipe after transfer ends"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BFRE_A {
    #[doc = "0: Generate BRDY interrupt on transmitting or receiving data"]
    _0 = 0,
    #[doc = "1: Generate BRDY interrupt on completion of reading data"]
    _1 = 1,
}
...
pub enum TYPE_A {
    #[doc = "0: Pipe not used"]
    _00 = 0,
    #[doc = "1: Pipes 1 and 2: Bulk transfer Pipes 3 to 5: Bulk transfer Pipes 6 to 9: Setting prohibited"]
    _01 = 1,
    #[doc = "2: Pipes 1 and 2: Setting prohibited Pipes 3 to 5: Setting prohibited Pipes 6 to 9: Interrupt transfer"]
    _10 = 2,
    #[doc = "3: Pipes 1 and 2: Isochronous transfer Pipes 3 to 5: Setting prohibited Pipes 6 to 9: Setting prohibited"]
    _11 = 3,
}
