...
pub type RDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, SSIFSR_SPEC, RDF_A, O>;
...
#[doc = "Field `RDC` reader - Number of Receive FIFO Data Indication Flag"]
...
pub type TDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SSIFSR_SPEC, TDE_A, O>;
...
#[doc = "Field `TDC` reader - Number of Transmit FIFO Data Indication Flag"]
...
impl R {
    ...
    #[doc = "Bits 8:13 - Number of Receive FIFO Data Indication Flag"]
    #[inline(always)]
    pub fn rdc(&self) -> RDC_R {
        RDC_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    ...
    #[doc = "Bits 24:29 - Number of Transmit FIFO Data Indication Flag"]
    #[inline(always)]
    pub fn tdc(&self) -> TDC_R {
        TDC_R::new(((self.bits >> 24) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Receive Data Full Flag"]
