...
#[doc = "Field `CSTPEN` reader - CTS external pin Enable"]
pub type CSTPEN_R = crate::BitReader<CSTPEN_A>;
#[doc = "CTS external pin Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CSTPEN_A {
    #[doc = "0: Alternate setting to use CTS and RTS functions as either one terminal"]
    _0 = 0,
    #[doc = "1: Dedicated setting for separately using CTS and RTS functions with 2 terminals These bits for the other SCI channels than SCIn (n = 0, 3, 4, 9) are reserved."]
    _1 = 1,
}
impl From<CSTPEN_A> for bool {
    #[inline(always)]
    fn from(variant: CSTPEN_A) -> Self {
        variant as u8 != 0
    }
}
impl CSTPEN_R {
...
#[doc = "Field `CSTPEN` writer - CTS external pin Enable"]
pub type CSTPEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, SPMR_SPEC, CSTPEN_A, O>;
impl<'a, const O: u8> CSTPEN_W<'a, O> {
    #[doc = "Alternate setting to use CTS and RTS functions as either one terminal"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CSTPEN_A::_0)
    }
...
impl R {
    ...
    #[inline(always)]
    pub fn cstpen(&self) -> CSTPEN_R {
        CSTPEN_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cstpen(&mut self) -> CSTPEN_W<3> {
        CSTPEN_W::new(self)
    }
    #[doc = "Bit 4 - Mode Fault Flag"]
    #[inline(always)]
