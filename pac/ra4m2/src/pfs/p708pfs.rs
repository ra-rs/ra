#[doc = "Register `P708PFS` reader"]
pub struct R(crate::R<P708PFS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P708PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P708PFS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P708PFS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P708PFS` writer"]
pub struct W(crate::W<P708PFS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P708PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P708PFS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P708PFS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, NCODR_A, O>;
...
pub type DSCR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, P708PFS_SPEC, u8, DSCR_A, 2, O>;
...
pub type EOFR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, P708PFS_SPEC, u8, EOFR_A, 2, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, ASEL_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PMR_A {
    #[doc = "0: Use as general I/O pin"]
    _0 = 0,
    #[doc = "1: Use as I/O port for peripheral functions"]
    _1 = 1,
}
...
pub type PMR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P708PFS_SPEC, PMR_A, O>;
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, P708PFS_SPEC, u8, u8, 5, O>;
impl R {
...
#[doc = "Port 708 Pin Function Select Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p708pfs](index.html) module"]
pub struct P708PFS_SPEC;
impl crate::RegisterSpec for P708PFS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [p708pfs::R](R) reader structure"]
impl crate::Readable for P708PFS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p708pfs::W](W) writer structure"]
impl crate::Writable for P708PFS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P708PFS to value 0"]
impl crate::Resettable for P708PFS_SPEC {
