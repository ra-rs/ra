...
pub struct R(crate::R<P0PFS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P0PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P0PFS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P0PFS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P0%sPFS` writer"]
pub struct W(crate::W<P0PFS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P0PFS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P0PFS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P0PFS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, NCODR_A, O>;
...
pub type DSCR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, P0PFS_SPEC, u8, DSCR_A, 2, O>;
...
pub type EOFR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, P0PFS_SPEC, u8, EOFR_A, 2, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, ASEL_A, O>;
...
pub type PMR_W<'a, const O: u8> = crate::BitWriter<'a, u32, P0PFS_SPEC, PMR_A, O>;
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, P0PFS_SPEC, u8, u8, 5, O>;
impl R {
