...
pub struct RegisterBlock {
    ...
    _reserved65: [u8; 0x21],
    #[doc = "0x440 - LDO Stop Control Register"]
    pub ldoscr: LDOSCR,
    _reserved66: [u8; 0x03],
    #[doc = "0x444 - PLL2-LDO Stop Control Register"]
    pub pl2ldoscr: PL2LDOSCR,
    _reserved67: [u8; 0x3b],
...
pub mod vbattmonr;
#[doc = "LDOSCR (rw) register accessor: an alias for `Reg<LDOSCR_SPEC>`"]
pub type LDOSCR = crate::Reg<ldoscr::LDOSCR_SPEC>;
#[doc = "LDO Stop Control Register"]
pub mod ldoscr;
#[doc = "PL2LDOSCR (rw) register accessor: an alias for `Reg<PL2LDOSCR_SPEC>`"]
pub type PL2LDOSCR = crate::Reg<pl2ldoscr::PL2LDOSCR_SPEC>;
