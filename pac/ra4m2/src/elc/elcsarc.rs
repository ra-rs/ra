...
#[doc = "Field `ELSR` reader - Event Link Setting Register n Security Attribution (n = 16 to 18)"]
...
#[doc = "Field `ELSR` writer - Event Link Setting Register n Security Attribution (n = 16 to 18)"]
pub type ELSR_W<'a, const O: u8> = crate::FieldWriter<'a, u16, ELCSARC_SPEC, u8, ELSR_A, 3, O>;
...
impl R {
    #[doc = "Bits 0:2 - Event Link Setting Register n Security Attribution (n = 16 to 18)"]
    #[inline(always)]
    pub fn elsr(&self) -> ELSR_R {
        ELSR_R::new((self.bits & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Event Link Setting Register n Security Attribution (n = 16 to 18)"]
