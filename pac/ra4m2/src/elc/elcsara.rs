...
pub type ELCR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ELCSARA_SPEC, ELCR_A, O>;
...
pub type ELSEGR0_W<'a, const O: u8> = crate::BitWriter<'a, u16, ELCSARA_SPEC, ELSEGR0_A, O>;
...
pub type ELSEGR1_W<'a, const O: u8> = crate::BitWriter<'a, u16, ELCSARA_SPEC, ELSEGR1_A, O>;
...
#[doc = "`reset()` method sets ELCSARA to value 0xffff"]
