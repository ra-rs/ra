...
#[doc = "Field `IRQWUPEN` reader - IRQn Interrupt Software Standby/Snooze Mode Returns Enable bit"]
pub type IRQWUPEN_R = crate::FieldReader<u16, IRQWUPEN_A>;
#[doc = "IRQn Interrupt Software Standby/Snooze Mode Returns Enable bit\n\nValue on reset: 0"]
...
#[doc = "Field `IRQWUPEN` writer - IRQn Interrupt Software Standby/Snooze Mode Returns Enable bit"]
...
impl R {
    #[doc = "Bits 0:15 - IRQn Interrupt Software Standby/Snooze Mode Returns Enable bit"]
    #[inline(always)]
