...
#[doc = "Field `NONSEC13` reader - Non Secure Attribute bit 13"]
pub type NONSEC13_R = crate::BitReader<NONSEC13_A>;
...
impl From<NONSEC13_A> for bool {
    #[inline(always)]
    fn from(variant: NONSEC13_A) -> Self {
        variant as u8 != 0
    }
}
impl NONSEC13_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> NONSEC13_A {
        match self.bits {
            false => NONSEC13_A::_0,
            true => NONSEC13_A::_1,
        }
...
#[doc = "Field `NONSEC13` writer - Non Secure Attribute bit 13"]
pub type NONSEC13_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPMSAR_SPEC, NONSEC13_A, O>;
impl<'a, const O: u8> NONSEC13_W<'a, O> {
    #[doc = "Secure"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(NONSEC13_A::_0)
    }
    #[doc = "Non Secure"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(NONSEC13_A::_1)
    }
}
impl R {
    ...
    #[doc = "Bit 13 - Non Secure Attribute bit 13"]
    #[inline(always)]
    pub fn nonsec13(&self) -> NONSEC13_R {
        NONSEC13_R::new(((self.bits >> 13) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Non Secure Attribute bit 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn nonsec13(&mut self) -> NONSEC13_W<13> {
        NONSEC13_W::new(self)
    }
