...
#[doc = "Field `RSV` reader - Reserved. Set these bits to the same value as PCKB\\[2:0\\]."]
pub type RSV_R = crate::FieldReader<u8, RSV_A>;
...
impl From<RSV_A> for u8 {
    #[inline(always)]
    fn from(variant: RSV_A) -> Self {
        variant as _
    }
}
impl RSV_R {
...
#[doc = "Field `RSV` writer - Reserved. Set these bits to the same value as PCKB\\[2:0\\]."]
pub type RSV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCKDIVCR_SPEC, u8, RSV_A, 3, O>;
impl<'a, const O: u8> RSV_W<'a, O> {
    #[doc = "x 1/1"]
    #[inline(always)]
    pub fn _000(self) -> &'a mut W {
        self.variant(RSV_A::_000)
    }
    #[doc = "x 1/2"]
    #[inline(always)]
    pub fn _001(self) -> &'a mut W {
        self.variant(RSV_A::_001)
    }
    #[doc = "x 1/4"]
    #[inline(always)]
    pub fn _010(self) -> &'a mut W {
        self.variant(RSV_A::_010)
    }
    #[doc = "x 1/8"]
    #[inline(always)]
    pub fn _011(self) -> &'a mut W {
        self.variant(RSV_A::_011)
    }
    #[doc = "x 1/16"]
    #[inline(always)]
    pub fn _100(self) -> &'a mut W {
        self.variant(RSV_A::_100)
    }
    #[doc = "x 1/32"]
    #[inline(always)]
    pub fn _101(self) -> &'a mut W {
        self.variant(RSV_A::_101)
    }
    #[doc = "x 1/64"]
    #[inline(always)]
    pub fn _110(self) -> &'a mut W {
        self.variant(RSV_A::_110)
    }
}
...
#[doc = "Field `FCK` reader - FlashIF Clock (FCLK) Select"]
...
#[doc = "Field `FCK` writer - FlashIF Clock (FCLK) Select"]
...
impl R {
    ...
    #[doc = "Bits 16:18 - Reserved. Set these bits to the same value as PCKB\\[2:0\\]."]
    #[inline(always)]
    pub fn rsv(&self) -> RSV_R {
        RSV_R::new(((self.bits >> 16) & 7) as u8)
    }
    ...
    #[doc = "Bits 28:30 - FlashIF Clock (FCLK) Select"]
    #[inline(always)]
...
#[doc = "`reset()` method sets SCKDIVCR to value 0x2202_2222"]
impl crate::Resettable for SCKDIVCR_SPEC {
    const RESET_VALUE: Self::Ux = 0x2202_2222;
}
