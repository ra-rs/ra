...
pub enum DAE_A {
    #[doc = "0: Control D/A conversion of channels 0 and 1 individually"]
    _0 = 0,
    #[doc = "1: Control D/A conversion of channels 0 and 1 collectively"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DAOE0_A {
    #[doc = "0: Disable analog output of channel 0 (DA0)"]
    _0 = 0,
    #[doc = "1: Enable D/A conversion of channel 0 (DA0)"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DAOE1_A {
    #[doc = "0: Disable analog output of channel 1 (DA1)"]
    _0 = 0,
    #[doc = "1: Enable D/A conversion of channel 1 (DA1)"]
    _1 = 1,
}
