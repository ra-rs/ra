...
#[doc = "Field `AD` reader - Converted Value 11 to 0"]
...
pub enum DIAGST_A {
    ...
    _00 = 0,
    #[doc = "1: Self-diagnosis was executed using the 0 V voltage."]
    _01 = 1,
    #[doc = "2: Self-diagnosis was executed using the reference power supply voltage x 1/2."]
    _10 = 2,
    #[doc = "3: Self-diagnosis was executed using the reference power supply voltage."]
    _11 = 3,
}
