...
#[doc = "Field `RFC16` reader - Write 0 before writing to the RFRL register after a cold start."]
pub type RFC16_R = crate::BitReader<bool>;
#[doc = "Field `RFC16` writer - Write 0 before writing to the RFRL register after a cold start."]
pub type RFC16_W<'a, const O: u8> = crate::BitWriter<'a, u16, RFRH_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Write 0 before writing to the RFRL register after a cold start."]
    #[inline(always)]
