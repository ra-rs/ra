...
pub enum ENB_A {
    #[doc = "0: Do not compare register value with RMONCNT counter value"]
    _0 = 0,
    #[doc = "1: Compare register value with RMONCNT counter value"]
    _1 = 1,
}
...
impl R {
    #[doc = "Bits 0:3 - 1 Month"]
    #[inline(always)]
    pub fn mon1(&self) -> MON1_R {
        MON1_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bit 4 - 10 Months"]
    #[inline(always)]
