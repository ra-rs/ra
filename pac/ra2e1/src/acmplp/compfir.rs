...
pub enum C0FCK_A {
    ...
    _00 = 0,
    #[doc = "1: Sampling at PCLKB"]
    _01 = 1,
    #[doc = "2: Sampling at PCLKB/8"]
    _10 = 2,
    #[doc = "3: Sampling at PCLKB/32"]
    _11 = 3,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum C0EPO_A {
    #[doc = "0: Interrupt and ELC event request on rising edge"]
    _0 = 0,
    #[doc = "1: Interrupt and ELC event request on falling edge"]
    _1 = 1,
}
...
impl R {
    ...
    pub fn c1fck(&self) -> C1FCK_R {
        C1FCK_R::new(((self.bits >> 4) & 3) as u8)
    }
