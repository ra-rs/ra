...
pub enum AAS0_A {
    #[doc = "0: Slave address 0 not detected"]
    _0 = 0,
    #[doc = "1: Slave address 0 detected"]
    _1 = 1,
}
...
pub type AAS0_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICSR1_SPEC, AAS0_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum AAS1_A {
    #[doc = "0: Slave address 1 not detected"]
    _0 = 0,
    #[doc = "1: Slave address 1 detected"]
    _1 = 1,
}
...
pub type AAS1_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICSR1_SPEC, AAS1_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum AAS2_A {
    #[doc = "0: Slave address 2 not detected"]
    _0 = 0,
    #[doc = "1: Slave address 2 detected"]
    _1 = 1,
}
...
pub type AAS2_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICSR1_SPEC, AAS2_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GCA_A {
    #[doc = "0: General call address not detected"]
    _0 = 0,
...
pub type GCA_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICSR1_SPEC, GCA_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DID_A {
    #[doc = "0: Device-ID command not detected"]
    _0 = 0,
    #[doc = "1: Device-ID command detected"]
    _1 = 1,
}
...
pub type DID_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICSR1_SPEC, DID_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HOA_A {
    #[doc = "0: Host address not detected"]
    _0 = 0,
    #[doc = "1: Host address detected"]
    _1 = 1,
}
...
pub type HOA_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICSR1_SPEC, HOA_A, O>;
