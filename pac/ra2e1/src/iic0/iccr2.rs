...
#[doc = "Field `ST` reader - Start Condition Issuance Request"]
pub type ST_R = crate::BitReader<ST_A>;
#[doc = "Start Condition Issuance Request\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ST_A {
    #[doc = "0: Do not issue a start condition request"]
    _0 = 0,
    #[doc = "1: Issue a start condition request"]
    _1 = 1,
}
...
#[doc = "Field `ST` writer - Start Condition Issuance Request"]
...
#[doc = "Field `RS` reader - Restart Condition Issuance Request"]
pub type RS_R = crate::BitReader<RS_A>;
#[doc = "Restart Condition Issuance Request\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RS_A {
    #[doc = "0: Do not issue a restart condition request"]
    _0 = 0,
    #[doc = "1: Issue a restart condition request"]
    _1 = 1,
}
...
#[doc = "Field `RS` writer - Restart Condition Issuance Request"]
...
#[doc = "Field `SP` reader - Stop Condition Issuance Request"]
pub type SP_R = crate::BitReader<SP_A>;
#[doc = "Stop Condition Issuance Request\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SP_A {
    #[doc = "0: Do not issue a stop condition request"]
    _0 = 0,
    #[doc = "1: Issue a stop condition request"]
    _1 = 1,
}
...
#[doc = "Field `SP` writer - Stop Condition Issuance Request"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BBSY_A {
    #[doc = "0: I2C bus released (bus free state)"]
    _0 = 0,
    #[doc = "1: I2C bus occupied (bus busy state)"]
    _1 = 1,
}
...
impl R {
    #[doc = "Bit 1 - Start Condition Issuance Request"]
    #[inline(always)]
    pub fn st(&self) -> ST_R {
        ST_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Restart Condition Issuance Request"]
    #[inline(always)]
    pub fn rs(&self) -> RS_R {
        RS_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Stop Condition Issuance Request"]
    #[inline(always)]
    pub fn sp(&self) -> SP_R {
