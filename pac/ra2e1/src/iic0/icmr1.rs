...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BCWP_AW {
    #[doc = "0: Write enable BC\\[2:0\\]
bits"]
    _0 = 0,
    #[doc = "1: Write protect BC\\[2:0\\]
bits"]
    _1 = 1,
}
...
#[doc = "Field `CKS` reader - Internal Reference Clock Select"]
pub type CKS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CKS` writer - Internal Reference Clock Select"]
pub type CKS_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ICMR1_SPEC, u8, u8, 3, O>;
#[doc = "Field `MTWP` reader - MST/TRS Write Protect"]
pub type MTWP_R = crate::BitReader<MTWP_A>;
#[doc = "MST/TRS Write Protect\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MTWP_A {
    #[doc = "0: Write protect MST and TRS bits in ICCR2"]
    _0 = 0,
    #[doc = "1: Write enable MST and TRS bits in ICCR2"]
    _1 = 1,
}
...
impl R {
    ...
    #[inline(always)]
    pub fn bc(&self) -> BC_R {
        BC_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - Internal Reference Clock Select"]
    #[inline(always)]
    pub fn cks(&self) -> CKS_R {
        CKS_R::new(((self.bits >> 4) & 7) as u8)
    }
