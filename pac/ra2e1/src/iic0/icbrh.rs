...
#[doc = "Field `BRH` reader - Bit Rate High-Level Period"]
pub type BRH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BRH` writer - Bit Rate High-Level Period"]
pub type BRH_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ICBRH_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - Bit Rate High-Level Period"]
    #[inline(always)]
    pub fn brh(&self) -> BRH_R {
        BRH_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4 - Bit Rate High-Level Period"]
