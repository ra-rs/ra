...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RIE_A {
    #[doc = "0: Disable receive data full interrupt (IIC0_RXI) request"]
    _0 = 0,
    #[doc = "1: Enable receive data full interrupt (IIC0_RXI) request"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TEIE_A {
    #[doc = "0: Disable transmit end interrupt (IIC0_TEI) request"]
    _0 = 0,
    #[doc = "1: Enable transmit end interrupt (IIC0_TEI) request"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TIE_A {
    #[doc = "0: Disable transmit data empty interrupt (IIC0_TXI) request"]
    _0 = 0,
    #[doc = "1: Enable transmit data empty interrupt (IIC0_TXI) request"]
    _1 = 1,
}
