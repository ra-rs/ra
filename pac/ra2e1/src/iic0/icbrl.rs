...
#[doc = "Field `BRL` reader - Bit Rate Low-Level Period"]
pub type BRL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BRL` writer - Bit Rate Low-Level Period"]
pub type BRL_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ICBRL_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - Bit Rate Low-Level Period"]
    #[inline(always)]
    pub fn brl(&self) -> BRL_R {
        BRL_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4 - Bit Rate Low-Level Period"]
