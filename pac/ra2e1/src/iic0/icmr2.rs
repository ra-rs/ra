...
pub enum TMOS_A {
    #[doc = "0: Select long mode"]
    _0 = 0,
    #[doc = "1: Select short mode"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMOL_A {
    #[doc = "0: Disable count while SCL0 line is low"]
    _0 = 0,
    #[doc = "1: Enable count while SCL0 line is low"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMOH_A {
    #[doc = "0: Disable count while SCL0 line is high"]
    _0 = 0,
    #[doc = "1: Enable count while SCL0 line is high"]
    _1 = 1,
}
...
pub enum SDDL_A {
    ...
    _000 = 0,
    #[doc = "1: 1 IIC-phi cycle (When ICMR2.DLCS = 0 (IIC-phi)) 1 or 2 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _001 = 1,
    #[doc = "2: 2 IIC-phi cycles (When ICMR2.DLCS = 0 (IIC-phi)) 3 or 4 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _010 = 2,
    #[doc = "3: 3 IIC-phi cycles (When ICMR2.DLCS = 0 (IIC-phi)) 5 or 6 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _011 = 3,
    #[doc = "4: 4 IIC-phi cycles (When ICMR2.DLCS = 0 (IIC-phi)) 7 or 8 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _100 = 4,
    #[doc = "5: 5 IIC-phi cycles (When ICMR2.DLCS = 0 (IIC-phi)) 9 or 10 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _101 = 5,
    #[doc = "6: 6 IIC-phi cycles (When ICMR2.DLCS = 0 (IIC-phi)) 11 or 12 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _110 = 6,
    #[doc = "7: 7 IIC-phi cycles (When ICMR2.DLCS = 0 (IIC-phi)) 13 or 14 IIC-phi cycles (When ICMR2.DLCS = 1 (IIC-phi/2))"]
    _111 = 7,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DLCS_A {
    #[doc = "0: Select internal reference clock (IIC-phi) as the clock source for SDA output delay counter"]
    _0 = 0,
    #[doc = "1: Select internal reference clock divided by 2 (IIC-phi/2) as the clock source for SDA output delay counter"]
    _1 = 1,
}
...
impl R {
    ...
    pub fn sddl(&self) -> SDDL_R {
        SDDL_R::new(((self.bits >> 4) & 7) as u8)
    }
