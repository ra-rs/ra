...
pub enum CKSEL_A {
    ...
    #[doc = "2: LOCO"]
    _010 = 2,
    #[doc = "3: Main clock oscillator (MOSC)"]
    _011 = 3,
...
pub type CKSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCKSCR_SPEC, u8, CKSEL_A, 3, O>;
impl<'a, const O: u8> CKSEL_W<'a, O> {
    ...
    pub fn _110(self) -> &'a mut W {
        self.variant(CKSEL_A::_110)
    }
    #[doc = "Setting prohibited"]
    #[inline(always)]
    pub fn _111(self) -> &'a mut W {
        self.variant(CKSEL_A::_111)
    }
}
impl R {
