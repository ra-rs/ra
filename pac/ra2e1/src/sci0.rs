...
impl RegisterBlock {
    ...
    pub fn smr_smci(&self) -> &SMR_SMCI {
        unsafe { &*(((self as *const Self) as *const u8).add(0usize) as *const SMR_SMCI) }
    }
    #[doc = "0x00 - Serial Mode Register for Non-Smart Card Interface Mode (SCMR.SMIF = 0)"]
    #[inline(always)]
    pub fn smr(&self) -> &SMR {
        unsafe { &*(((self as *const Self) as *const u8).add(0usize) as *const SMR) }
    }
    #[doc = "0x02 - Serial Control Register for Smart Card Interface Mode (SCMR.SMIF = 1)"]
    #[inline(always)]
    pub fn scr_smci(&self) -> &SCR_SMCI {
        unsafe { &*(((self as *const Self) as *const u8).add(2usize) as *const SCR_SMCI) }
    }
    #[doc = "0x02 - Serial Control Register for Non-Smart Card Interface Mode (SCMR.SMIF = 0)"]
    #[inline(always)]
    pub fn scr(&self) -> &SCR {
        unsafe { &*(((self as *const Self) as *const u8).add(2usize) as *const SCR) }
    }
    #[doc = "0x04 - Serial Status Register for Smart Card Interface Mode (SCMR.SMIF = 1)"]
    #[inline(always)]
    pub fn ssr_smci(&self) -> &SSR_SMCI {
        unsafe { &*(((self as *const Self) as *const u8).add(4usize) as *const SSR_SMCI) }
    }
    #[doc = "0x04 - Serial Status Register for Non-Smart Card Interface and FIFO Mode (SCMR.SMIF = 0, FCR.FM = 1)"]
    #[inline(always)]
    pub fn ssr_fifo(&self) -> &SSR_FIFO {
        unsafe { &*(((self as *const Self) as *const u8).add(4usize) as *const SSR_FIFO) }
    }
    #[doc = "0x04 - Serial Status Register for Non-Smart Card Interface and Non-FIFO Mode (SCMR.SMIF = 0, FCR.FM = 0)"]
    #[inline(always)]
    pub fn ssr(&self) -> &SSR {
        unsafe { &*(((self as *const Self) as *const u8).add(4usize) as *const SSR) }
    }
    #[doc = "0x0e - Transmit FIFO Data Register"]
    #[inline(always)]
    pub fn ftdrh(&self) -> &FTDRH {
        unsafe { &*(((self as *const Self) as *const u8).add(14usize) as *const FTDRH) }
    }
    #[doc = "0x0e - Transmit Data Register"]
    #[inline(always)]
    pub fn tdrhl(&self) -> &TDRHL {
        unsafe { &*(((self as *const Self) as *const u8).add(14usize) as *const TDRHL) }
    }
    #[doc = "0x0e - Transmit FIFO Data Register"]
    #[inline(always)]
    pub fn ftdrhl(&self) -> &FTDRHL {
        unsafe { &*(((self as *const Self) as *const u8).add(14usize) as *const FTDRHL) }
    }
    #[doc = "0x0f - Transmit FIFO Data Register"]
    #[inline(always)]
    pub fn ftdrl(&self) -> &FTDRL {
        unsafe { &*(((self as *const Self) as *const u8).add(15usize) as *const FTDRL) }
    }
    #[doc = "0x10 - Receive FIFO Data Register"]
    #[inline(always)]
    pub fn frdrh(&self) -> &FRDRH {
        unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const FRDRH) }
    }
    #[doc = "0x10 - Receive Data Register"]
    #[inline(always)]
    pub fn rdrhl(&self) -> &RDRHL {
        unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const RDRHL) }
    }
    #[doc = "0x10 - Receive FIFO Data Register"]
    #[inline(always)]
    pub fn frdrhl(&self) -> &FRDRHL {
        unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const FRDRHL) }
    }
    #[doc = "0x11 - Receive FIFO Data Register"]
    #[inline(always)]
    pub fn frdrl(&self) -> &FRDRL {
        unsafe { &*(((self as *const Self) as *const u8).add(17usize) as *const FRDRL) }
    }
}
