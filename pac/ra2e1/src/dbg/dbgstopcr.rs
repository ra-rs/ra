...
pub enum DBGSTOP_IWDT_A {
    ...
    _0 = 0,
    #[doc = "1: Mask IWDT reset/interrupt and stop IWDT count when CPU is in OCD break mode"]
    _1 = 1,
}
...
impl<'a, const O: u8> DBGSTOP_IWDT_W<'a, O> {
    ...
    #[doc = "Mask IWDT reset/interrupt and stop IWDT count when CPU is in OCD break mode"]
    #[inline(always)]
...
pub enum DBGSTOP_WDT_A {
    ...
    _0 = 0,
    #[doc = "1: Mask WDT reset/interrupt and stop WDT count when CPU is in OCD break mode"]
    _1 = 1,
}
...
impl<'a, const O: u8> DBGSTOP_WDT_W<'a, O> {
    ...
    #[doc = "Mask WDT reset/interrupt and stop WDT count when CPU is in OCD break mode"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
