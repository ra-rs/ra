...
#[doc = "Field `WUSEN` reader - Wakeup Function Synchronous Enable"]
...
#[doc = "Field `WUSEN` writer - Wakeup Function Synchronous Enable"]
...
#[doc = "Field `WUASYF` reader - Wakeup Function Asynchronous Operation Status Flag"]
...
#[doc = "Field `WUSYF` reader - Wakeup Function Synchronous Operation Status Flag"]
...
impl R {
    #[doc = "Bit 0 - Wakeup Function Synchronous Enable"]
    #[inline(always)]
    pub fn wusen(&self) -> WUSEN_R {
        WUSEN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Wakeup Function Asynchronous Operation Status Flag"]
    #[inline(always)]
    pub fn wuasyf(&self) -> WUASYF_R {
        WUASYF_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Wakeup Function Synchronous Operation Status Flag"]
    #[inline(always)]
