...
#[doc = "Field `ACMPLP0WUPEN` reader - ACMPLP0 Interrupt Software Standby/Snooze Mode Returns Enable"]
...
pub enum ACMPLP0WUPEN_A {
    #[doc = "0: Software Standby/Snooze Mode returns by ACMPLP0 interrupt disabled"]
    _0 = 0,
    #[doc = "1: Software Standby/Snooze Mode returns by ACMPLP0 interrupt enabled"]
    _1 = 1,
}
...
#[doc = "Field `ACMPLP0WUPEN` writer - ACMPLP0 Interrupt Software Standby/Snooze Mode Returns Enable"]
...
#[doc = "Field `RTCALMWUPEN` reader - RTC Alarm Interrupt Software Standby/Snooze Mode Returns Enable"]
...
pub enum RTCALMWUPEN_A {
    #[doc = "0: Software Standby/Snooze Mode returns by RTC alarm interrupt disabled"]
    _0 = 0,
    #[doc = "1: Software Standby/Snooze Mode returns by RTC alarm interrupt enabled."]
    _1 = 1,
}
...
#[doc = "Field `RTCALMWUPEN` writer - RTC Alarm Interrupt Software Standby/Snooze Mode Returns Enable"]
...
#[doc = "Field `RTCPRDWUPEN` reader - RTC Period Interrupt Software Standby/Snooze Mode Returns Enable"]
...
pub enum RTCPRDWUPEN_A {
    #[doc = "0: Software Standby/Snooze Mode returns by RTC period interrupt disabled"]
    _0 = 0,
    #[doc = "1: Software Standby/Snooze Mode returns by RTC period interrupt enabled"]
    _1 = 1,
}
...
#[doc = "Field `RTCPRDWUPEN` writer - RTC Period Interrupt Software Standby/Snooze Mode Returns Enable"]
...
#[doc = "Field `IIC0WUPEN` reader - IIC0 Address Match Interrupt Software Standby/Snooze Mode Returns Enable"]
...
pub enum IIC0WUPEN_A {
    #[doc = "0: Software Standby/Snooze Mode returns by IIC0 address match interrupt disabled"]
    _0 = 0,
    #[doc = "1: Software Standby/Snooze Mode returns by IIC0 address match interrupt enabled"]
    _1 = 1,
}
...
#[doc = "Field `IIC0WUPEN` writer - IIC0 Address Match Interrupt Software Standby/Snooze Mode Returns Enable"]
...
impl R {
    ...
    #[doc = "Bit 23 - ACMPLP0 Interrupt Software Standby/Snooze Mode Returns Enable"]
    #[inline(always)]
    pub fn acmplp0wupen(&self) -> ACMPLP0WUPEN_R {
        ACMPLP0WUPEN_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - RTC Alarm Interrupt Software Standby/Snooze Mode Returns Enable"]
    #[inline(always)]
    pub fn rtcalmwupen(&self) -> RTCALMWUPEN_R {
        RTCALMWUPEN_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - RTC Period Interrupt Software Standby/Snooze Mode Returns Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - IIC0 Address Match Interrupt Software Standby/Snooze Mode Returns Enable"]
    #[inline(always)]
