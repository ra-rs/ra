...
pub type UNDFF_W<'a, const O: u8> = crate::BitWriter<'a, u16, IWDTSR_SPEC, UNDFF_A, O>;
...
pub type REFEF_W<'a, const O: u8> = crate::BitWriter<'a, u16, IWDTSR_SPEC, REFEF_A, O>;
...
impl R {
    ...
    pub fn cntval(&self) -> CNTVAL_R {
        CNTVAL_R::new((self.bits & 0x3fff) as u16)
    }
