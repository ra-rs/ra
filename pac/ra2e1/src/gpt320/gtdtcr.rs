...
pub enum TDE_A {
    ...
    _0 = 0,
    #[doc = "1: GTDVU sets the compare match value for negative-phase waveform with automatic dead time in GTCCRB"]
    _1 = 1,
}
...
impl<'a, const O: u8> TDE_W<'a, O> {
    ...
    #[doc = "GTDVU sets the compare match value for negative-phase waveform with automatic dead time in GTCCRB"]
    #[inline(always)]
