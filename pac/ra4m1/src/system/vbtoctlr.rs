...
impl VOUT1LSEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> VOUT1LSEL_A {
        match self.bits {
...
pub type VOUT1LSEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, VBTOCTLR_SPEC, VOUT1LSEL_A, O>;
impl<'a, const O: u8> VOUT1LSEL_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vout1lsel(&mut self) -> VOUT1LSEL_W<4> {
