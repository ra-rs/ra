...
pub struct R(crate::R<P109PFS_HA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P109PFS_HA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P109PFS_HA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P109PFS_HA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P109PFS_HA` writer"]
pub struct W(crate::W<P109PFS_HA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P109PFS_HA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P109PFS_HA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P109PFS_HA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PODR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, PODR_A, O>;
...
pub type PDR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, PDR_A, O>;
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, PCR_A, O>;
...
pub type NCODR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, NCODR_A, O>;
...
pub type DSCR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, DSCR_A, O>;
...
pub type EOR_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, EOR_A, O>;
...
pub type EOF_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, EOF_A, O>;
...
pub type ISEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, ISEL_A, O>;
...
pub type ASEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, P109PFS_HA_SPEC, ASEL_A, O>;
