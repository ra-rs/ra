...
#[doc = "Field `ADS5` reader - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS5_R = crate::BitReader<ADS5_A>;
#[doc = "A/D-Converted Value Addition/Average Channel Select n\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS5_A {
    #[doc = "0: Do not select associated input channel."]
...
impl From<ADS5_A> for bool {
    #[inline(always)]
    fn from(variant: ADS5_A) -> Self {
        variant as u8 != 0
    }
}
impl ADS5_R {
...
#[doc = "Field `ADS5` writer - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS5_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADADS0_SPEC, ADS5_A, O>;
impl<'a, const O: u8> ADS5_W<'a, O> {
    #[doc = "Do not select associated input channel."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ADS5_A::_0)
    }
    #[doc = "Select associated input channel."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ADS5_A::_1)
    }
}
#[doc = "Field `ADS6` reader - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS6_R = crate::BitReader<ADS6_A>;
#[doc = "A/D-Converted Value Addition/Average Channel Select n\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS6_A {
    #[doc = "0: Do not select associated input channel."]
...
impl From<ADS6_A> for bool {
    #[inline(always)]
    fn from(variant: ADS6_A) -> Self {
        variant as u8 != 0
    }
}
impl ADS6_R {
...
#[doc = "Field `ADS6` writer - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS6_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADADS0_SPEC, ADS6_A, O>;
impl<'a, const O: u8> ADS6_W<'a, O> {
    #[doc = "Do not select associated input channel."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ADS6_A::_0)
    }
    #[doc = "Select associated input channel."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ADS6_A::_1)
    }
}
#[doc = "Field `ADS7` reader - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS7_R = crate::BitReader<ADS7_A>;
#[doc = "A/D-Converted Value Addition/Average Channel Select n\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS7_A {
    #[doc = "0: Do not select associated input channel."]
...
impl From<ADS7_A> for bool {
    #[inline(always)]
    fn from(variant: ADS7_A) -> Self {
        variant as u8 != 0
    }
}
impl ADS7_R {
...
#[doc = "Field `ADS7` writer - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS7_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADADS0_SPEC, ADS7_A, O>;
impl<'a, const O: u8> ADS7_W<'a, O> {
    #[doc = "Do not select associated input channel."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ADS7_A::_0)
    }
    #[doc = "Select associated input channel."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ADS7_A::_1)
    }
}
#[doc = "Field `ADS8` reader - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS8_R = crate::BitReader<ADS8_A>;
#[doc = "A/D-Converted Value Addition/Average Channel Select n\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS8_A {
    #[doc = "0: Do not select associated input channel."]
...
impl From<ADS8_A> for bool {
    #[inline(always)]
    fn from(variant: ADS8_A) -> Self {
        variant as u8 != 0
    }
}
impl ADS8_R {
...
#[doc = "Field `ADS8` writer - A/D-Converted Value Addition/Average Channel Select n"]
pub type ADS8_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADADS0_SPEC, ADS8_A, O>;
impl<'a, const O: u8> ADS8_W<'a, O> {
    #[doc = "Do not select associated input channel."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ADS8_A::_0)
    }
    #[doc = "Select associated input channel."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ADS8_A::_1)
    }
}
...
impl R {
    ...
    #[doc = "Bit 5 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    pub fn ads5(&self) -> ADS5_R {
        ADS5_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    pub fn ads6(&self) -> ADS6_R {
        ADS6_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    pub fn ads7(&self) -> ADS7_R {
        ADS7_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    pub fn ads8(&self) -> ADS8_R {
        ADS8_R::new(((self.bits >> 8) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ads5(&mut self) -> ADS5_W<5> {
        ADS5_W::new(self)
    }
    #[doc = "Bit 6 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    #[must_use]
    pub fn ads6(&mut self) -> ADS6_W<6> {
        ADS6_W::new(self)
    }
    #[doc = "Bit 7 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    #[must_use]
    pub fn ads7(&mut self) -> ADS7_W<7> {
        ADS7_W::new(self)
    }
    #[doc = "Bit 8 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
    #[must_use]
    pub fn ads8(&mut self) -> ADS8_W<8> {
        ADS8_W::new(self)
    }
    #[doc = "Bit 12 - A/D-Converted Value Addition/Average Channel Select n"]
    #[inline(always)]
