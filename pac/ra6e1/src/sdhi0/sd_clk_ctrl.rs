...
#[doc = "Field `CLKEN` reader - SD/MMC Clock Output Control"]
pub type CLKEN_R = crate::BitReader<CLKEN_A>;
#[doc = "SD/MMC Clock Output Control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLKEN_A {
    #[doc = "0: Disable SD/MMC clock output (fix SDnCLK signal low)"]
    _0 = 0,
    #[doc = "1: Enable SD/MMC clock output"]
    _1 = 1,
}
...
#[doc = "Field `CLKEN` writer - SD/MMC Clock Output Control"]
...
#[doc = "Field `CLKCTRLEN` reader - SD/MMC Clock Output Automatic Control Select"]
pub type CLKCTRLEN_R = crate::BitReader<CLKCTRLEN_A>;
#[doc = "SD/MMC Clock Output Automatic Control Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLKCTRLEN_A {
    #[doc = "0: Disable automatic control of SD/MMC clock output"]
    _0 = 0,
    #[doc = "1: Enable automatic control of SD/MMC clock output"]
    _1 = 1,
}
...
#[doc = "Field `CLKCTRLEN` writer - SD/MMC Clock Output Automatic Control Select"]
...
impl R {
    ...
    #[doc = "Bit 8 - SD/MMC Clock Output Control"]
    #[inline(always)]
    pub fn clken(&self) -> CLKEN_R {
        CLKEN_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - SD/MMC Clock Output Automatic Control Select"]
    #[inline(always)]
