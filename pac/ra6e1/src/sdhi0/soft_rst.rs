...
#[doc = "Field `SDRST` reader - Software Reset Control"]
pub type SDRST_R = crate::BitReader<SDRST_A>;
#[doc = "Software Reset Control\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDRST_A {
    #[doc = "0: Reset SD/MMC Host Interface software"]
    _0 = 0,
    #[doc = "1: Cancel reset of SD/MMC Host Interface software"]
    _1 = 1,
}
...
#[doc = "Field `SDRST` writer - Software Reset Control"]
