...
#[doc = "Field `MDC` reader - RMII Management Data Clock"]
pub type MDC_R = crate::BitReader<bool>;
#[doc = "Field `MDC` writer - RMII Management Data Clock"]
pub type MDC_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIR_SPEC, bool, O>;
#[doc = "Field `MMD` reader - RMII Management Mode"]
...
#[doc = "Field `MMD` writer - RMII Management Mode"]
