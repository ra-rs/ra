...
#[doc = "Field `ELSR` reader - Event Link Setting Register n Security Attribution (n = 16 to 17)"]
...
#[doc = "Field `ELSR` writer - Event Link Setting Register n Security Attribution (n = 16 to 17)"]
...
impl R {
    #[doc = "Bits 0:1 - Event Link Setting Register n Security Attribution (n = 16 to 17)"]
    #[inline(always)]
