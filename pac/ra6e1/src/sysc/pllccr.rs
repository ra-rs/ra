...
pub type PLIDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u16, PLLCCR_SPEC, u8, PLIDIV_A, 2, O>;
...
pub type PLLMUL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, PLLCCR_SPEC, u8, u8, 6, O>;
impl R {
    ...
    #[doc = "Bits 8:13 - PLL Frequency Multiplication Factor Select"]
    #[inline(always)]
