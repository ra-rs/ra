...
#[repr(u8)]
pub enum RHST_A {
    #[doc = "0: In host controller mode: Communication speed indeterminate (powered state or no connection) In device controller mode: Communication speed indeterminate"]
    _000 = 0,
    #[doc = "1: In host controller mode: Low-speed connection In device controller mode: USB bus reset in progress"]
    _001 = 1,
    #[doc = "2: In host controller mode: Full-speed connection In device controller mode: USB bus reset in progress or full-speed connection"]
    _010 = 2,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UACT_A {
    #[doc = "0: Disable downstream port (disable SOF transmission)"]
    _0 = 0,
    #[doc = "1: Enable downstream port (enable SOF transmission)"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VBUSEN_A {
    #[doc = "0: Output low on external USB_VBUSEN pin"]
    _0 = 0,
    #[doc = "1: Output high on external USB_VBUSEN pin"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum EXICEN_A {
    #[doc = "0: Output low on external USB_EXICEN pin"]
    _0 = 0,
    #[doc = "1: Output high on external USB_EXICEN pin"]
    _1 = 1,
}
...
#[doc = "Field `HNPBTOA` reader - Host Negotiation Protocol (HNP) Control"]
pub type HNPBTOA_R = crate::BitReader<bool>;
#[doc = "Field `HNPBTOA` writer - Host Negotiation Protocol (HNP) Control"]
...
impl R {
    ...
    #[doc = "Bit 11 - Host Negotiation Protocol (HNP) Control"]
    #[inline(always)]
