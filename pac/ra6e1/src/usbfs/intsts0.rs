...
impl CTSQ_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CTSQ_A> {
        match self.bits {
            0 => Some(CTSQ_A::_000),
            1 => Some(CTSQ_A::_001),
            2 => Some(CTSQ_A::_010),
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VALID_A {
    #[doc = "0: Setup packet not received"]
    _0 = 0,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CTRT_A {
    #[doc = "0: No control transfer stage transition interrupt occurred"]
    _0 = 0,
    #[doc = "1: Control transfer stage transition interrupt occurred"]
    _1 = 1,
}
...
pub type CTRT_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTSTS0_SPEC, CTRT_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DVST_A {
    #[doc = "0: No device state transition interrupt occurred"]
    _0 = 0,
    #[doc = "1: Device state transition interrupt occurred"]
    _1 = 1,
}
...
pub type DVST_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTSTS0_SPEC, DVST_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SOFR_A {
    #[doc = "0: No SOF interrupt occurred"]
    _0 = 0,
    #[doc = "1: SOF interrupt occurred"]
    _1 = 1,
}
...
pub type SOFR_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTSTS0_SPEC, SOFR_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RESM_A {
    #[doc = "0: No resume interrupt occurred"]
    _0 = 0,
    #[doc = "1: Resume interrupt occurred"]
    _1 = 1,
}
...
pub type RESM_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTSTS0_SPEC, RESM_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VBINT_A {
    #[doc = "0: No VBUS interrupt occurred"]
    _0 = 0,
    #[doc = "1: VBUS interrupt occurred"]
    _1 = 1,
}
...
pub type VBINT_W<'a, const O: u8> = crate::BitWriter<'a, u16, INTSTS0_SPEC, VBINT_A, O>;
