...
pub enum CERFIP_A {
    #[doc = "0: Disable CRC error interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable CRC error interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PREIP_A {
    #[doc = "0: Disable PHY-LSI receive error interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable PHY-LSI receive error interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RTSFIP_A {
    #[doc = "0: Disable frame-too-short error interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable frame-too-short error interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RTLFIP_A {
    #[doc = "0: Disable frame-too-long error interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable frame-too-long error interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RRFIP_A {
    #[doc = "0: Disable alignment error interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable alignment error interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RMAFIP_A {
    #[doc = "0: Disable multicast address frame receive interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable multicast address frame receive interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TROIP_A {
    #[doc = "0: Disable transmit retry over interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable transmit retry over interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CDIP_A {
    #[doc = "0: Disable late collision detected interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable late collision detected interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DLCIP_A {
    #[doc = "0: Disable loss of carrier detected interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable loss of carrier detected interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CNDIP_A {
    #[doc = "0: Disable carrier not detected interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable carrier not detected interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RFOFIP_A {
    #[doc = "0: Disable overflow interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable overflow interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RDEIP_A {
    #[doc = "0: Disable receive descriptor empty interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable receive descriptor empty interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FRIP_A {
    #[doc = "0: Disable frame reception interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable frame reception interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TFUFIP_A {
    #[doc = "0: Disable underflow interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable underflow interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TDEIP_A {
    #[doc = "0: Disable transmit descriptor empty interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable transmit descriptor empty interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TCIP_A {
    #[doc = "0: Disable frame transmission complete interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable frame transmission complete interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ECIIP_A {
    #[doc = "0: Disable ETHERC status interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable ETHERC status interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADEIP_A {
    #[doc = "0: Disable address error interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable address error interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RFCOFIP_A {
    #[doc = "0: Disable receive frame counter overflow interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable receive frame counter overflow interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RABTIP_A {
    #[doc = "0: Disable receive abort detected interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable receive abort detected interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TABTIP_A {
    #[doc = "0: Disable transmit abort detected interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable transmit abort detected interrupt requests."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TWBIP_A {
    #[doc = "0: Disable write-back complete interrupt requests"]
    _0 = 0,
    #[doc = "1: Enable write-back complete interrupt requests."]
    _1 = 1,
}
