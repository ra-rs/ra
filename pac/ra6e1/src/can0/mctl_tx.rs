...
pub enum SENTDATA_A {
    #[doc = "0: Transmission not complete"]
    _0 = 0,
    #[doc = "1: Transmission complete"]
    _1 = 1,
}
...
#[doc = "Field `TRMACTIVE` reader - Transmission-in-Progress Status Flag"]
pub type TRMACTIVE_R = crate::BitReader<TRMACTIVE_A>;
#[doc = "Transmission-in-Progress Status Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TRMACTIVE_A {
    #[doc = "0: Transmission pending or not requested"]
    _0 = 0,
    #[doc = "1: Transmission in progress"]
    _1 = 1,
}
...
#[doc = "Field `TRMABT` reader - Transmission Abort Complete Flag"]
pub type TRMABT_R = crate::BitReader<TRMABT_A>;
#[doc = "Transmission Abort Complete Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TRMABT_A {
    #[doc = "0: Transmission started, transmission abort failed because transmission completed, or transmission abort not requested"]
    _0 = 0,
    #[doc = "1: Transmission abort complete"]
    _1 = 1,
}
...
#[doc = "Field `TRMABT` writer - Transmission Abort Complete Flag"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ONESHOT_A {
    #[doc = "0: Disable one-shot transmission"]
    _0 = 0,
    #[doc = "1: Enable one-shot transmission"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RECREQ_A {
    #[doc = "0: Do not configure for reception"]
    _0 = 0,
    #[doc = "1: Configure for reception"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TRMREQ_A {
    #[doc = "0: Do not configure for transmission"]
    _0 = 0,
    #[doc = "1: Configure for transmission"]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 1 - Transmission-in-Progress Status Flag"]
    #[inline(always)]
    pub fn trmactive(&self) -> TRMACTIVE_R {
        TRMACTIVE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Transmission Abort Complete Flag"]
    #[inline(always)]
