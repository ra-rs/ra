...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RIE_A {
    #[doc = "0: Receive data full interrupt request (RXI) is disabled."]
    _0 = 0,
    #[doc = "1: Receive data full interrupt request (RXI) is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TEIE_A {
    #[doc = "0: Transmit end interrupt request (TEI) is disabled."]
    _0 = 0,
    #[doc = "1: Transmit end interrupt request (TEI) is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIE_A {
    #[doc = "0: Transmit data empty interrupt request (TXI) is disabled."]
    _0 = 0,
    #[doc = "1: Transmit data empty interrupt request (TXI) is enabled."]
    _1 = 1,
}
