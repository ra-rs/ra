...
pub type P000GAIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, ADPGAGS0_SPEC, u8, P000GAIN_A, 4, O>;
...
pub type P001GAIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, ADPGAGS0_SPEC, u8, P001GAIN_A, 4, O>;
...
pub type P002GAIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, ADPGAGS0_SPEC, u8, P002GAIN_A, 4, O>;
