...
#[doc = "Field `SHANS0` reader - AN100 sample-and-hold circuit Select"]
...
#[doc = "Field `SHANS0` writer - AN100 sample-and-hold circuit Select"]
...
#[doc = "Field `SHANS1` reader - AN101 sample-and-hold circuit Select"]
...
#[doc = "Field `SHANS1` writer - AN101 sample-and-hold circuit Select"]
...
#[doc = "Field `SHANS2` reader - AN102 sample-and-hold circuit Select"]
...
#[doc = "Field `SHANS2` writer - AN102 sample-and-hold circuit Select"]
...
impl R {
    ...
    #[doc = "Bit 8 - AN100 sample-and-hold circuit Select"]
    #[inline(always)]
    pub fn shans0(&self) -> SHANS0_R {
        SHANS0_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - AN101 sample-and-hold circuit Select"]
    #[inline(always)]
    pub fn shans1(&self) -> SHANS1_R {
        SHANS1_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - AN102 sample-and-hold circuit Select"]
    #[inline(always)]
