...
pub enum GBADIE_A {
    #[doc = "0: Disables ADC12_GBADI1 interrupt generation upon group B scan completion."]
    _0 = 0,
    #[doc = "1: Enables ADC12_GBADI1 interrupt generation upon group B scan completion."]
    _1 = 1,
}
