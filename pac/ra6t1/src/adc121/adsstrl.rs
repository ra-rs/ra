...
#[doc = "Field `SST` reader - Sampling Time Setting (AN116-AN117)"]
pub type SST_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SST` writer - Sampling Time Setting (AN116-AN117)"]
pub type SST_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ADSSTRL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Sampling Time Setting (AN116-AN117)"]
    #[inline(always)]
