...
#[doc = "Field `MSPMPUSA` reader - Region Start Address : Address where the region starts, for use in region determination. NOTE: Range: 0x1FF00000-0x200FFFFC The low-order 2 bits are fixed to 0."]
pub type MSPMPUSA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MSPMPUSA` writer - Region Start Address : Address where the region starts, for use in region determination. NOTE: Range: 0x1FF00000-0x200FFFFC The low-order 2 bits are fixed to 0."]
pub type MSPMPUSA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MSPMPUSA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Region Start Address : Address where the region starts, for use in region determination. NOTE: Range: 0x1FF00000-0x200FFFFC The low-order 2 bits are fixed to 0."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mspmpusa(&mut self) -> MSPMPUSA_W<0> {
        MSPMPUSA_W::new(self)
    }
