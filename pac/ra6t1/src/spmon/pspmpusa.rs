...
#[doc = "Field `PSPMPUSA` reader - Region Start Address : Address where the region starts, for use in region determination. NOTE: Range: 0x1FF00000-0x200FFFFC The low-order 2 bits are fixed to 0."]
pub type PSPMPUSA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PSPMPUSA` writer - Region Start Address : Address where the region starts, for use in region determination. NOTE: Range: 0x1FF00000-0x200FFFFC The low-order 2 bits are fixed to 0."]
