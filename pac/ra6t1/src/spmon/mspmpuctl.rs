...
pub enum ENABLE_A {
    #[doc = "0: Disable stack pointer monitor"]
    _0 = 0,
    #[doc = "1: Enable stack pointer monitor"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ERROR_A {
    #[doc = "0: No stack pointer overflow or underflow occurred"]
    _0 = 0,
    #[doc = "1: Stack pointer overflow or underflow occurred"]
    _1 = 1,
}
