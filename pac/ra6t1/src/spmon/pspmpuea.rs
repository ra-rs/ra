...
#[doc = "Field `PSPMPUEA` reader - Region End Address : Address where the region ends, for use in region determination. NOTE: Range: 0x1FF00003-0x200FFFFF The low-order 2 bits are fixed to 1."]
pub type PSPMPUEA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PSPMPUEA` writer - Region End Address : Address where the region ends, for use in region determination. NOTE: Range: 0x1FF00003-0x200FFFFF The low-order 2 bits are fixed to 1."]
pub type PSPMPUEA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PSPMPUEA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Region End Address : Address where the region ends, for use in region determination. NOTE: Range: 0x1FF00003-0x200FFFFF The low-order 2 bits are fixed to 1."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pspmpuea(&mut self) -> PSPMPUEA_W<0> {
        PSPMPUEA_W::new(self)
    }
