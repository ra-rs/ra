...
#[doc = "Field `MPBT` reader - This bit should be 0 in smart card interface mode."]
pub type MPBT_R = crate::BitReader<bool>;
#[doc = "Field `MPBT` writer - This bit should be 0 in smart card interface mode."]
pub type MPBT_W<'a, const O: u8> = crate::BitWriter<'a, u8, SSR_SMCI_SPEC, bool, O>;
#[doc = "Field `MPB` reader - This bit should be 0 in smart card interface mode."]
...
impl R {
    #[doc = "Bit 0 - This bit should be 0 in smart card interface mode."]
    #[inline(always)]
    pub fn mpbt(&self) -> MPBT_R {
        MPBT_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - This bit should be 0 in smart card interface mode."]
    #[inline(always)]
