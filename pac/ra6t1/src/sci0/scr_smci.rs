...
#[doc = "Field `TEIE` reader - Transmit End Interrupt Enable Set this bit to 0 in smart card interface mode."]
pub type TEIE_R = crate::BitReader<bool>;
#[doc = "Field `TEIE` writer - Transmit End Interrupt Enable Set this bit to 0 in smart card interface mode."]
pub type TEIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, SCR_SMCI_SPEC, bool, O>;
#[doc = "Field `MPIE` reader - Multi-Processor Interrupt Enable Set this bit to 0 in smart card interface mode."]
pub type MPIE_R = crate::BitReader<bool>;
#[doc = "Field `MPIE` writer - Multi-Processor Interrupt Enable Set this bit to 0 in smart card interface mode."]
...
impl R {
    ...
    #[doc = "Bit 2 - Transmit End Interrupt Enable Set this bit to 0 in smart card interface mode."]
    #[inline(always)]
    pub fn teie(&self) -> TEIE_R {
        TEIE_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Multi-Processor Interrupt Enable Set this bit to 0 in smart card interface mode."]
    #[inline(always)]
