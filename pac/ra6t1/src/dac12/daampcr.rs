...
pub enum DAAMP0_A {
    #[doc = "0: Output amplifier of channel 0 is not used."]
    _0 = 0,
    #[doc = "1: Output amplifier of channel 0 is used."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DAAMP1_A {
    #[doc = "0: Output amplifier of channel 1 is not used."]
    _0 = 0,
    #[doc = "1: Output amplifier of channel 1 is used."]
    _1 = 1,
}
