...
pub enum SWREQ_A {
    #[doc = "0: Do not request DMA transfer"]
    _0 = 0,
    #[doc = "1: Request DMA transfer."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLRS_A {
    #[doc = "0: Clear SWREQ bit after DMA transfer is started by software"]
    _0 = 0,
    #[doc = "1: Do not clear SWREQ bit after DMA transfer is started by software"]
    _1 = 1,
}
