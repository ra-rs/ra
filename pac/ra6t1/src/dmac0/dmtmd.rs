...
pub enum DCTG_A {
    #[doc = "0: Software"]
    _00 = 0,
    #[doc = "1: Interrupts from peripheral modules or external interrupt input pins"]
    _01 = 1,
}
...
impl DCTG_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<DCTG_A> {
        match self.bits {
            0 => Some(DCTG_A::_00),
            1 => Some(DCTG_A::_01),
            _ => None,
...
pub type DCTG_W<'a, const O: u8> = crate::FieldWriter<'a, u16, DMTMD_SPEC, u8, DCTG_A, 2, O>;
...
#[repr(u8)]
pub enum DTS_A {
    #[doc = "0: Specify destination as the repeat area or block area"]
    _00 = 0,
    #[doc = "1: Specify source as the repeat area or block area"]
    _01 = 1,
    #[doc = "2: Do not specify repeat area or block area"]
    _10 = 2,
    #[doc = "3: Setting prohibited"]
    _11 = 3,
}
