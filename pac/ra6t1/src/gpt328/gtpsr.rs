...
pub enum PSGTRGAR_A {
    #[doc = "0: Disable counter stop on the rising edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTETRGA input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGAF_A {
    #[doc = "0: Disable counter stop on the falling edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTETRGA input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGBR_A {
    #[doc = "0: Disable counter stop on the rising edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTETRGB input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGBF_A {
    #[doc = "0: Disable counter stop on the falling edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTETRGB input"]
    _1 = 1,
}
...
#[doc = "Field `PSGTRGCR` reader - GTETRGC Pin Rising Input Source Counter Stop Enable"]
pub type PSGTRGCR_R = crate::BitReader<PSGTRGCR_A>;
#[doc = "GTETRGC Pin Rising Input Source Counter Stop Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGCR_A {
    #[doc = "0: Disable counter stop on the rising edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTETRGC input"]
    _1 = 1,
}
...
impl PSGTRGCR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PSGTRGCR_A {
        match self.bits {
            false => PSGTRGCR_A::_0,
            true => PSGTRGCR_A::_1,
        }
...
#[doc = "Field `PSGTRGCR` writer - GTETRGC Pin Rising Input Source Counter Stop Enable"]
pub type PSGTRGCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSGTRGCR_A, O>;
impl<'a, const O: u8> PSGTRGCR_W<'a, O> {
...
#[doc = "Field `PSGTRGCF` reader - GTETRGC Pin Falling Input Source Counter Stop Enable"]
pub type PSGTRGCF_R = crate::BitReader<PSGTRGCF_A>;
#[doc = "GTETRGC Pin Falling Input Source Counter Stop Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGCF_A {
    #[doc = "0: Disable counter stop on the falling edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTETRGC input"]
    _1 = 1,
}
...
impl PSGTRGCF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PSGTRGCF_A {
        match self.bits {
            false => PSGTRGCF_A::_0,
            true => PSGTRGCF_A::_1,
        }
...
#[doc = "Field `PSGTRGCF` writer - GTETRGC Pin Falling Input Source Counter Stop Enable"]
pub type PSGTRGCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSGTRGCF_A, O>;
impl<'a, const O: u8> PSGTRGCF_W<'a, O> {
...
#[doc = "Field `PSGTRGDR` reader - GTETRGD Pin Rising Input Source Counter Stop Enable"]
pub type PSGTRGDR_R = crate::BitReader<PSGTRGDR_A>;
#[doc = "GTETRGD Pin Rising Input Source Counter Stop Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGDR_A {
    #[doc = "0: Disable counter stop on the rising edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTETRGD input"]
    _1 = 1,
}
...
impl PSGTRGDR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PSGTRGDR_A {
        match self.bits {
            false => PSGTRGDR_A::_0,
            true => PSGTRGDR_A::_1,
        }
...
#[doc = "Field `PSGTRGDR` writer - GTETRGD Pin Rising Input Source Counter Stop Enable"]
pub type PSGTRGDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSGTRGDR_A, O>;
impl<'a, const O: u8> PSGTRGDR_W<'a, O> {
...
#[doc = "Field `PSGTRGDF` reader - GTETRGD Pin Falling Input Source Counter Stop Enable"]
pub type PSGTRGDF_R = crate::BitReader<PSGTRGDF_A>;
#[doc = "GTETRGD Pin Falling Input Source Counter Stop Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGDF_A {
    #[doc = "0: Disable counter stop on the falling edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTETRGD input"]
    _1 = 1,
}
...
impl PSGTRGDF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PSGTRGDF_A {
        match self.bits {
            false => PSGTRGDF_A::_0,
            true => PSGTRGDF_A::_1,
        }
...
#[doc = "Field `PSGTRGDF` writer - GTETRGD Pin Falling Input Source Counter Stop Enable"]
pub type PSGTRGDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSGTRGDF_A, O>;
impl<'a, const O: u8> PSGTRGDF_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCARBL_A {
    #[doc = "0: Disable counter stop on the rising edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTIOCA input when GTIOCB input is 0"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCARBH_A {
    #[doc = "0: Disable counter stop on the rising edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTIOCA input when GTIOCB input is 1"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCAFBL_A {
    #[doc = "0: Disable counter stop on the falling edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTIOCA input when GTIOCB input is 0"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCAFBH_A {
    #[doc = "0: Disable counter stop on the falling edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTIOCA input when GTIOCB input is 1"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBRAL_A {
    #[doc = "0: Disable counter stop on the rising edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTIOCB input when GTIOCA input is 0"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBRAH_A {
    #[doc = "0: Disable counter stop on the rising edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the rising edge of GTIOCB input when GTIOCA input is 1"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBFAL_A {
    #[doc = "0: Disable counter stop on the falling edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTIOCB input when GTIOCA input is 0"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBFAH_A {
    #[doc = "0: Disable counter stop on the falling edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter stop on the falling edge of GTIOCB input when GTIOCA input is 1"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCA_A {
    #[doc = "0: Disable counter stop on ELC_GPTA input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTA input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCB_A {
    #[doc = "0: Disable counter stop on ELC_GPTB input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTB input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCC_A {
    #[doc = "0: Disable counter stop on ELC_GPTC input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTC input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCD_A {
    #[doc = "0: Disable counter stop on ELC_GPTD input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTD input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCE_A {
    #[doc = "0: Disable counter stop on ELC_GPTE input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTE input"]
    _1 = 1,
}
...
pub type PSELCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSELCE_A, O>;
impl<'a, const O: u8> PSELCE_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCF_A {
    #[doc = "0: Disable counter stop on ELC_GPTF input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTF input"]
    _1 = 1,
}
...
pub type PSELCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSELCF_A, O>;
impl<'a, const O: u8> PSELCF_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCG_A {
    #[doc = "0: Disable counter stop on ELC_GPTG input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELC_GPTG input"]
    _1 = 1,
}
...
pub type PSELCG_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSELCG_A, O>;
impl<'a, const O: u8> PSELCG_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCH_A {
    #[doc = "0: Disable counter stop on ELC_GPTH input"]
    _0 = 0,
    #[doc = "1: Enable counter stop on ELCH event inpu"]
    _1 = 1,
}
...
pub type PSELCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTPSR_SPEC, PSELCH_A, O>;
impl<'a, const O: u8> PSELCH_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CSTOP_A {
    #[doc = "0: Disable counter stop by the GTSTP register"]
    _0 = 0,
    #[doc = "1: Enable counter stop by the GTSTP register"]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 4 - GTETRGC Pin Rising Input Source Counter Stop Enable"]
    #[inline(always)]
    pub fn psgtrgcr(&self) -> PSGTRGCR_R {
        PSGTRGCR_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - GTETRGC Pin Falling Input Source Counter Stop Enable"]
    #[inline(always)]
    pub fn psgtrgcf(&self) -> PSGTRGCF_R {
        PSGTRGCF_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - GTETRGD Pin Rising Input Source Counter Stop Enable"]
    #[inline(always)]
    pub fn psgtrgdr(&self) -> PSGTRGDR_R {
        PSGTRGDR_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - GTETRGD Pin Falling Input Source Counter Stop Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn psgtrgcr(&mut self) -> PSGTRGCR_W<4> {
        PSGTRGCR_W::new(self)
    }
    #[doc = "Bit 5 - GTETRGC Pin Falling Input Source Counter Stop Enable"]
    #[inline(always)]
    #[must_use]
    pub fn psgtrgcf(&mut self) -> PSGTRGCF_W<5> {
        PSGTRGCF_W::new(self)
    }
    #[doc = "Bit 6 - GTETRGD Pin Rising Input Source Counter Stop Enable"]
    #[inline(always)]
    #[must_use]
    pub fn psgtrgdr(&mut self) -> PSGTRGDR_W<6> {
        PSGTRGDR_W::new(self)
    }
    #[doc = "Bit 7 - GTETRGD Pin Falling Input Source Counter Stop Enable"]
    #[inline(always)]
    #[must_use]
    pub fn psgtrgdf(&mut self) -> PSGTRGDF_W<7> {
        PSGTRGDF_W::new(self)
    }
    #[doc = "Bit 8 - GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Stop Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pselce(&mut self) -> PSELCE_W<20> {
        PSELCE_W::new(self)
    }
    #[doc = "Bit 21 - ELC_GPTF Event Source Counter Stop Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pselcf(&mut self) -> PSELCF_W<21> {
        PSELCF_W::new(self)
    }
    #[doc = "Bit 22 - ELC_GPTG Event Source Counter Stop Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pselcg(&mut self) -> PSELCG_W<22> {
        PSELCG_W::new(self)
    }
    #[doc = "Bit 23 - ELC_GPTH Event Source Counter Stop Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pselch(&mut self) -> PSELCH_W<23> {
        PSELCH_W::new(self)
    }
    #[doc = "Bit 31 - Software Source Counter Stop Enable"]
    #[inline(always)]
