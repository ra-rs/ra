...
pub type CMPSTTSA_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ADCMPSER_SPEC, CMPSTTSA_A, O>;
...
pub type CMPSTOCA_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ADCMPSER_SPEC, CMPSTOCA_A, O>;
