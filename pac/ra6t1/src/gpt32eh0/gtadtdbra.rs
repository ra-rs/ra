...
#[doc = "Field `GTADTDBRA` reader - A/D Converter Start Request Timing Double-Buffer Register A"]
pub type GTADTDBRA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `GTADTDBRA` writer - A/D Converter Start Request Timing Double-Buffer Register A"]
pub type GTADTDBRA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GTADTDBRA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A/D Converter Start Request Timing Double-Buffer Register A"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gtadtdbra(&mut self) -> GTADTDBRA_W<0> {
        GTADTDBRA_W::new(self)
    }
