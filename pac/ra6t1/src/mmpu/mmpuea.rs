...
#[doc = "Field `MMPUEA` reader - Region End Address : Address where the region end, for use in region determination. NOTE: The low-order 2 bits are fixed to 1."]
pub type MMPUEA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MMPUEA` writer - Region End Address : Address where the region end, for use in region determination. NOTE: The low-order 2 bits are fixed to 1."]
pub type MMPUEA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MMPUEA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Region End Address : Address where the region end, for use in region determination. NOTE: The low-order 2 bits are fixed to 1."]
    #[inline(always)]
