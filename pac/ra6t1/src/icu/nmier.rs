...
pub enum IWDTEN_A {
    #[doc = "0: IWDT underflow/refresh error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: IWDT underflow/refresh error interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WDTEN_A {
    #[doc = "0: WDT underflow/refresh error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: WDT underflow/refresh error interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LVD1EN_A {
    #[doc = "0: Voltage-monitoring 1 interrupt is disabled."]
    _0 = 0,
    #[doc = "1: Voltage-monitoring 1 interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LVD2EN_A {
    #[doc = "0: Voltage-monitoring 2 interrupt is disabled."]
    _0 = 0,
    #[doc = "1: Voltage-monitoring 2 interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OSTEN_A {
    #[doc = "0: Oscillation stop detection interrupt is disabled."]
    _0 = 0,
    #[doc = "1: Oscillation stop detection interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NMIEN_A {
    #[doc = "0: NMI pin interrupt is disabled."]
    _0 = 0,
    #[doc = "1: NMI pin interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RPEEN_A {
    #[doc = "0: RAM Parity Error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: RAM Parity Error interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RECCEN_A {
    #[doc = "0: RAM ECC Error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: RAM ECC Error interrupt is enabled."]
    _1 = 1,
}
...
pub type RECCEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, NMIER_SPEC, RECCEN_A, O>;
impl<'a, const O: u8> RECCEN_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BUSSEN_A {
    #[doc = "0: MPU Bus Slave Error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: MPU Bus Slave Error interrupt is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BUSMEN_A {
    #[doc = "0: MPU Bus Master Error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: MPU Bus Master Error interrupt is enabled."]
    _1 = 1,
}
...
#[doc = "Field `SPEEN` reader - MPU Stack Error Interrupt Enable"]
pub type SPEEN_R = crate::BitReader<SPEEN_A>;
#[doc = "MPU Stack Error Interrupt Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPEEN_A {
    #[doc = "0: MPU Stack Error interrupt is disabled."]
    _0 = 0,
    #[doc = "1: MPU Stack Error interrupt is enabled."]
    _1 = 1,
}
...
#[doc = "Field `SPEEN` writer - MPU Stack Error Interrupt Enable"]
...
impl R {
    ...
    #[doc = "Bit 12 - MPU Stack Error Interrupt Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reccen(&mut self) -> RECCEN_W<9> {
        RECCEN_W::new(self)
    }
    #[doc = "Bit 10 - MPU Bus Slave Error Interrupt Enable"]
    #[inline(always)]
