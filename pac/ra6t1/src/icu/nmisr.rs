...
pub enum IWDTST_A {
    #[doc = "0: IWDT underflow/refresh error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: IWDT underflow/refresh error interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WDTST_A {
    #[doc = "0: WDT underflow/refresh error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: WDT underflow/refresh error interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LVD1ST_A {
    #[doc = "0: Voltage-monitoring 1 interrupt is not requested."]
    _0 = 0,
    #[doc = "1: Voltage-monitoring 1 interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LVD2ST_A {
    #[doc = "0: Voltage-monitoring 2 interrupt is not requested."]
    _0 = 0,
    #[doc = "1: Voltage-monitoring 2 interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OSTST_A {
    #[doc = "0: Oscillation stop detection interrupt is not requested."]
    _0 = 0,
    #[doc = "1: Oscillation stop detection interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NMIST_A {
    #[doc = "0: NMI pin interrupt is not requested."]
    _0 = 0,
    #[doc = "1: NMI pin interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RPEST_A {
    #[doc = "0: RAM Parity Error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: RAM Parity Error interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RECCST_A {
    #[doc = "0: RAM ECC Error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: RAM ECC Error interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BUSSST_A {
    #[doc = "0: MPU Bus Slave Error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: MPU Bus Slave Error interrupt is requested."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BUSMST_A {
    #[doc = "0: MPU Bus Master Error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: MPU Bus Master Error interrupt is requested."]
    _1 = 1,
}
...
#[doc = "Field `SPEST` reader - MPU Stack Error Interrupt Status Flag"]
pub type SPEST_R = crate::BitReader<SPEST_A>;
#[doc = "MPU Stack Error Interrupt Status Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPEST_A {
    #[doc = "0: MPU Stack Error interrupt is not requested."]
    _0 = 0,
    #[doc = "1: MPU Stack Error interrupt is requested."]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 12 - MPU Stack Error Interrupt Status Flag"]
    #[inline(always)]
