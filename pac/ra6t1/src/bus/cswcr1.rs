...
#[doc = "Field `CSPWWAIT` reader - Page Write Cycle Wait Select NOTE: The CSPWWAIT value is valid only when the PWENB bit in CSnMOD is set to 1."]
pub type CSPWWAIT_R = crate::FieldReader<u8, CSPWWAIT_A>;
#[doc = "Page Write Cycle Wait Select NOTE: The CSPWWAIT value is valid only when the PWENB bit in CSnMOD is set to 1.\n\nValue on reset: 7"]
...
#[doc = "Field `CSPWWAIT` writer - Page Write Cycle Wait Select NOTE: The CSPWWAIT value is valid only when the PWENB bit in CSnMOD is set to 1."]
...
#[doc = "Field `CSPRWAIT` reader - Page Read Cycle Wait Select NOTE: The CSPRWAIT value is valid only when the PRENB bit in CSnMOD is set to 1."]
pub type CSPRWAIT_R = crate::FieldReader<u8, CSPRWAIT_A>;
#[doc = "Page Read Cycle Wait Select NOTE: The CSPRWAIT value is valid only when the PRENB bit in CSnMOD is set to 1.\n\nValue on reset: 7"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CSPRWAIT_A {
    #[doc = "0: No wait is inserted."]
...
#[doc = "Field `CSPRWAIT` writer - Page Read Cycle Wait Select NOTE: The CSPRWAIT value is valid only when the PRENB bit in CSnMOD is set to 1."]
...
impl R {
    #[doc = "Bits 0:2 - Page Write Cycle Wait Select NOTE: The CSPWWAIT value is valid only when the PWENB bit in CSnMOD is set to 1."]
    #[inline(always)]
    pub fn cspwwait(&self) -> CSPWWAIT_R {
        CSPWWAIT_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 8:10 - Page Read Cycle Wait Select NOTE: The CSPRWAIT value is valid only when the PRENB bit in CSnMOD is set to 1."]
    #[inline(always)]
