...
#[doc = "Field `FLLCNTL` reader - FLL Multiplication ControlMultiplication ratio of the FLL reference clock select"]
pub type FLLCNTL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FLLCNTL` writer - FLL Multiplication ControlMultiplication ratio of the FLL reference clock select"]
pub type FLLCNTL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, FLLCR2_SPEC, u16, u16, 11, O>;
impl R {
    #[doc = "Bits 0:10 - FLL Multiplication ControlMultiplication ratio of the FLL reference clock select"]
    #[inline(always)]
