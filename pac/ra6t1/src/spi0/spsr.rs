...
pub type OVRF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SPSR_SPEC, OVRF_A, O>;
...
pub type MODF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SPSR_SPEC, MODF_A, O>;
...
pub type PERF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SPSR_SPEC, PERF_A, O>;
...
pub type UDRF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SPSR_SPEC, UDRF_A, O>;
...
pub type SPTEF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SPSR_SPEC, SPTEF_A, O>;
...
pub type SPRF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, SPSR_SPEC, SPRF_A, O>;
