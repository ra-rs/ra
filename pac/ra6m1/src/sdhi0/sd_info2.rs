...
#[doc = "Field `SDD0MON` reader - SDDAT0 Indicates the SDDAT0 state of the port specified by SD_PORTSEL."]
pub type SDD0MON_R = crate::BitReader<SDD0MON_A>;
#[doc = "SDDAT0 Indicates the SDDAT0 state of the port specified by SD_PORTSEL.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDD0MON_A {
...
impl R {
    ...
    #[doc = "Bit 7 - SDDAT0 Indicates the SDDAT0 state of the port specified by SD_PORTSEL."]
    #[inline(always)]
