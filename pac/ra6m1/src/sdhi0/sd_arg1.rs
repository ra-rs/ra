...
#[doc = "Field `SD_ARG1` reader - Argument Register 1 Set command format\\[39:24\\]
(argument)"]
pub type SD_ARG1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SD_ARG1` writer - Argument Register 1 Set command format\\[39:24\\]
(argument)"]
pub type SD_ARG1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SD_ARG1_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Argument Register 1 Set command format\\[39:24\\]
(argument)"]
    #[inline(always)]
