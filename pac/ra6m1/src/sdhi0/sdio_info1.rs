...
#[doc = "Field `EXPUB52` reader - EXPUB52 Status Flag NOTE: See manual\n\nThe field is **modified** in some way after a read operation."]
pub type EXPUB52_R = crate::BitReader<bool>;
#[doc = "Field `EXPUB52` writer - EXPUB52 Status Flag NOTE: See manual"]
pub type EXPUB52_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, SDIO_INFO1_SPEC, bool, O>;
#[doc = "Field `EXWT` reader - EXWT Status Flag NOTE: See manual\n\nThe field is **modified** in some way after a read operation."]
pub type EXWT_R = crate::BitReader<bool>;
#[doc = "Field `EXWT` writer - EXWT Status Flag NOTE: See manual"]
...
impl R {
    ...
    #[doc = "Bit 14 - EXPUB52 Status Flag NOTE: See manual"]
    #[inline(always)]
    pub fn expub52(&self) -> EXPUB52_R {
        EXPUB52_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - EXWT Status Flag NOTE: See manual"]
    #[inline(always)]
