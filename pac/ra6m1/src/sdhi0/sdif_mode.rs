...
#[doc = "Field `NOCHKCR` reader - CRC Check Mask (for MMC test commands)"]
pub type NOCHKCR_R = crate::BitReader<NOCHKCR_A>;
#[doc = "CRC Check Mask (for MMC test commands)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NOCHKCR_A {
    #[doc = "0: CRC check is valid"]
    _0 = 0,
    #[doc = "1: CRC check is invalid(CRC16 value is ignored when read and CRC Status value is ignored when write)"]
    _1 = 1,
}
...
#[doc = "Field `NOCHKCR` writer - CRC Check Mask (for MMC test commands)"]
...
impl R {
    #[doc = "Bit 8 - CRC Check Mask (for MMC test commands)"]
    #[inline(always)]
