...
#[doc = "Field `SD_SECCNT` reader - Number of Transfer Blocks NOTE: Do not change the value of this bit when the CBSY bit in SD_INFO2 is set to 1."]
pub type SD_SECCNT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SD_SECCNT` writer - Number of Transfer Blocks NOTE: Do not change the value of this bit when the CBSY bit in SD_INFO2 is set to 1."]
pub type SD_SECCNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SD_SECCNT_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Number of Transfer Blocks NOTE: Do not change the value of this bit when the CBSY bit in SD_INFO2 is set to 1."]
    #[inline(always)]
