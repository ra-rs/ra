...
#[doc = "Field `TOUTMASK` reader - Timeout MASK When timeout occurs in case of inactivating timeout, software reset should be executed to terminate command sequence."]
pub type TOUTMASK_R = crate::BitReader<TOUTMASK_A>;
#[doc = "Timeout MASK When timeout occurs in case of inactivating timeout, software reset should be executed to terminate command sequence.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TOUTMASK_A {
...
#[doc = "Field `TOUTMASK` writer - Timeout MASK When timeout occurs in case of inactivating timeout, software reset should be executed to terminate command sequence."]
...
#[doc = "Field `WIDTH8` reader - Bus Width see b15, WIDTH bit"]
pub type WIDTH8_R = crate::BitReader<bool>;
#[doc = "Field `WIDTH8` writer - Bus Width see b15, WIDTH bit"]
pub type WIDTH8_W<'a, const O: u8> = crate::BitWriter<'a, u32, SD_OPTION_SPEC, bool, O>;
#[doc = "Field `WIDTH` reader - Bus Width NOTE: The initial value is applied at a reset and when the SOFT_RST.SDRST flag is 0."]
pub type WIDTH_R = crate::BitReader<WIDTH_A>;
#[doc = "Bus Width NOTE: The initial value is applied at a reset and when the SOFT_RST.SDRST flag is 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WIDTH_A {
    #[doc = "0: 4-bit width (WIDTH8=0) / Setting prohibited (WIDTH8=1)"]
    _0 = 0,
...
#[doc = "Field `WIDTH` writer - Bus Width NOTE: The initial value is applied at a reset and when the SOFT_RST.SDRST flag is 0."]
...
impl R {
    ...
    #[doc = "Bit 8 - Timeout MASK When timeout occurs in case of inactivating timeout, software reset should be executed to terminate command sequence."]
    #[inline(always)]
    pub fn toutmask(&self) -> TOUTMASK_R {
        TOUTMASK_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 13 - Bus Width see b15, WIDTH bit"]
    #[inline(always)]
    pub fn width8(&self) -> WIDTH8_R {
        WIDTH8_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 15 - Bus Width NOTE: The initial value is applied at a reset and when the SOFT_RST.SDRST flag is 0."]
    #[inline(always)]
