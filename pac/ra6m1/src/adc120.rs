...
pub struct RegisterBlock {
    ...
    pub adsstro: ADSSTRO,
    #[doc = "0xe0 - A/D Sampling State Register %s (Corresponding Channel is AN00%s )"]
    pub adsstr0: [ADSSTR0; 4],
    _reserved48: [u8; 0x01],
    #[doc = "0xe5 - A/D Sampling State Register %s (Corresponding Channel is AN00%s )"]
    pub adsstr05: ADSSTR05,
    #[doc = "0xe6 - A/D Sampling State Register %s (Corresponding Channel is AN00%s )"]
    pub adsstr06: ADSSTR05,
    #[doc = "0xe7 - A/D Sampling State Register %s (Corresponding Channel is AN00%s )"]
