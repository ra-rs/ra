...
#[doc = "Field `CNTVAL` reader - Down-Counter ValueValue counted by the down-counter"]
...
pub type UNDFF_W<'a, const O: u8> = crate::BitWriter0C<'a, u16, WDTSR_SPEC, UNDFF_A, O>;
...
pub type REFEF_W<'a, const O: u8> = crate::BitWriter0C<'a, u16, WDTSR_SPEC, REFEF_A, O>;
...
impl R {
    #[doc = "Bits 0:13 - Down-Counter ValueValue counted by the down-counter"]
    #[inline(always)]
