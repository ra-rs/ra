...
pub enum WP_A {
    #[doc = "0: Enable writes to the register"]
    _0 = 0,
    #[doc = "1: Disable writes to the register"]
    _1 = 1,
}
...
pub type PRKEY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTWP_SPEC, u8, PRKEY_AW, 8, O>;
