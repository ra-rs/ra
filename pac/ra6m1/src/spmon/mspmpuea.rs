...
#[doc = "Field `MSPMPUEA` reader - Region End Address : Address where the region ends, for use in region determination. NOTE: Range: 0x1FF00003-0x200FFFFF The low-order 2 bits are fixed to 1."]
pub type MSPMPUEA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MSPMPUEA` writer - Region End Address : Address where the region ends, for use in region determination. NOTE: Range: 0x1FF00003-0x200FFFFF The low-order 2 bits are fixed to 1."]
