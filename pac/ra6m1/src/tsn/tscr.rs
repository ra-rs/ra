...
#[doc = "Field `TSOE` reader - Temperature Sensor Enable"]
pub type TSOE_R = crate::BitReader<TSOE_A>;
#[doc = "Temperature Sensor Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TSOE_A {
    #[doc = "0: Disables output from the temperature sensor to the 12-bit A/D converter."]
    _0 = 0,
    #[doc = "1: Enables output from the temperature sensor to the 12-bit A/D converter."]
    _1 = 1,
}
...
#[doc = "Field `TSOE` writer - Temperature Sensor Enable"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TSEN_A {
    #[doc = "0: Stops the temperature sensor."]
    _0 = 0,
    #[doc = "1: Starts the temperature sensor."]
    _1 = 1,
}
...
impl R {
    #[doc = "Bit 4 - Temperature Sensor Enable"]
    #[inline(always)]
    pub fn tsoe(&self) -> TSOE_R {
        TSOE_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 7 - Temperature Sensor Output Enable"]
    #[inline(always)]
