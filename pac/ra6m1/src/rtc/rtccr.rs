...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TCEN_A {
    #[doc = "0: The RTCICn pin is disabled as the time capture event input."]
    _0 = 0,
    #[doc = "1: The RTCICn pin is enabled as the time capture event input."]
    _1 = 1,
}
...
pub type TCEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCCR_SPEC, TCEN_A, O>;
