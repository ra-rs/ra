...
pub enum SSGTRGAR_A {
    #[doc = "0: Disable counter start on the rising edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTETRGA input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGAF_A {
    #[doc = "0: Disable counter start on the falling edge of GTETRGA input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTETRGA input"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGBR_A {
    #[doc = "0: Disable counter start on the rising edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTETRGB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGBF_A {
    #[doc = "0: Disable counter start on the falling edge of GTETRGB input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTETRGB input"]
    _1 = 1,
}
...
#[doc = "Field `SSGTRGCR` reader - GTETRGC Pin Rising Input Source Counter Start Enable"]
pub type SSGTRGCR_R = crate::BitReader<SSGTRGCR_A>;
#[doc = "GTETRGC Pin Rising Input Source Counter Start Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGCR_A {
    #[doc = "0: Disable counter start on the rising edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTETRGC input"]
    _1 = 1,
}
...
impl SSGTRGCR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SSGTRGCR_A {
        match self.bits {
            false => SSGTRGCR_A::_0,
            true => SSGTRGCR_A::_1,
        }
...
#[doc = "Field `SSGTRGCR` writer - GTETRGC Pin Rising Input Source Counter Start Enable"]
pub type SSGTRGCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSGTRGCR_A, O>;
impl<'a, const O: u8> SSGTRGCR_W<'a, O> {
...
#[doc = "Field `SSGTRGCF` reader - GTETRGC Pin Falling Input Source Counter Start Enable"]
pub type SSGTRGCF_R = crate::BitReader<SSGTRGCF_A>;
#[doc = "GTETRGC Pin Falling Input Source Counter Start Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGCF_A {
    #[doc = "0: Disable counter start on the falling edge of GTETRGC input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTETRGC input"]
    _1 = 1,
}
...
impl SSGTRGCF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SSGTRGCF_A {
        match self.bits {
            false => SSGTRGCF_A::_0,
            true => SSGTRGCF_A::_1,
        }
...
#[doc = "Field `SSGTRGCF` writer - GTETRGC Pin Falling Input Source Counter Start Enable"]
pub type SSGTRGCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSGTRGCF_A, O>;
impl<'a, const O: u8> SSGTRGCF_W<'a, O> {
...
#[doc = "Field `SSGTRGDR` reader - GTETRGD Pin Rising Input Source Counter Start Enable"]
pub type SSGTRGDR_R = crate::BitReader<SSGTRGDR_A>;
#[doc = "GTETRGD Pin Rising Input Source Counter Start Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGDR_A {
    #[doc = "0: Disable counter start on the rising edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTETRGD input"]
    _1 = 1,
}
...
impl SSGTRGDR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SSGTRGDR_A {
        match self.bits {
            false => SSGTRGDR_A::_0,
            true => SSGTRGDR_A::_1,
        }
...
#[doc = "Field `SSGTRGDR` writer - GTETRGD Pin Rising Input Source Counter Start Enable"]
pub type SSGTRGDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSGTRGDR_A, O>;
impl<'a, const O: u8> SSGTRGDR_W<'a, O> {
...
#[doc = "Field `SSGTRGDF` reader - GTETRGD Pin Falling Input Source Counter Start Enable"]
pub type SSGTRGDF_R = crate::BitReader<SSGTRGDF_A>;
#[doc = "GTETRGD Pin Falling Input Source Counter Start Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGDF_A {
    #[doc = "0: Disable counter start on the falling edge of GTETRGD input"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTETRGD input."]
    _1 = 1,
}
...
impl SSGTRGDF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SSGTRGDF_A {
        match self.bits {
            false => SSGTRGDF_A::_0,
            true => SSGTRGDF_A::_1,
        }
...
#[doc = "Field `SSGTRGDF` writer - GTETRGD Pin Falling Input Source Counter Start Enable"]
pub type SSGTRGDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSGTRGDF_A, O>;
impl<'a, const O: u8> SSGTRGDF_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCARBL_A {
    #[doc = "0: Disable counter start on the rising edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTIOCA input when GTIOCB input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCARBH_A {
    #[doc = "0: Disable counter start on the rising edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTIOCA input when GTIOCB input is 1"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCAFBL_A {
    #[doc = "0: Disable counter start on the falling edge of GTIOCA input when GTIOCB input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTIOCA input when GTIOCB input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCAFBH_A {
    #[doc = "0: Disable counter start on the falling edge of GTIOCA input when GTIOCB input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTIOCA input when GTIOCB input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBRAL_A {
    #[doc = "0: Disable counter start on the rising edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTIOCB input when GTIOCA input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBRAH_A {
    #[doc = "0: Disable counter start on the rising edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter start on the rising edge of GTIOCB input when GTIOCA input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBFAL_A {
    #[doc = "0: Disable counter start on the falling edge of GTIOCB input when GTIOCA input is 0"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTIOCB input when GTIOCA input is 0."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBFAH_A {
    #[doc = "0: Disable counter start on the falling edge of GTIOCB input when GTIOCA input is 1"]
    _0 = 0,
    #[doc = "1: Enable counter start on the falling edge of GTIOCB input when GTIOCA input is 1."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCA_A {
    #[doc = "0: Disable counter start on ELC_GPTA input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTA input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCB_A {
    #[doc = "0: Disable counter start on ELC_GPTB input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTB input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCC_A {
    #[doc = "0: Disable counter start on ELC_GPTC input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTC input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCD_A {
    #[doc = "0: Disable counter start on ELC_GPTD input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTD input."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCE_A {
    #[doc = "0: Disable counter start on ELC_GPTE input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTE input"]
    _1 = 1,
}
...
pub type SSELCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSELCE_A, O>;
impl<'a, const O: u8> SSELCE_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCF_A {
    #[doc = "0: Disable counter start on ELC_GPTF input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTF input"]
    _1 = 1,
}
...
pub type SSELCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSELCF_A, O>;
impl<'a, const O: u8> SSELCF_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCG_A {
    #[doc = "0: Disable counter start on ELC_GPTG input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTG input."]
    _1 = 1,
}
...
pub type SSELCG_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSELCG_A, O>;
impl<'a, const O: u8> SSELCG_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCH_A {
    #[doc = "0: Disable counter start on ELC_GPTH input"]
    _0 = 0,
    #[doc = "1: Enable counter start on ELC_GPTH input."]
    _1 = 1,
}
...
pub type SSELCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTSSR_SPEC, SSELCH_A, O>;
impl<'a, const O: u8> SSELCH_W<'a, O> {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CSTRT_A {
    #[doc = "0: Disable counter start by the GTSTR register"]
    _0 = 0,
    #[doc = "1: Enable counter start by the GTSTR register"]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bit 4 - GTETRGC Pin Rising Input Source Counter Start Enable"]
    #[inline(always)]
    pub fn ssgtrgcr(&self) -> SSGTRGCR_R {
        SSGTRGCR_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - GTETRGC Pin Falling Input Source Counter Start Enable"]
    #[inline(always)]
    pub fn ssgtrgcf(&self) -> SSGTRGCF_R {
        SSGTRGCF_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - GTETRGD Pin Rising Input Source Counter Start Enable"]
    #[inline(always)]
    pub fn ssgtrgdr(&self) -> SSGTRGDR_R {
        SSGTRGDR_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - GTETRGD Pin Falling Input Source Counter Start Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssgtrgcr(&mut self) -> SSGTRGCR_W<4> {
        SSGTRGCR_W::new(self)
    }
    #[doc = "Bit 5 - GTETRGC Pin Falling Input Source Counter Start Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ssgtrgcf(&mut self) -> SSGTRGCF_W<5> {
        SSGTRGCF_W::new(self)
    }
    #[doc = "Bit 6 - GTETRGD Pin Rising Input Source Counter Start Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ssgtrgdr(&mut self) -> SSGTRGDR_W<6> {
        SSGTRGDR_W::new(self)
    }
    #[doc = "Bit 7 - GTETRGD Pin Falling Input Source Counter Start Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ssgtrgdf(&mut self) -> SSGTRGDF_W<7> {
        SSGTRGDF_W::new(self)
    }
    #[doc = "Bit 8 - GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Start Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sselce(&mut self) -> SSELCE_W<20> {
        SSELCE_W::new(self)
    }
    #[doc = "Bit 21 - ELC_GPTF Event Source Counter Start Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sselcf(&mut self) -> SSELCF_W<21> {
        SSELCF_W::new(self)
    }
    #[doc = "Bit 22 - ELC_GPTG Event Source Counter Start Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sselcg(&mut self) -> SSELCG_W<22> {
        SSELCG_W::new(self)
    }
    #[doc = "Bit 23 - ELC_GPTH Event Source Counter Start Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sselch(&mut self) -> SSELCH_W<23> {
        SSELCH_W::new(self)
    }
    #[doc = "Bit 31 - Software Source Counter Start Enable"]
    #[inline(always)]
