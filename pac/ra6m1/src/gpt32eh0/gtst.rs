...
#[doc = "Field `ITCNT` reader - GTCIV/GTCIU Interrupt Skipping Count Counter(Counter for counting the number of times a timer interrupt has been skipped.)"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TUCF_A {
    #[doc = "0: GTCNT counter is counting down"]
    _0 = 0,
    #[doc = "1: GTCNT counter is counting up."]
    _1 = 1,
}
...
impl R {
    ...
    #[doc = "Bits 8:10 - GTCIV/GTCIU Interrupt Skipping Count Counter(Counter for counting the number of times a timer interrupt has been skipped.)"]
    #[inline(always)]
