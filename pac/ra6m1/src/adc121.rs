...
pub struct RegisterBlock {
    ...
    pub adrd: ADRD,
    #[doc = "0x20..0x26 - A/D Data Register %s"]
    pub addr: [ADDR; 3],
    _reserved16: [u8; 0x04],
    #[doc = "0x2a - A/D Data Register %s"]
    pub addr5: ADDR5,
    #[doc = "0x2c - A/D Data Register %s"]
    pub addr6: ADDR5,
    #[doc = "0x2e - A/D Data Register %s"]
    pub addr7: ADDR5,
    _reserved19: [u8; 0x10],
    ...
    pub adsstro: ADSSTRO,
    #[doc = "0xe0 - A/D Sampling State Register %s (Corresponding Channel is AN10%s )"]
    pub adsstr0: [ADSSTR0; 3],
    _reserved49: [u8; 0x02],
    #[doc = "0xe5 - A/D Sampling State Register %s (Corresponding Channel is AN10%s )"]
    pub adsstr05: ADSSTR05,
    #[doc = "0xe6 - A/D Sampling State Register %s (Corresponding Channel is AN10%s )"]
    pub adsstr06: ADSSTR05,
    #[doc = "0xe7 - A/D Sampling State Register %s (Corresponding Channel is AN10%s )"]
