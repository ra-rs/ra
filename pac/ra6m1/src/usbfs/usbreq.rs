...
#[doc = "Field `BMREQUESTTYPE` writer - Request TypeThese bits store the USB request bmRequestType value."]
...
#[doc = "Field `BREQUEST` writer - RequestThese bits store the USB request bRequest value."]
