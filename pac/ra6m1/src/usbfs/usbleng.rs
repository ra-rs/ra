...
#[doc = "Field `WLENGTUH` writer - LengthThese bits store the USB request wLength value."]
pub type WLENGTUH_W<'a, const O: u8> = crate::FieldWriter<'a, u16, USBLENG_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wlengtuh(&mut self) -> WLENGTUH_W<0> {
        WLENGTUH_W::new(self)
    }
