...
#[doc = "Field `CMPSTB` reader - Compare window B flag. It is a status flag that shows the comparative result of CH (AN100-AN102, AN105-AN107, AN116-AN117, temperature sensor, and internal reference voltage) made the object of window B relation condition.\n\nThe field is **modified** in some way after a read operation."]
pub type CMPSTB_R = crate::BitReader<CMPSTB_A>;
#[doc = "Compare window B flag. It is a status flag that shows the comparative result of CH (AN100-AN102, AN105-AN107, AN116-AN117, temperature sensor, and internal reference voltage) made the object of window B relation condition.\n\nValue on reset: 0"]
...
#[doc = "Field `CMPSTB` writer - Compare window B flag. It is a status flag that shows the comparative result of CH (AN100-AN102, AN105-AN107, AN116-AN117, temperature sensor, and internal reference voltage) made the object of window B relation condition."]
...
impl R {
    #[doc = "Bit 0 - Compare window B flag. It is a status flag that shows the comparative result of CH (AN100-AN102, AN105-AN107, AN116-AN117, temperature sensor, and internal reference voltage) made the object of window B relation condition."]
    #[inline(always)]
