...
#[doc = "Field `CMPCHA06` reader - Compare Window A Channel AN106 Select"]
pub type CMPCHA06_R = crate::BitReader<CMPCHA06_A>;
#[doc = "Compare Window A Channel AN106 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA06_A {
    #[doc = "0: Disable compare function for AN106"]
    _0 = 0,
    #[doc = "1: Enable compare function for AN106"]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA06` writer - Compare Window A Channel AN106 Select"]
...
#[doc = "Field `CMPCHA07` reader - Compare Window A Channel AN107 Select"]
pub type CMPCHA07_R = crate::BitReader<CMPCHA07_A>;
#[doc = "Compare Window A Channel AN107 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA07_A {
    #[doc = "0: Disable compare function for AN107"]
    _0 = 0,
    #[doc = "1: Enable compare function for AN107"]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA07` writer - Compare Window A Channel AN107 Select"]
...
impl R {
    ...
    #[doc = "Bit 6 - Compare Window A Channel AN106 Select"]
    #[inline(always)]
    pub fn cmpcha06(&self) -> CMPCHA06_R {
        CMPCHA06_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Compare Window A Channel AN107 Select"]
    #[inline(always)]
