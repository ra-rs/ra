...
#[doc = "Field `IELS` reader - Event selection to NVIC"]
pub type IELS_R = crate::FieldReader<u16, IELS_A>;
...
#[doc = "Field `IELS` writer - Event selection to NVIC"]
pub type IELS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IELSR_SPEC, u16, IELS_A, 9, O>;
...
pub type IR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IELSR_SPEC, IR_A, O>;
...
pub type DTCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IELSR_SPEC, DTCE_A, O>;
...
impl R {
    #[doc = "Bits 0:8 - Event selection to NVIC"]
    #[inline(always)]
