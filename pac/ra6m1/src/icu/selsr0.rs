...
pub type SELS_R = crate::FieldReader<u16, SELS_A>;
...
impl SELS_R {
    ...
    pub fn variant(&self) -> Option<SELS_A> {
        match self.bits {
            0 => Some(SELS_A::_000000000),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `_000000000`"]
    #[inline(always)]
...
pub type SELS_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SELSR0_SPEC, u16, SELS_A, 9, O>;
impl<'a, const O: u8> SELS_W<'a, O> {
    #[doc = "Disable event output to the associated low-power mode module"]
    #[inline(always)]
    pub fn _000000000(self) -> &'a mut W {
        self.variant(SELS_A::_000000000)
    }
}
impl R {
    #[doc = "Bits 0:8 - SYS Event Link Select"]
    #[inline(always)]
