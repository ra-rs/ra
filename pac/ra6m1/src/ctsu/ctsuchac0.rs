...
#[doc = "Field `CTSUCHAC0` reader - CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: Bit 1 corresponds to TS01 and Bit 7 corresponds to TS07."]
pub type CTSUCHAC0_R = crate::BitReader<CTSUCHAC0_A>;
#[doc = "CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: Bit 1 corresponds to TS01 and Bit 7 corresponds to TS07.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct CTSUCHAC0_A(bool);
impl From<CTSUCHAC0_A> for bool {
    #[inline(always)]
    fn from(val: CTSUCHAC0_A) -> Self {
        val.0 as u8 != 0
    }
}
#[doc = "Field `CTSUCHAC0` writer - CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: Bit 1 corresponds to TS01 and Bit 7 corresponds to TS07."]
pub type CTSUCHAC0_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTSUCHAC0_SPEC, CTSUCHAC0_A, O>;
impl R {
    #[doc = "Bit 7 - CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: Bit 1 corresponds to TS01 and Bit 7 corresponds to TS07."]
    #[inline(always)]
    pub fn ctsuchac0(&self) -> CTSUCHAC0_R {
        CTSUCHAC0_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: Bit 1 corresponds to TS01 and Bit 7 corresponds to TS07."]
    #[inline(always)]
    #[must_use]
    pub fn ctsuchac0(&mut self) -> CTSUCHAC0_W<7> {
