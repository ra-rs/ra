...
#[repr(u8)]
pub enum FLWE_A {
    #[doc = "0: Prohibits programming and erasure of the code flash, data flash or blank checking."]
    _00 = 0,
    #[doc = "1: Permits programming and erasure of the code flash, data flash or blank checking."]
    _01 = 1,
    #[doc = "2: Prohibits programming and erasure of the code flash, data flash or blank checking."]
    _10 = 2,
    #[doc = "3: Prohibits programming and erasure of the code flash, data flash or blank checking."]
    _11 = 3,
}
