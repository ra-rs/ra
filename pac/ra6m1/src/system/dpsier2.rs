...
#[doc = "Field `DTRTCIIE` reader - RTC Interval interrupt Deep Standby Cancel Signal Enable"]
...
impl DTRTCIIE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DTRTCIIE_A {
        match self.bits {
            false => DTRTCIIE_A::_0,
            true => DTRTCIIE_A::_1,
        }
...
#[doc = "Field `DTRTCIIE` writer - RTC Interval interrupt Deep Standby Cancel Signal Enable"]
pub type DTRTCIIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, DPSIER2_SPEC, DTRTCIIE_A, O>;
impl<'a, const O: u8> DTRTCIIE_W<'a, O> {
    #[doc = "Canceling deep software standby mode is disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrtciie(&mut self) -> DTRTCIIE_W<2> {
        DTRTCIIE_W::new(self)
    }
    #[doc = "Bit 3 - RTC Alarm interrupt Deep Standby Cancel Signal Enable"]
    #[inline(always)]
