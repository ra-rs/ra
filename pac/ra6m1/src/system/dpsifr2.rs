...
pub type DLVD1IF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, DPSIFR2_SPEC, DLVD1IF_A, O>;
...
pub type DLVD2IF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, DPSIFR2_SPEC, DLVD2IF_A, O>;
...
#[doc = "Field `DTRTCIIF` reader - RTC Interval interrupt Deep Standby Cancel Flag\n\nThe field is **modified** in some way after a read operation."]
...
impl DTRTCIIF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DTRTCIIF_A {
        match self.bits {
            false => DTRTCIIF_A::_0,
            true => DTRTCIIF_A::_1,
        }
...
#[doc = "Field `DTRTCIIF` writer - RTC Interval interrupt Deep Standby Cancel Flag"]
pub type DTRTCIIF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, DPSIFR2_SPEC, DTRTCIIF_A, O>;
impl<'a, const O: u8> DTRTCIIF_W<'a, O> {
    #[doc = "The cancel request is not generated"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
pub type DRTCAIF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, DPSIFR2_SPEC, DRTCAIF_A, O>;
...
pub type DNMIF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, DPSIFR2_SPEC, DNMIF_A, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrtciif(&mut self) -> DTRTCIIF_W<2> {
        DTRTCIIF_W::new(self)
    }
    #[doc = "Bit 3 - RTC Alarm interrupt Deep Standby Cancel Flag"]
    #[inline(always)]
