...
#[doc = "Field `ECCPRCR` reader - ECCRAMETST Register Write Control"]
...
#[doc = "Field `ECCPRCR` writer - ECCRAMETST Register Write Control"]
...
impl R {
    #[doc = "Bit 0 - ECCRAMETST Register Write Control"]
    #[inline(always)]
