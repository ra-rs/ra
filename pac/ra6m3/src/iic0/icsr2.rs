...
pub type TMOF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, TMOF_A, O>;
...
pub type AL_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, AL_A, O>;
...
pub type START_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, START_A, O>;
...
pub type STOP_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, STOP_A, O>;
...
pub type NACKF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, NACKF_A, O>;
...
pub type RDRF_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, RDRF_A, O>;
...
pub type TEND_W<'a, const O: u8> = crate::BitWriter0C<'a, u8, ICSR2_SPEC, TEND_A, O>;
