...
#[doc = "Field `CMDIDX` reader - Command IndexThese bits specify Command Format\\[45:40\\]
(command index).\\[Examples\\]CMD6: SD_CMD\\[7:0\\]
= 8'b00_000110CMD18: SD_CMD\\[7:0\\]
= 8'b00_010010ACMD13: SD_CMD\\[7:0\\]
= 8'b01_001101"]
pub type CMDIDX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CMDIDX` writer - Command IndexThese bits specify Command Format\\[45:40\\]
(command index).\\[Examples\\]CMD6: SD_CMD\\[7:0\\]
= 8'b00_000110CMD18: SD_CMD\\[7:0\\]
= 8'b00_010010ACMD13: SD_CMD\\[7:0\\]
= 8'b01_001101"]
...
#[doc = "Field `RSPTP` reader - Mode/Response TypeNOTE: As some commands cannot be used in normal mode, see section 1.4.10, Example of SD_CMD Register Setting to select mode/response type."]
...
#[doc = "Field `RSPTP` writer - Mode/Response TypeNOTE: As some commands cannot be used in normal mode, see section 1.4.10, Example of SD_CMD Register Setting to select mode/response type."]
...
impl R {
    #[doc = "Bits 0:5 - Command IndexThese bits specify Command Format\\[45:40\\]
(command index).\\[Examples\\]CMD6: SD_CMD\\[7:0\\]
= 8'b00_000110CMD18: SD_CMD\\[7:0\\]
= 8'b00_010010ACMD13: SD_CMD\\[7:0\\]
= 8'b01_001101"]
    ...
    #[doc = "Bits 8:10 - Mode/Response TypeNOTE: As some commands cannot be used in normal mode, see section 1.4.10, Example of SD_CMD Register Setting to select mode/response type."]
    #[inline(always)]
