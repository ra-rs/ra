...
#[doc = "Field `SD_ARG` reader - Argument RegisterSet command format\\[39:8\\]
(argument)"]
pub type SD_ARG_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SD_ARG` writer - Argument RegisterSet command format\\[39:8\\]
(argument)"]
pub type SD_ARG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SD_ARG_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Argument RegisterSet command format\\[39:8\\]
(argument)"]
    #[inline(always)]
