...
pub enum RSPENDM_A {
    #[doc = "0: Response end interrupt request is not masked"]
    _0 = 0,
    #[doc = "1: Response end interrupt request is masked"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ACENDM_A {
    #[doc = "0: Access end interrupt request is not masked"]
    _0 = 0,
    #[doc = "1: Access end interrupt request is masked"]
    _1 = 1,
}
...
#[doc = "Field `SDCDRMM` reader - SDnCD card Removal Interrupt Request Mask"]
pub type SDCDRMM_R = crate::BitReader<SDCDRMM_A>;
#[doc = "SDnCD card Removal Interrupt Request Mask\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDCDRMM_A {
    #[doc = "0: Card removal interrupt request by the by the SDnCD is not masked"]
    _0 = 0,
    #[doc = "1: Card removal interrupt request by the by the SDnCD is masked"]
    _1 = 1,
}
...
#[doc = "Field `SDCDRMM` writer - SDnCD card Removal Interrupt Request Mask"]
...
#[doc = "Field `SDCDINM` reader - SDnCD card Insertion Interrupt Request Mask"]
pub type SDCDINM_R = crate::BitReader<SDCDINM_A>;
#[doc = "SDnCD card Insertion Interrupt Request Mask\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDCDINM_A {
    #[doc = "0: Card insertion interrupt request by the SDnCD is not masked"]
    _0 = 0,
    #[doc = "1: Card insertion interrupt request by the SDnCD is masked"]
    _1 = 1,
}
...
#[doc = "Field `SDCDINM` writer - SDnCD card Insertion Interrupt Request Mask"]
...
#[doc = "Field `SDD3RMM` reader - SDnDAT3 Card Removal Interrupt Request Mask"]
pub type SDD3RMM_R = crate::BitReader<SDD3RMM_A>;
#[doc = "SDnDAT3 Card Removal Interrupt Request Mask\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDD3RMM_A {
    #[doc = "0: SD card removal interrupt request by the SDnDAT3 is not masked"]
    _0 = 0,
    #[doc = "1: SD card removal interrupt request by the SDnDAT3 is masked"]
    _1 = 1,
}
...
#[doc = "Field `SDD3RMM` writer - SDnDAT3 Card Removal Interrupt Request Mask"]
...
#[doc = "Field `SDD3INM` reader - SDnDAT3 Card Insertion Interrupt Request Mask"]
pub type SDD3INM_R = crate::BitReader<SDD3INM_A>;
#[doc = "SDnDAT3 Card Insertion Interrupt Request Mask\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SDD3INM_A {
    #[doc = "0: SD card insertion interrupt request by the SDnDAT3 is not masked"]
    _0 = 0,
    #[doc = "1: SD card insertion interrupt request by the SDnDAT3 is masked"]
    _1 = 1,
}
...
#[doc = "Field `SDD3INM` writer - SDnDAT3 Card Insertion Interrupt Request Mask"]
...
impl R {
    ...
    #[doc = "Bit 3 - SDnCD card Removal Interrupt Request Mask"]
    #[inline(always)]
    pub fn sdcdrmm(&self) -> SDCDRMM_R {
        SDCDRMM_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - SDnCD card Insertion Interrupt Request Mask"]
    #[inline(always)]
    pub fn sdcdinm(&self) -> SDCDINM_R {
        SDCDINM_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 8 - SDnDAT3 Card Removal Interrupt Request Mask"]
    #[inline(always)]
    pub fn sdd3rmm(&self) -> SDD3RMM_R {
        SDD3RMM_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - SDnDAT3 Card Insertion Interrupt Request Mask"]
    #[inline(always)]
