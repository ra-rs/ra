...
#[doc = "Field `DCOM` reader - Selection of a mode of communication with the SPI bus"]
...
#[doc = "Field `DCOM` writer - Selection of a mode of communication with the SPI bus"]
...
impl R {
    #[doc = "Bit 0 - Selection of a mode of communication with the SPI bus"]
    #[inline(always)]
