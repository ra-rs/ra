...
#[doc = "Field `DIRQ13E` reader - IRQ13-DS Pin Enable"]
...
#[doc = "Field `DIRQ13E` writer - IRQ13-DS Pin Enable"]
pub type DIRQ13E_W<'a, const O: u8> = crate::BitWriter<'a, u8, DPSIER1_SPEC, DIRQ13E_A, O>;
impl<'a, const O: u8> DIRQ13E_W<'a, O> {
    #[doc = "Canceling deep software standby mode is disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dirq13e(&mut self) -> DIRQ13E_W<5> {
        DIRQ13E_W::new(self)
    }
    #[doc = "Bit 6 - IRQ14-DS Pin Enable"]
    #[inline(always)]
