...
pub type HUBPORT_W<'a, const O: u8> = crate::FieldWriter<'a, u16, DEVADD_SPEC, u8, HUBPORT_A, 3, O>;
...
pub type UPPHUB_W<'a, const O: u8> = crate::FieldWriter<'a, u16, DEVADD_SPEC, u8, UPPHUB_A, 4, O>;
