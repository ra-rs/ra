...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VBSTS_A {
    #[doc = "0: The USBHS_VBUS pin is low"]
    _0 = 0,
    #[doc = "1: The USBHS_VBUS pin is high"]
    _1 = 1,
}
...
pub enum BEMP_A {
    ...
    _0 = 0,
    #[doc = "1: BEMP interrupts are not generated"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VBINT_A {
    #[doc = "0: VBUS interrupt is not generated on detecting a change in the USBHS_VBUS pin."]
    _0 = 0,
    #[doc = "1: VBUS interrupt is generated on detecting a change in the USBHS_VBUS pin."]
    _1 = 1,
}
