...
#[doc = "Field `FRDY` reader - FIFO Port ReadyIndicates whether the FIFO port can be accessed."]
...
pub type BCLR_W<'a, const O: u8> = crate::BitWriter<'a, u16, D1FIFOCTR_SPEC, BCLR_AW, O>;
...
impl R {
    #[doc = "Bits 0:11 - Receive Data Length.Indicates the length of the receive data."]
    #[inline(always)]
    pub fn dtln(&self) -> DTLN_R {
        DTLN_R::new(self.bits & 0x0fff)
    }
    #[doc = "Bit 13 - FIFO Port ReadyIndicates whether the FIFO port can be accessed."]
    #[inline(always)]
