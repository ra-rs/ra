...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CCPL_A {
    #[doc = "0: Completion of control transfer is disabled."]
    _0 = 0,
...
#[doc = "Field `PINGE` reader - PING Token Issue Enable"]
pub type PINGE_R = crate::BitReader<PINGE_A>;
#[doc = "PING Token Issue Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PINGE_A {
    #[doc = "0: Issuing PING token is disabled."]
    _0 = 0,
    #[doc = "1: Normal PING operation"]
    _1 = 1,
}
...
#[doc = "Field `PINGE` writer - PING Token Issue Enable"]
pub type PINGE_W<'a, const O: u8> = crate::BitWriter<'a, u16, DCPCTR_SPEC, PINGE_A, O>;
impl<'a, const O: u8> PINGE_W<'a, O> {
...
#[doc = "Field `SQSET` reader - Toggle Bit Set"]
...
#[doc = "Field `SQSET` writer - Toggle Bit Set"]
...
#[doc = "Field `SQCLR` reader - Toggle Bit Clear"]
...
#[doc = "Field `SQCLR` writer - Toggle Bit Clear"]
...
#[doc = "Field `CSSTS` reader - Split Transaction COMPLETE SPLIT(CSPLIT) Status"]
pub type CSSTS_R = crate::BitReader<CSSTS_A>;
#[doc = "Split Transaction COMPLETE SPLIT(CSPLIT) Status\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CSSTS_A {
    #[doc = "0: START-SPLIT(SSPLIT) transaction processing is in progress or processing for devices that do not use Split Transaction is in progress."]
    _0 = 0,
    #[doc = "1: The CSPLIT transaction processing is in progress."]
    _1 = 1,
}
...
#[doc = "Field `CSCLR` reader - Split Transaction CSPLIT Status Clear"]
...
pub enum CSCLR_A {
    #[doc = "0: Writing is ignored."]
    _0 = 0,
    #[doc = "1: Clears the CSSTS bit to 0."]
    _1 = 1,
}
...
#[doc = "Field `CSCLR` writer - Split Transaction CSPLIT Status Clear"]
pub type CSCLR_W<'a, const O: u8> = crate::BitWriter<'a, u16, DCPCTR_SPEC, CSCLR_A, O>;
...
impl R {
    ...
    #[doc = "Bit 4 - PING Token Issue Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Split Transaction COMPLETE SPLIT(CSPLIT) Status"]
    #[inline(always)]
    pub fn cssts(&self) -> CSSTS_R {
        CSSTS_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Split Transaction CSPLIT Status Clear"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pinge(&mut self) -> PINGE_W<4> {
        PINGE_W::new(self)
    }
    #[doc = "Bit 7 - Toggle Bit Set"]
    #[inline(always)]
