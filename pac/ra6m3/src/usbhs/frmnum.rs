...
#[doc = "Field `FRNM` reader - Frame Number.Indicate the latest frame number."]
pub type FRNM_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CRCE` reader - CRC Error Detection Status"]
...
#[doc = "Field `CRCE` writer - CRC Error Detection Status"]
...
impl R {
    #[doc = "Bits 0:10 - Frame Number.Indicate the latest frame number."]
    #[inline(always)]
    pub fn frnm(&self) -> FRNM_R {
        FRNM_R::new(self.bits & 0x07ff)
    }
    #[doc = "Bit 14 - CRC Error Detection Status"]
    #[inline(always)]
