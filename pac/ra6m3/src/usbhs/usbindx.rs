...
#[doc = "Field `WINDEX` reader - Value of USB request wIndex Finction controller selected : read-only Host controller selected : read-write"]
pub type WINDEX_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WINDEX` writer - Value of USB request wIndex Finction controller selected : read-only Host controller selected : read-write"]
pub type WINDEX_W<'a, const O: u8> = crate::FieldWriter<'a, u16, USBINDX_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Value of USB request wIndex Finction controller selected : read-only Host controller selected : read-write"]
    #[inline(always)]
