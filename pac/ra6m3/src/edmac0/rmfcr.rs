...
#[doc = "Field `MFC` reader - Missed-Frame CounterThese bits indicate the number of frames that are discarded and not transferred to the receive buffer during reception."]
pub type MFC_R = crate::FieldReader<u16, u16>;
#[doc = "Field `MFC` writer - Missed-Frame CounterThese bits indicate the number of frames that are discarded and not transferred to the receive buffer during reception."]
pub type MFC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RMFCR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Missed-Frame CounterThese bits indicate the number of frames that are discarded and not transferred to the receive buffer during reception."]
    #[inline(always)]
