#[doc = "Register `MMPUPTB` reader"]
pub struct R(crate::R<MMPUPTB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MMPUPTB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MMPUPTB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MMPUPTB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MMPUPTB` writer"]
pub struct W(crate::W<MMPUPTB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MMPUPTB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MMPUPTB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MMPUPTB_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PROTECT` reader - Protection of register(MMPUSBn, MMPUEBn and MMPUACBn)"]
pub type PROTECT_R = crate::BitReader<PROTECT_A>;
#[doc = "Protection of register(MMPUSBn, MMPUEBn and MMPUACBn)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PROTECT_A {
    #[doc = "0: All Bus Master MPU Group B register writing is possible."]
    _0 = 0,
    #[doc = "1: All Bus Master MPU Group B register writing is protected. Read is possible."]
    _1 = 1,
}
...
#[doc = "Field `PROTECT` writer - Protection of register(MMPUSBn, MMPUEBn and MMPUACBn)"]
pub type PROTECT_W<'a, const O: u8> = crate::BitWriter<'a, u16, MMPUPTB_SPEC, PROTECT_A, O>;
...
pub type KEY_W<'a, const O: u8> = crate::FieldWriter<'a, u16, MMPUPTB_SPEC, u8, KEY_AW, 8, O>;
...
impl R {
    #[doc = "Bit 0 - Protection of register(MMPUSBn, MMPUEBn and MMPUACBn)"]
    #[inline(always)]
