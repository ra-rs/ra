...
#[doc = "Field `SSIFRDR` reader - SSIFRDR is a read-only FIFO register consisting of eight stages of 32-bit registers for storing serially received data."]
pub type SSIFRDR_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - SSIFRDR is a read-only FIFO register consisting of eight stages of 32-bit registers for storing serially received data."]
    #[inline(always)]
