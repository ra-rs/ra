...
impl CRCSA_R {
    ...
    pub fn variant(&self) -> Option<CRCSA_A> {
        match self.bits {
            ...
            163 => Some(CRCSA_A::_0X00A3),
            165 => Some(CRCSA_A::_0X00A5),
            195 => Some(CRCSA_A::_0X00C3),
            197 => Some(CRCSA_A::_0X00C5),
            227 => Some(CRCSA_A::_0X00E3),
            229 => Some(CRCSA_A::_0X00E5),
            259 => Some(CRCSA_A::_0X0103),
            261 => Some(CRCSA_A::_0X0105),
    ...
    #[doc = "Checks if the value of the field is `_0X00A3`"]
    #[inline(always)]
    pub fn is_0x00a3(&self) -> bool {
        *self == CRCSA_A::_0X00A3
    }
    #[doc = "Checks if the value of the field is `_0X00A5`"]
    #[inline(always)]
    pub fn is_0x00a5(&self) -> bool {
        *self == CRCSA_A::_0X00A5
    }
    #[doc = "Checks if the value of the field is `_0X00C3`"]
    #[inline(always)]
    pub fn is_0x00c3(&self) -> bool {
        *self == CRCSA_A::_0X00C3
    }
    #[doc = "Checks if the value of the field is `_0X00C5`"]
    #[inline(always)]
    pub fn is_0x00c5(&self) -> bool {
        *self == CRCSA_A::_0X00C5
    }
    #[doc = "Checks if the value of the field is `_0X00E3`"]
    #[inline(always)]
    pub fn is_0x00e3(&self) -> bool {
        *self == CRCSA_A::_0X00E3
    }
    #[doc = "Checks if the value of the field is `_0X00E5`"]
    #[inline(always)]
    pub fn is_0x00e5(&self) -> bool {
        *self == CRCSA_A::_0X00E5
    }
    #[doc = "Checks if the value of the field is `_0X0103`"]
    #[inline(always)]
    pub fn is_0x0103(&self) -> bool {
        *self == CRCSA_A::_0X0103
    }
    #[doc = "Checks if the value of the field is `_0X0105`"]
    #[inline(always)]
...
impl<'a, const O: u8> CRCSA_W<'a, O> {
    ...
    #[doc = "SCI5.TDR"]
    #[inline(always)]
    pub fn _0x00a3(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X00A3)
    }
    #[doc = "SCI5.RDR"]
    #[inline(always)]
    pub fn _0x00a5(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X00A5)
    }
    #[doc = "SCI6.TDR"]
    #[inline(always)]
    pub fn _0x00c3(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X00C3)
    }
    #[doc = "SCI6.RDR"]
    #[inline(always)]
    pub fn _0x00c5(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X00C5)
    }
    #[doc = "SCI7.TDR"]
    #[inline(always)]
    pub fn _0x00e3(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X00E3)
    }
    #[doc = "SCI7.RDR"]
    #[inline(always)]
    pub fn _0x00e5(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X00E5)
    }
    #[doc = "SCI8.TDR"]
    #[inline(always)]
    pub fn _0x0103(self) -> &'a mut W {
        self.variant(CRCSA_A::_0X0103)
    }
    #[doc = "SCI8.RDR"]
    #[inline(always)]
    pub fn _0x0105(self) -> &'a mut W {
