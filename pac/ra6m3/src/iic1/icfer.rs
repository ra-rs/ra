...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FMPE_A {
    #[doc = "0: No Fm+ slope control circuit is used for the SCLn pin and SDAn pin."]
    _0 = 0,
    #[doc = "1: An Fm+ slope control circuit is used for the SCLn pin and SDAn pin."]
    _1 = 1,
}
...
pub type FMPE_W<'a, const O: u8> = crate::BitWriter<'a, u8, ICFER_SPEC, FMPE_A, O>;
...
impl R {
    ...
    #[doc = "Bit 7 - Fast-mode Plus Enable"]
    #[inline(always)]
