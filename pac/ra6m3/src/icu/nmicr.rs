...
#[doc = "Field `NFCLKSEL` reader - NMI Digital Filter Sampling Clock"]
...
#[doc = "Field `NFCLKSEL` writer - NMI Digital Filter Sampling Clock"]
...
impl R {
    ...
    #[doc = "Bits 4:5 - NMI Digital Filter Sampling Clock"]
    #[inline(always)]
