...
pub type DMDAR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DMDAR` writer - Specifies the transfer destination start address."]
pub type DMDAR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMDAR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmdar(&mut self) -> DMDAR_W<0> {
        DMDAR_W::new(self)
    }
