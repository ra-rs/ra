...
#[doc = "Field `ADS16` reader - A/D-Converted Value Addition/Average Channel AN116 Select"]
pub type ADS16_R = crate::BitReader<ADS16_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN116 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS16_A {
    #[doc = "0: AN116 is not selected."]
    _0 = 0,
    #[doc = "1: AN116 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS16` writer - A/D-Converted Value Addition/Average Channel AN116 Select"]
...
#[doc = "Field `ADS17` reader - A/D-Converted Value Addition/Average Channel AN117 Select"]
pub type ADS17_R = crate::BitReader<ADS17_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN117 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS17_A {
    #[doc = "0: AN117 is not selected."]
    _0 = 0,
    #[doc = "1: AN117 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS17` writer - A/D-Converted Value Addition/Average Channel AN117 Select"]
...
#[doc = "Field `ADS18` reader - A/D-Converted Value Addition/Average Channel AN118 Select"]
pub type ADS18_R = crate::BitReader<ADS18_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN118 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS18_A {
    #[doc = "0: AN118 is not selected."]
    _0 = 0,
    #[doc = "1: AN118 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS18` writer - A/D-Converted Value Addition/Average Channel AN118 Select"]
...
#[doc = "Field `ADS19` reader - A/D-Converted Value Addition/Average Channel AN119 Select"]
pub type ADS19_R = crate::BitReader<ADS19_A>;
#[doc = "A/D-Converted Value Addition/Average Channel AN119 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ADS19_A {
    #[doc = "0: AN119 is not selected."]
    _0 = 0,
    #[doc = "1: AN119 is selected."]
    _1 = 1,
}
...
#[doc = "Field `ADS19` writer - A/D-Converted Value Addition/Average Channel AN119 Select"]
...
impl R {
    #[doc = "Bit 0 - A/D-Converted Value Addition/Average Channel AN116 Select"]
    #[inline(always)]
    pub fn ads16(&self) -> ADS16_R {
        ADS16_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - A/D-Converted Value Addition/Average Channel AN117 Select"]
    #[inline(always)]
    pub fn ads17(&self) -> ADS17_R {
        ADS17_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - A/D-Converted Value Addition/Average Channel AN118 Select"]
    #[inline(always)]
    pub fn ads18(&self) -> ADS18_R {
        ADS18_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - A/D-Converted Value Addition/Average Channel AN119 Select"]
    #[inline(always)]
