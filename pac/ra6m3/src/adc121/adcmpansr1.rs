...
#[doc = "Field `CMPCHA18` reader - AN118 Select"]
pub type CMPCHA18_R = crate::BitReader<CMPCHA18_A>;
#[doc = "AN118 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA18_A {
    #[doc = "0: Excludes AN118 from the compare window A target range."]
    _0 = 0,
    #[doc = "1: Includes AN118 from the compare window A target range."]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA18` writer - AN118 Select"]
...
#[doc = "Field `CMPCHA19` reader - AN119 Select"]
pub type CMPCHA19_R = crate::BitReader<CMPCHA19_A>;
#[doc = "AN119 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA19_A {
    #[doc = "0: Excludes AN119 from the compare window A target range."]
    _0 = 0,
    #[doc = "1: Includes AN119 from the compare window A target range."]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA19` writer - AN119 Select"]
...
#[doc = "Field `CMPCHA20` reader - AN120 Select"]
pub type CMPCHA20_R = crate::BitReader<CMPCHA20_A>;
#[doc = "AN120 Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPCHA20_A {
    #[doc = "0: Excludes AN120 from the compare window A target range."]
    _0 = 0,
    #[doc = "1: Includes AN120 from the compare window A target range."]
    _1 = 1,
}
...
#[doc = "Field `CMPCHA20` writer - AN120 Select"]
