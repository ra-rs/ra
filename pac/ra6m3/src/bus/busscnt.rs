...
pub struct R(crate::R<BUSSCNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUSSCNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUSSCNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUSSCNT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BUSSCNT%s` writer"]
pub struct W(crate::W<BUSSCNT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUSSCNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUSSCNT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUSSCNT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ARBMET_W<'a, const O: u8> = crate::FieldWriter<'a, u16, BUSSCNT_SPEC, u8, ARBMET_A, 2, O>;
...
#[doc = "Field `EWRES` reader - Early Write ResponseWhether the next write request is accepted or not until a response for the write transaction comes back."]
...
#[doc = "Field `EWRES` writer - Early Write ResponseWhether the next write request is accepted or not until a response for the write transaction comes back."]
pub type EWRES_W<'a, const O: u8> = crate::BitWriter<'a, u16, BUSSCNT_SPEC, EWRES_A, O>;
...
impl R {
    ...
    #[doc = "Bit 8 - Early Write ResponseWhether the next write request is accepted or not until a response for the write transaction comes back."]
    #[inline(always)]
