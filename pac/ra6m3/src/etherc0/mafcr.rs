...
#[doc = "Field `MAFCR` reader - Multicast Address Frame Receive Counter RegisterThe MAFCR register is a counter indicating the number of times a frame where the multicast address is set has been received."]
pub type MAFCR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MAFCR` writer - Multicast Address Frame Receive Counter RegisterThe MAFCR register is a counter indicating the number of times a frame where the multicast address is set has been received."]
pub type MAFCR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAFCR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Multicast Address Frame Receive Counter RegisterThe MAFCR register is a counter indicating the number of times a frame where the multicast address is set has been received."]
    #[inline(always)]
