...
pub enum PRM_A {
    #[doc = "0: Promiscuous mode is disabled."]
    _0 = 0,
    #[doc = "1: Promiscuous mode is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ILB_A {
    #[doc = "0: Normal data transmission or reception is performed."]
    _0 = 0,
    #[doc = "1: Data is looped back in the ETHERC when full-duplex mode is selected."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TE_A {
    #[doc = "0: Transmit function is disabled."]
    _0 = 0,
    #[doc = "1: Transmit function is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RE_A {
    #[doc = "0: Receive function is disabled."]
    _0 = 0,
    #[doc = "1: Receive function is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MPDE_A {
    #[doc = "0: Magic Packet detection is disabled."]
    _0 = 0,
    #[doc = "1: Magic Packet detection is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PRCEF_A {
    #[doc = "0: EDMAC is notified of a CRC error."]
    _0 = 0,
    #[doc = "1: EDMAC is not notified of a CRC error."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TXF_A {
    #[doc = "0: Automatic PAUSE frame transmission is disabled.(PAUSE frame is not automatically transmitted.)"]
    _0 = 0,
    #[doc = "1: Automatic PAUSE frame transmission is enabled.(PAUSE frame is automatically transmitted as required.)"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RXF_A {
    #[doc = "0: PAUSE frame detection is disabled."]
    _0 = 0,
    #[doc = "1: PAUSE frame detection is enabled."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PFR_A {
    #[doc = "0: PAUSE frame is not transferred to the EDMAC."]
    _0 = 0,
    #[doc = "1: PAUSE frame is transferred to the EDMAC."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ZPF_A {
    #[doc = "0: PAUSE frame that contains the pause_time parameter of 0 is not used."]
    _0 = 0,
    #[doc = "1: PAUSE frame that contains the pause_time parameter of 0 is used."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TPC_A {
    #[doc = "0: PAUSE frame is transmitted even during a PAUSE period."]
    _0 = 0,
    #[doc = "1: PAUSE frame is not transmitted during a PAUSE period."]
    _1 = 1,
}
