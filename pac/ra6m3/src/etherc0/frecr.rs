...
#[doc = "Field `FRECR` reader - Frame Receive Error Counter RegisterThe FRECR register is a counter indicating the number of times a frame receive error has occurred."]
pub type FRECR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FRECR` writer - Frame Receive Error Counter RegisterThe FRECR register is a counter indicating the number of times a frame receive error has occurred."]
pub type FRECR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FRECR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Frame Receive Error Counter RegisterThe FRECR register is a counter indicating the number of times a frame receive error has occurred."]
    #[inline(always)]
