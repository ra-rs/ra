...
#[doc = "Field `TSFRCR` reader - Too-Short Frame Receive Counter RegisterThe TSFRCR register is a counter indicating the number of times a short frame that is shorter than 64 bytes has been received."]
pub type TSFRCR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TSFRCR` writer - Too-Short Frame Receive Counter RegisterThe TSFRCR register is a counter indicating the number of times a short frame that is shorter than 64 bytes has been received."]
pub type TSFRCR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TSFRCR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Too-Short Frame Receive Counter RegisterThe TSFRCR register is a counter indicating the number of times a short frame that is shorter than 64 bytes has been received."]
    #[inline(always)]
