...
pub enum ICD_A {
    ...
    _0 = 0,
    #[doc = "1: PHY-LSI has detected a false carrier on the line."]
    _1 = 1,
}
...
pub type ICD_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, ECSR_SPEC, ICD_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MPD_A {
    #[doc = "0: Magic Packet has not been detected."]
    _0 = 0,
    #[doc = "1: Magic Packet has been detected."]
    _1 = 1,
}
...
pub type MPD_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, ECSR_SPEC, MPD_A, O>;
...
#[doc = "Field `LCHNG` reader - LCHNG Link Signal Change Flag\n\nThe field is **modified** in some way after a read operation."]
pub type LCHNG_R = crate::BitReader<LCHNG_A>;
#[doc = "LCHNG Link Signal Change Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LCHNG_A {
    #[doc = "0: Change in the ETn_LINKSTA signal has not been detected."]
    _0 = 0,
    #[doc = "1: Change in the ETn_LINKSTA signal has been detected (high to low, or low to high)."]
    _1 = 1,
}
...
#[doc = "Field `LCHNG` writer - LCHNG Link Signal Change Flag"]
pub type LCHNG_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, ECSR_SPEC, LCHNG_A, O>;
...
pub enum PSRTO_A {
    ...
    _0 = 0,
    #[doc = "1: PAUSE frame retransmit count has reached the upper limit."]
    _1 = 1,
}
...
pub type PSRTO_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, ECSR_SPEC, PSRTO_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BFR_A {
    #[doc = "0: Continuous reception of broadcast frames has not been detected."]
    _0 = 0,
    #[doc = "1: Continuous reception of broadcast frames has been detected."]
    _1 = 1,
}
...
pub type BFR_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, ECSR_SPEC, BFR_A, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - LCHNG Link Signal Change Flag"]
    #[inline(always)]
...
impl crate::Writable for ECSR_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x37;
}
