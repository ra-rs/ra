...
#[doc = "Field `RPAUSE` reader - Received PAUSE Frame CountNumber of received PAUSE frames"]
pub type RPAUSE_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:7 - Received PAUSE Frame CountNumber of received PAUSE frames"]
    #[inline(always)]
