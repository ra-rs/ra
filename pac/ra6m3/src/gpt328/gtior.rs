...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OADFLT_A {
    #[doc = "0: Output low on GTIOCA pin when counting stops"]
    _0 = 0,
    #[doc = "1: Output high on GTIOCA pin when counting stops."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OAHLD_A {
    #[doc = "0: Set GTIOCA pin output level on counting start and stop based on the register setting."]
    _0 = 0,
    #[doc = "1: Retain GTIOCA pin output level on counting start and stop"]
    _1 = 1,
}
...
#[repr(u8)]
pub enum OADF_A {
    #[doc = "0: Prohibit output disable"]
    _00 = 0,
    #[doc = "1: Set GTIOCA pin to Hi-Z on output disable"]
    _01 = 1,
    #[doc = "2: Set GTIOCA pin to 0 on output disable"]
    _10 = 2,
    #[doc = "3: Set GTIOCA pin to 1 on output disable."]
    _11 = 3,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NFAEN_A {
    #[doc = "0: Disable noise filter for GTIOCA pin"]
    _0 = 0,
    #[doc = "1: Enable noise filter for GTIOCA pin."]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OBDFLT_A {
    #[doc = "0: Output low on GTIOCB pin when counting stops"]
    _0 = 0,
    #[doc = "1: Output high on GTIOCB pin when counting stops"]
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OBHLD_A {
    #[doc = "0: Set GTIOCB pin output level on counting start and stop based on the register setting"]
    _0 = 0,
    #[doc = "1: Retain GTIOCB pin output level on counting start and stop"]
    _1 = 1,
}
...
pub enum OBDF_A {
    #[doc = "0: Prohibit output disable"]
    _00 = 0,
    #[doc = "1: Set GTIOCB pin to Hi-Z on output disable"]
    _01 = 1,
    #[doc = "2: Set GTIOCB pin to 0 on output disable"]
    _10 = 2,
    #[doc = "3: Set GTIOCB pin to 1 on output disable."]
    _11 = 3,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NFBEN_A {
    #[doc = "0: Disable noise filter for GTIOCB pin"]
    _0 = 0,
    #[doc = "1: Enable noise filter for GTIOCB pin"]
    _1 = 1,
}
