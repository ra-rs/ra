...
pub struct RegisterBlock {
    #[doc = "0x00 - PTPEDMAC Mode Register"]
    pub edmr: EDMR,
    _reserved1: [u8; 0x04],
    ...
    pub rdlar: RDLAR,
    _reserved5: [u8; 0x04],
    #[doc = "0x28 - PTP/EDMAC Status Register"]
    pub eesr: EESR,
    _reserved6: [u8; 0x04],
    #[doc = "0x30 - PTP/EDMAC Status Interrupt Enable Register"]
    pub eesipr: EESIPR,
    _reserved7: [u8; 0x0c],
    ...
    pub tftr: TFTR,
    _reserved9: [u8; 0x04],
    #[doc = "0x50 - Transmit FIFO Threshold Register"]
    pub fdr: FDR,
    _reserved10: [u8; 0x04],
