...
#[doc = "Field `CTSUTXVSEL` reader - CTSU Transmission power supply selection"]
...
pub enum CTSUTXVSEL_A {
    #[doc = "0: Select Vcc"]
    _0 = 0,
    #[doc = "1: Select internal logic power supply"]
    _1 = 1,
}
...
impl CTSUTXVSEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CTSUTXVSEL_A {
        match self.bits {
...
#[doc = "Field `CTSUTXVSEL` writer - CTSU Transmission power supply selection"]
pub type CTSUTXVSEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTSUCR0_SPEC, CTSUTXVSEL_A, O>;
impl<'a, const O: u8> CTSUTXVSEL_W<'a, O> {
    #[doc = "Select Vcc"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 7 - CTSU Transmission power supply selection"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ctsutxvsel(&mut self) -> CTSUTXVSEL_W<7> {
        CTSUTXVSEL_W::new(self)
    }
