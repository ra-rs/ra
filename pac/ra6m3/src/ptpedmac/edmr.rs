...
#[doc = "Field `SWR` reader - Software Reset (The read value is 0.)"]
...
pub enum SWR_A {
    #[doc = "0: no effect."]
    _0 = 0,
    #[doc = "1: the corresponding channels of the EDMAC and ETHERC are reset. Registers TDLAR, RDLAR, RMFCR, TFUCR, and RFOCR are not reset."]
    _1 = 1,
}
...
#[doc = "Field `SWR` writer - Software Reset (The read value is 0.)"]
pub type SWR_W<'a, const O: u8> = crate::BitWriter<'a, u32, EDMR_SPEC, SWR_A, O>;
...
#[doc = "Field `DL` reader - Transmit/Receive DescriptorLength"]
...
#[doc = "Field `DL` writer - Transmit/Receive DescriptorLength"]
...
#[doc = "Field `DE` reader - Big Endian Mode/Little Endian ModeNOTE: This setting applies to data for the transmit/receive buffer. It does not apply to transmit/receive descriptors and registers."]
...
#[doc = "Field `DE` writer - Big Endian Mode/Little Endian ModeNOTE: This setting applies to data for the transmit/receive buffer. It does not apply to transmit/receive descriptors and registers."]
...
impl R {
    #[doc = "Bit 0 - Software Reset (The read value is 0.)"]
    #[inline(always)]
    pub fn swr(&self) -> SWR_R {
        SWR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 4:5 - Transmit/Receive DescriptorLength"]
    #[inline(always)]
    pub fn dl(&self) -> DL_R {
        DL_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bit 6 - Big Endian Mode/Little Endian ModeNOTE: This setting applies to data for the transmit/receive buffer. It does not apply to transmit/receive descriptors and registers."]
    #[inline(always)]
    pub fn de(&self) -> DE_R {
